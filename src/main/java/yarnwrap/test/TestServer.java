...
// public void GAME_RULES(yarnwrap.world.GameRules value) { wrapperContained.GAME_RULES = value.wrapperContained; }
...
// public void testFunctions(java.util.List value) { wrapperContained.testFunctions = value; }
