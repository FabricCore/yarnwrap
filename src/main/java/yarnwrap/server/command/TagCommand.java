...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType ADD_FAILED_EXCEPTION() { return net.minecraft.server.command.TagCommand.ADD_FAILED_EXCEPTION; }
// public static void ADD_FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.TagCommand.ADD_FAILED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType REMOVE_FAILED_EXCEPTION() { return net.minecraft.server.command.TagCommand.REMOVE_FAILED_EXCEPTION; }
// public static void REMOVE_FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.TagCommand.REMOVE_FAILED_EXCEPTION = value; }

// public int method_13697(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13697(context); }
// public static int method_13697(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.TagCommand.method_13697(context); }
// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.command.TagCommand.register(dispatcher); }
...
// public static int executeRemove(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets,java.lang.String tag, ) { return net.minecraft.server.command.TagCommand.executeRemove(source.wrapperContained,targets,tag); }
...
// public static int executeList(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets, ) { return net.minecraft.server.command.TagCommand.executeList(source.wrapperContained,targets); }
...
// public static java.util.concurrent.CompletableFuture method_13701(com.mojang.brigadier.context.CommandContext context,com.mojang.brigadier.suggestion.SuggestionsBuilder builder, ) { return net.minecraft.server.command.TagCommand.method_13701(context,builder); }
...
// public static int executeAdd(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets,java.lang.String tag, ) { return net.minecraft.server.command.TagCommand.executeAdd(source.wrapperContained,targets,tag); }
