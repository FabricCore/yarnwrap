...
// public static int execute(yarnwrap.server.command.ServerCommandSource source,yarnwrap.util.math.Vec2f center,float spreadDistance,float maxRange,int maxY,boolean respectTeams,java.util.Collection players, ) { return net.minecraft.server.command.SpreadPlayersCommand.execute(source.wrapperContained,center.wrapperContained,spreadDistance,maxRange,maxY,respectTeams,players); }
...
// public static double getMinDistance(java.util.Collection entities,yarnwrap.server.world.ServerWorld world,Object[] piles,int maxY,boolean respectTeams, ) { return net.minecraft.server.command.SpreadPlayersCommand.getMinDistance(entities,world.wrapperContained,piles,maxY,respectTeams); }
...
// public static boolean method_13659(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.command.SpreadPlayersCommand.method_13659(source.wrapperContained); }
