...
// public static int method_13783(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.TimeCommand.method_13783(context); }
...
// public static int executeSet(yarnwrap.server.command.ServerCommandSource source,int time, ) { return net.minecraft.server.command.TimeCommand.executeSet(source.wrapperContained,time); }
// public int method_13785(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13785(context); }
// public static int method_13785(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.TimeCommand.method_13785(context); }
// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.command.TimeCommand.register(dispatcher); }
// public int getDayTime(yarnwrap.server.world.ServerWorld world) { return wrapperContained.getDayTime(world.wrapperContained); }
// public static int getDayTime(yarnwrap.server.world.ServerWorld world, ) { return net.minecraft.server.command.TimeCommand.getDayTime(world.wrapperContained); }
...
// public static int executeAdd(yarnwrap.server.command.ServerCommandSource source,int time, ) { return net.minecraft.server.command.TimeCommand.executeAdd(source.wrapperContained,time); }
...
// public static int method_13793(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.TimeCommand.method_13793(context); }
// public int method_13794(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13794(context); }
// public static int method_13794(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.TimeCommand.method_13794(context); }
// public int method_13795(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13795(context); }
// public static int method_13795(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.TimeCommand.method_13795(context); }
...
// public static int executeQuery(yarnwrap.server.command.ServerCommandSource source,int time, ) { return net.minecraft.server.command.TimeCommand.executeQuery(source.wrapperContained,time); }
// public int method_13797(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13797(context); }
// public static int method_13797(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.TimeCommand.method_13797(context); }
