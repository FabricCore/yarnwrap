...
// public static int method_36183(yarnwrap.entity.SpawnGroup context, ) { return net.minecraft.server.command.DebugMobSpawningCommand.method_36183(context.wrapperContained); }
// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.command.DebugMobSpawningCommand.register(dispatcher); }
...
// public static int execute(yarnwrap.server.command.ServerCommandSource source,yarnwrap.entity.SpawnGroup group,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.server.command.DebugMobSpawningCommand.execute(source.wrapperContained,group.wrapperContained,pos.wrapperContained); }
