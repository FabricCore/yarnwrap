...
// public static boolean method_13778(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.command.TellRawCommand.method_13778(source.wrapperContained); }
