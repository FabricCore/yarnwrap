...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType GIVE_FAILED_EXCEPTION() { return net.minecraft.server.command.EffectCommand.GIVE_FAILED_EXCEPTION; }
// public static void GIVE_FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.EffectCommand.GIVE_FAILED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType CLEAR_SPECIFIC_FAILED_EXCEPTION() { return net.minecraft.server.command.EffectCommand.CLEAR_SPECIFIC_FAILED_EXCEPTION; }
// public static void CLEAR_SPECIFIC_FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.EffectCommand.CLEAR_SPECIFIC_FAILED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType CLEAR_EVERYTHING_FAILED_EXCEPTION() { return net.minecraft.server.command.EffectCommand.CLEAR_EVERYTHING_FAILED_EXCEPTION; }
// public static void CLEAR_EVERYTHING_FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.EffectCommand.CLEAR_EVERYTHING_FAILED_EXCEPTION = value; }

// public int method_13225(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13225(context); }
// public static int method_13225(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EffectCommand.method_13225(context); }
// public int method_13226(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13226(context); }
// public static int method_13226(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EffectCommand.method_13226(context); }
...
// public static int executeGive(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets,yarnwrap.registry.entry.RegistryEntry statusEffect,java.lang.Integer seconds,int amplifier,boolean showParticles, ) { return net.minecraft.server.command.EffectCommand.executeGive(source.wrapperContained,targets,statusEffect.wrapperContained,seconds,amplifier,showParticles); }
// public int method_13228(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13228(context); }
// public static int method_13228(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EffectCommand.method_13228(context); }
...
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher,yarnwrap.command.CommandRegistryAccess registryAccess, ) { net.minecraft.server.command.EffectCommand.register(dispatcher,registryAccess.wrapperContained); }
...
// public static int executeClear(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets, ) { return net.minecraft.server.command.EffectCommand.executeClear(source.wrapperContained,targets); }
...
// public static int executeClear(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets,yarnwrap.registry.entry.RegistryEntry statusEffect, ) { return net.minecraft.server.command.EffectCommand.executeClear(source.wrapperContained,targets,statusEffect.wrapperContained); }
// public int method_13232(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13232(context); }
// public static int method_13232(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EffectCommand.method_13232(context); }
...
// public static int method_48545(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EffectCommand.method_48545(context); }
// public int method_48546(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_48546(context); }
// public static int method_48546(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EffectCommand.method_48546(context); }
// public int method_48547(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_48547(context); }
// public static int method_48547(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EffectCommand.method_48547(context); }
