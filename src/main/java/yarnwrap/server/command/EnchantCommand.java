...
// public static com.mojang.brigadier.exceptions.DynamicCommandExceptionType FAILED_ENTITY_EXCEPTION() { return net.minecraft.server.command.EnchantCommand.FAILED_ENTITY_EXCEPTION; }
// public static void FAILED_ENTITY_EXCEPTION(com.mojang.brigadier.exceptions.DynamicCommandExceptionType value, ) { net.minecraft.server.command.EnchantCommand.FAILED_ENTITY_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType FAILED_EXCEPTION() { return net.minecraft.server.command.EnchantCommand.FAILED_EXCEPTION; }
// public static void FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.EnchantCommand.FAILED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.DynamicCommandExceptionType FAILED_ITEMLESS_EXCEPTION() { return net.minecraft.server.command.EnchantCommand.FAILED_ITEMLESS_EXCEPTION; }
// public static void FAILED_ITEMLESS_EXCEPTION(com.mojang.brigadier.exceptions.DynamicCommandExceptionType value, ) { net.minecraft.server.command.EnchantCommand.FAILED_ITEMLESS_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.Dynamic2CommandExceptionType FAILED_LEVEL_EXCEPTION() { return net.minecraft.server.command.EnchantCommand.FAILED_LEVEL_EXCEPTION; }
// public static void FAILED_LEVEL_EXCEPTION(com.mojang.brigadier.exceptions.Dynamic2CommandExceptionType value, ) { net.minecraft.server.command.EnchantCommand.FAILED_LEVEL_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.DynamicCommandExceptionType FAILED_INCOMPATIBLE_EXCEPTION() { return net.minecraft.server.command.EnchantCommand.FAILED_INCOMPATIBLE_EXCEPTION; }
// public static void FAILED_INCOMPATIBLE_EXCEPTION(com.mojang.brigadier.exceptions.DynamicCommandExceptionType value, ) { net.minecraft.server.command.EnchantCommand.FAILED_INCOMPATIBLE_EXCEPTION = value; }

// public int method_13240(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13240(context); }
// public static int method_13240(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.EnchantCommand.method_13240(context); }
...
// public static int execute(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets,yarnwrap.registry.entry.RegistryEntry enchantment,int level, ) { return net.minecraft.server.command.EnchantCommand.execute(source.wrapperContained,targets,enchantment.wrapperContained,level); }
...
// public static com.mojang.brigadier.Message method_13242(java.lang.Object entityName, ) { return net.minecraft.server.command.EnchantCommand.method_13242(entityName); }
...
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher,yarnwrap.command.CommandRegistryAccess registryAccess, ) { net.minecraft.server.command.EnchantCommand.register(dispatcher,registryAccess.wrapperContained); }
...
// public static com.mojang.brigadier.Message method_13248(java.lang.Object level,java.lang.Object maxLevel, ) { return net.minecraft.server.command.EnchantCommand.method_13248(level,maxLevel); }
