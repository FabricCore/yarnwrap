...
// public static int DEFAULT_DURATION() { return net.minecraft.server.command.WeatherCommand.DEFAULT_DURATION; }
// public static void DEFAULT_DURATION(int value, ) { net.minecraft.server.command.WeatherCommand.DEFAULT_DURATION = value; }

// public int method_13823(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13823(context); }
// public static int method_13823(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.WeatherCommand.method_13823(context); }
...
// public static int executeClear(yarnwrap.server.command.ServerCommandSource source,int duration, ) { return net.minecraft.server.command.WeatherCommand.executeClear(source.wrapperContained,duration); }
// public int method_13825(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13825(context); }
// public static int method_13825(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.WeatherCommand.method_13825(context); }
// public int method_13826(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13826(context); }
// public static int method_13826(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.WeatherCommand.method_13826(context); }
// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.command.WeatherCommand.register(dispatcher); }
...
// public static int executeRain(yarnwrap.server.command.ServerCommandSource source,int duration, ) { return net.minecraft.server.command.WeatherCommand.executeRain(source.wrapperContained,duration); }
// public int method_13829(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13829(context); }
// public static int method_13829(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.WeatherCommand.method_13829(context); }
...
// public static int processDuration(yarnwrap.server.command.ServerCommandSource source,int duration,yarnwrap.util.math.intprovider.IntProvider provider, ) { return net.minecraft.server.command.WeatherCommand.processDuration(source.wrapperContained,duration,provider.wrapperContained); }
