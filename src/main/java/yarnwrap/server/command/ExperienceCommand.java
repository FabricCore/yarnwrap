...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType SET_POINT_INVALID_EXCEPTION() { return net.minecraft.server.command.ExperienceCommand.SET_POINT_INVALID_EXCEPTION; }
// public static void SET_POINT_INVALID_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.ExperienceCommand.SET_POINT_INVALID_EXCEPTION = value; }
...
// public static int executeAdd(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets,int amount,Object component, ) { return net.minecraft.server.command.ExperienceCommand.executeAdd(source.wrapperContained,targets,amount,component); }
// public int method_13327(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13327(context); }
// public static int method_13327(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.ExperienceCommand.method_13327(context); }
...
// public static int executeQuery(yarnwrap.server.command.ServerCommandSource source,yarnwrap.server.network.ServerPlayerEntity player,Object component, ) { return net.minecraft.server.command.ExperienceCommand.executeQuery(source.wrapperContained,player.wrapperContained,component); }
// public int method_13329(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13329(context); }
// public static int method_13329(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.ExperienceCommand.method_13329(context); }
// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.command.ExperienceCommand.register(dispatcher); }
// public int method_13331(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13331(context); }
// public static int method_13331(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.ExperienceCommand.method_13331(context); }
...
// public static int method_13337(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.ExperienceCommand.method_13337(context); }
// public int method_13338(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13338(context); }
// public static int method_13338(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.ExperienceCommand.method_13338(context); }
// public int method_13339(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13339(context); }
// public static int method_13339(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.ExperienceCommand.method_13339(context); }
