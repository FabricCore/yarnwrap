...
// public static boolean method_13490(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.command.ParticleCommand.method_13490(source.wrapperContained); }
