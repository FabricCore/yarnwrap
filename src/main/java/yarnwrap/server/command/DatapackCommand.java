...
// public static com.mojang.brigadier.suggestion.SuggestionProvider DISABLED_CONTAINERS_SUGGESTION_PROVIDER() { return net.minecraft.server.command.DatapackCommand.DISABLED_CONTAINERS_SUGGESTION_PROVIDER; }
// public static void DISABLED_CONTAINERS_SUGGESTION_PROVIDER(com.mojang.brigadier.suggestion.SuggestionProvider value, ) { net.minecraft.server.command.DatapackCommand.DISABLED_CONTAINERS_SUGGESTION_PROVIDER = value; }
...
// public static com.mojang.brigadier.exceptions.DynamicCommandExceptionType UNKNOWN_DATAPACK_EXCEPTION() { return net.minecraft.server.command.DatapackCommand.UNKNOWN_DATAPACK_EXCEPTION; }
// public static void UNKNOWN_DATAPACK_EXCEPTION(com.mojang.brigadier.exceptions.DynamicCommandExceptionType value, ) { net.minecraft.server.command.DatapackCommand.UNKNOWN_DATAPACK_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.DynamicCommandExceptionType ALREADY_ENABLED_EXCEPTION() { return net.minecraft.server.command.DatapackCommand.ALREADY_ENABLED_EXCEPTION; }
// public static void ALREADY_ENABLED_EXCEPTION(com.mojang.brigadier.exceptions.DynamicCommandExceptionType value, ) { net.minecraft.server.command.DatapackCommand.ALREADY_ENABLED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.DynamicCommandExceptionType ALREADY_DISABLED_EXCEPTION() { return net.minecraft.server.command.DatapackCommand.ALREADY_DISABLED_EXCEPTION; }
// public static void ALREADY_DISABLED_EXCEPTION(com.mojang.brigadier.exceptions.DynamicCommandExceptionType value, ) { net.minecraft.server.command.DatapackCommand.ALREADY_DISABLED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.suggestion.SuggestionProvider ENABLED_CONTAINERS_SUGGESTION_PROVIDER() { return net.minecraft.server.command.DatapackCommand.ENABLED_CONTAINERS_SUGGESTION_PROVIDER; }
// public static void ENABLED_CONTAINERS_SUGGESTION_PROVIDER(com.mojang.brigadier.suggestion.SuggestionProvider value, ) { net.minecraft.server.command.DatapackCommand.ENABLED_CONTAINERS_SUGGESTION_PROVIDER = value; }
...
// public static com.mojang.brigadier.exceptions.Dynamic2CommandExceptionType NO_FLAGS_EXCEPTION() { return net.minecraft.server.command.DatapackCommand.NO_FLAGS_EXCEPTION; }
// public static void NO_FLAGS_EXCEPTION(com.mojang.brigadier.exceptions.Dynamic2CommandExceptionType value, ) { net.minecraft.server.command.DatapackCommand.NO_FLAGS_EXCEPTION = value; }
...
// public static void method_13112(com.mojang.brigadier.context.CommandContext profiles,java.util.List profile, ) { net.minecraft.server.command.DatapackCommand.method_13112(profiles,profile); }
...
// public static int executeEnable(yarnwrap.server.command.ServerCommandSource source,yarnwrap.resource.ResourcePackProfile container,Object packAdder, ) { return net.minecraft.server.command.DatapackCommand.executeEnable(source.wrapperContained,container.wrapperContained,packAdder); }
// public int method_13115(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13115(context); }
// public static int method_13115(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.DatapackCommand.method_13115(context); }
// public int method_13116(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13116(context); }
// public static int method_13116(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.DatapackCommand.method_13116(context); }
...
// public static int executeList(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.command.DatapackCommand.executeList(source.wrapperContained); }
...
// public static yarnwrap.resource.ResourcePackProfile getPackContainer(com.mojang.brigadier.context.CommandContext context,java.lang.String name,boolean enable, ) { return new yarnwrap.resource.ResourcePackProfile(net.minecraft.server.command.DatapackCommand.getPackContainer(context,name,enable)); }
...
// public static int executeListAvailable(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.command.DatapackCommand.executeListAvailable(source.wrapperContained); }
// public int method_13130(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13130(context); }
// public static int method_13130(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.DatapackCommand.method_13130(context); }
// public com.mojang.brigadier.Message method_13131(java.lang.Object name) { return wrapperContained.method_13131(name); }
// public static com.mojang.brigadier.Message method_13131(java.lang.Object name, ) { return net.minecraft.server.command.DatapackCommand.method_13131(name); }
...
// public static yarnwrap.text.Text method_13132(yarnwrap.resource.ResourcePackProfile profile, ) { return new yarnwrap.text.Text(net.minecraft.server.command.DatapackCommand.method_13132(profile.wrapperContained)); }
...
// public static void method_13133(com.mojang.brigadier.context.CommandContext profiles,java.util.List profile, ) { net.minecraft.server.command.DatapackCommand.method_13133(profiles,profile); }
...
// public static yarnwrap.text.Text method_13134(yarnwrap.resource.ResourcePackProfile profile, ) { return new yarnwrap.text.Text(net.minecraft.server.command.DatapackCommand.method_13134(profile.wrapperContained)); }
// public com.mojang.brigadier.Message method_13135(java.lang.Object name) { return wrapperContained.method_13135(name); }
// public static com.mojang.brigadier.Message method_13135(java.lang.Object name, ) { return net.minecraft.server.command.DatapackCommand.method_13135(name); }
...
// public static java.util.concurrent.CompletableFuture method_13136(com.mojang.brigadier.context.CommandContext context,com.mojang.brigadier.suggestion.SuggestionsBuilder builder, ) { return net.minecraft.server.command.DatapackCommand.method_13136(context,builder); }
// public int method_13137(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13137(context); }
// public static int method_13137(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.DatapackCommand.method_13137(context); }
// public int method_13138(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13138(context); }
// public static int method_13138(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.DatapackCommand.method_13138(context); }
...
// public static void method_13139(java.util.List profiles,yarnwrap.resource.ResourcePackProfile profile, ) { net.minecraft.server.command.DatapackCommand.method_13139(profiles,profile.wrapperContained); }
...
// public static int executeDisable(yarnwrap.server.command.ServerCommandSource source,yarnwrap.resource.ResourcePackProfile container, ) { return net.minecraft.server.command.DatapackCommand.executeDisable(source.wrapperContained,container.wrapperContained); }
// public int method_13141(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13141(context); }
// public static int method_13141(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.DatapackCommand.method_13141(context); }
// public boolean method_29477(java.util.Collection profile) { return wrapperContained.method_29477(profile); }
// public static boolean method_29477(java.util.Collection profile, ) { return net.minecraft.server.command.DatapackCommand.method_29477(profile); }
// public boolean method_29776(java.util.Collection name) { return wrapperContained.method_29776(name); }
// public static boolean method_29776(java.util.Collection name, ) { return net.minecraft.server.command.DatapackCommand.method_29776(name); }
...
// public static boolean method_45145(yarnwrap.resource.featuretoggle.FeatureSet profile, ) { return net.minecraft.server.command.DatapackCommand.method_45145(profile.wrapperContained); }
