...
// public Object INSPECTOR() { return wrapperContained.INSPECTOR; }
// public void INSPECTOR(Object value) { wrapperContained.INSPECTOR = value; }
// // public static Object INSPECTOR() { return net.minecraft.server.command.CommandManager.INSPECTOR; }
// public static void INSPECTOR(Object value, ) { net.minecraft.server.command.CommandManager.INSPECTOR = value; }
...
// public void deepCopyNodes(com.mojang.brigadier.tree.CommandNode root,com.mojang.brigadier.tree.CommandNode newRoot,java.lang.Object source,java.util.Map nodes) { wrapperContained.deepCopyNodes(root,newRoot,source,nodes); }
// public static void deepCopyNodes(com.mojang.brigadier.tree.CommandNode root,com.mojang.brigadier.tree.CommandNode newRoot,java.lang.Object source,java.util.Map nodes, ) { net.minecraft.server.command.CommandManager.deepCopyNodes(root,newRoot,source,nodes); }
...
// public yarnwrap.command.CommandRegistryAccess createRegistryAccess(Object registries) { return new yarnwrap.command.CommandRegistryAccess(wrapperContained.createRegistryAccess(registries)); }
// public static yarnwrap.command.CommandRegistryAccess createRegistryAccess(Object registries, ) { return new yarnwrap.command.CommandRegistryAccess(net.minecraft.server.command.CommandManager.createRegistryAccess(registries)); }
...
// public yarnwrap.command.PermissionLevelPredicate requirePermissionLevel(int requiredLevel) { return new yarnwrap.command.PermissionLevelPredicate(wrapperContained.requirePermissionLevel(requiredLevel)); }
// public static yarnwrap.command.PermissionLevelPredicate requirePermissionLevel(int requiredLevel, ) { return new yarnwrap.command.PermissionLevelPredicate(net.minecraft.server.command.CommandManager.requirePermissionLevel(requiredLevel)); }
