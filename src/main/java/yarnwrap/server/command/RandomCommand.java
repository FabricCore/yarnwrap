...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType RANGE_TOO_LARGE_EXCEPTION() { return net.minecraft.server.command.RandomCommand.RANGE_TOO_LARGE_EXCEPTION; }
// public static void RANGE_TOO_LARGE_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.RandomCommand.RANGE_TOO_LARGE_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType RANGE_TOO_SMALL_EXCEPTION() { return net.minecraft.server.command.RandomCommand.RANGE_TOO_SMALL_EXCEPTION; }
// public static void RANGE_TOO_SMALL_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.command.RandomCommand.RANGE_TOO_SMALL_EXCEPTION = value; }

// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.command.RandomCommand.register(dispatcher); }
// public int method_52319(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_52319(context); }
// public static int method_52319(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.RandomCommand.method_52319(context); }
...
// public static java.util.concurrent.CompletableFuture suggestSequences(com.mojang.brigadier.context.CommandContext context,com.mojang.brigadier.suggestion.SuggestionsBuilder suggestionsBuilder, ) { return net.minecraft.server.command.RandomCommand.suggestSequences(context,suggestionsBuilder); }
...
// public static int executeReset(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.command.RandomCommand.executeReset(source.wrapperContained); }
...
// public static int executeReset(yarnwrap.server.command.ServerCommandSource source,int salt,boolean includeWorldSeed,boolean includeSequenceId, ) { return net.minecraft.server.command.RandomCommand.executeReset(source.wrapperContained,salt,includeWorldSeed,includeSequenceId); }
...
// public static int executeReset(yarnwrap.server.command.ServerCommandSource source,yarnwrap.util.Identifier sequenceId, ) { return net.minecraft.server.command.RandomCommand.executeReset(source.wrapperContained,sequenceId.wrapperContained); }
...
// public static int executeReset(yarnwrap.server.command.ServerCommandSource source,yarnwrap.util.Identifier sequenceId,int salt,boolean includeWorldSeed,boolean includeSequenceId, ) { return net.minecraft.server.command.RandomCommand.executeReset(source.wrapperContained,sequenceId.wrapperContained,salt,includeWorldSeed,includeSequenceId); }
...
// public static int execute(yarnwrap.server.command.ServerCommandSource source,Object range,yarnwrap.util.Identifier sequenceId,boolean roll, ) { return net.minecraft.server.command.RandomCommand.execute(source.wrapperContained,range,sequenceId.wrapperContained,roll); }
...
// public static com.mojang.brigadier.builder.LiteralArgumentBuilder random(java.lang.String argumentName,boolean roll, ) { return net.minecraft.server.command.RandomCommand.random(argumentName,roll); }
...
// public static void method_52327(java.util.List id,yarnwrap.util.Identifier sequence, ) { net.minecraft.server.command.RandomCommand.method_52327(id,sequence.wrapperContained); }
...
// public static int method_52338(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.RandomCommand.method_52338(context); }
// public int method_52339(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_52339(context); }
// public static int method_52339(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.RandomCommand.method_52339(context); }
// public int method_52340(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_52340(context); }
// public static int method_52340(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.RandomCommand.method_52340(context); }
// public int method_52341(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_52341(context); }
// public static int method_52341(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.RandomCommand.method_52341(context); }
