...
// public int method_13386(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13386(context); }
// public static int method_13386(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.GameModeCommand.method_13386(context); }
...
// public int method_13391(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13391(context); }
// public static int method_13391(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.command.GameModeCommand.method_13391(context); }
// public void execute(yarnwrap.server.network.ServerPlayerEntity target,yarnwrap.world.GameMode gameMode) { wrapperContained.execute(target.wrapperContained,gameMode.wrapperContained); }
// public static void execute(yarnwrap.server.network.ServerPlayerEntity target,yarnwrap.world.GameMode gameMode, ) { net.minecraft.server.command.GameModeCommand.execute(target.wrapperContained,gameMode.wrapperContained); }
// public boolean execute(yarnwrap.server.command.ServerCommandSource source,yarnwrap.server.network.ServerPlayerEntity target,yarnwrap.world.GameMode gameMode) { return wrapperContained.execute(source.wrapperContained,target.wrapperContained,gameMode.wrapperContained); }
// public static boolean execute(yarnwrap.server.command.ServerCommandSource source,yarnwrap.server.network.ServerPlayerEntity target,yarnwrap.world.GameMode gameMode, ) { return net.minecraft.server.command.GameModeCommand.execute(source.wrapperContained,target.wrapperContained,gameMode.wrapperContained); }
