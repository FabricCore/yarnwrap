...
// public static java.util.Comparator argumentComparator() { return net.minecraft.server.world.ChunkTicketType.argumentComparator; }
// public static void argumentComparator(java.util.Comparator value, ) { net.minecraft.server.world.ChunkTicketType.argumentComparator = value; }
...
public static yarnwrap.server.world.ChunkTicketType PLAYER() { return new yarnwrap.server.world.ChunkTicketType(net.minecraft.server.world.ChunkTicketType.PLAYER); }
// public static void PLAYER(yarnwrap.server.world.ChunkTicketType value, ) { net.minecraft.server.world.ChunkTicketType.PLAYER = value.wrapperContained; }

// public java.lang.String name() { return wrapperContained.name; }
// public void name(java.lang.String value) { wrapperContained.name = value; }
// public static java.lang.String name() { return net.minecraft.server.world.ChunkTicketType.name; }
// public static void name(java.lang.String value, ) { net.minecraft.server.world.ChunkTicketType.name = value; }
...
public static yarnwrap.server.world.ChunkTicketType POST_TELEPORT() { return new yarnwrap.server.world.ChunkTicketType(net.minecraft.server.world.ChunkTicketType.POST_TELEPORT); }
// public static void POST_TELEPORT(yarnwrap.server.world.ChunkTicketType value, ) { net.minecraft.server.world.ChunkTicketType.POST_TELEPORT = value.wrapperContained; }
...
// public static yarnwrap.server.world.ChunkTicketType create(java.lang.String name,java.util.Comparator argumentComparator, ) { return new yarnwrap.server.world.ChunkTicketType(net.minecraft.server.world.ChunkTicketType.create(name,argumentComparator)); }
public java.util.Comparator getArgumentComparator() { return wrapperContained.getArgumentComparator(); }
// public static java.util.Comparator getArgumentComparator() { return net.minecraft.server.world.ChunkTicketType.getArgumentComparator(); }
...
// public static int method_17315(yarnwrap.util.Unit a,yarnwrap.util.Unit b, ) { return net.minecraft.server.world.ChunkTicketType.method_17315(a.wrapperContained,b.wrapperContained); }
...
// public static int method_17316(yarnwrap.util.Unit a,yarnwrap.util.Unit b, ) { return net.minecraft.server.world.ChunkTicketType.method_17316(a.wrapperContained,b.wrapperContained); }
...
// public static yarnwrap.server.world.ChunkTicketType create(java.lang.String name,java.util.Comparator argumentComparator,int expiryTicks, ) { return new yarnwrap.server.world.ChunkTicketType(net.minecraft.server.world.ChunkTicketType.create(name,argumentComparator,expiryTicks)); }
public long getExpiryTicks() { return wrapperContained.getExpiryTicks(); }
// public static long getExpiryTicks() { return net.minecraft.server.world.ChunkTicketType.getExpiryTicks(); }
