...
// public static boolean method_13677(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.dedicated.command.StopCommand.method_13677(source.wrapperContained); }
