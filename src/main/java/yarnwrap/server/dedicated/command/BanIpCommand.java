...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType ALREADY_BANNED_EXCEPTION() { return net.minecraft.server.dedicated.command.BanIpCommand.ALREADY_BANNED_EXCEPTION; }
// public static void ALREADY_BANNED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.dedicated.command.BanIpCommand.ALREADY_BANNED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType INVALID_IP_EXCEPTION() { return net.minecraft.server.dedicated.command.BanIpCommand.INVALID_IP_EXCEPTION; }
// public static void INVALID_IP_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.dedicated.command.BanIpCommand.INVALID_IP_EXCEPTION = value; }

// public int method_13006(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13006(context); }
// public static int method_13006(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.dedicated.command.BanIpCommand.method_13006(context); }
...
// public static int banIp(yarnwrap.server.command.ServerCommandSource source,java.lang.String targetIp,yarnwrap.text.Text reason, ) { return net.minecraft.server.dedicated.command.BanIpCommand.banIp(source.wrapperContained,targetIp,reason.wrapperContained); }
// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.dedicated.command.BanIpCommand.register(dispatcher); }
