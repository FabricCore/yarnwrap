...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType ALREADY_ON_EXCEPTION() { return net.minecraft.server.dedicated.command.WhitelistCommand.ALREADY_ON_EXCEPTION; }
// public static void ALREADY_ON_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.dedicated.command.WhitelistCommand.ALREADY_ON_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType ADD_FAILED_EXCEPTION() { return net.minecraft.server.dedicated.command.WhitelistCommand.ADD_FAILED_EXCEPTION; }
// public static void ADD_FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.dedicated.command.WhitelistCommand.ADD_FAILED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType REMOVE_FAILED_EXCEPTION() { return net.minecraft.server.dedicated.command.WhitelistCommand.REMOVE_FAILED_EXCEPTION; }
// public static void REMOVE_FAILED_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.dedicated.command.WhitelistCommand.REMOVE_FAILED_EXCEPTION = value; }
...
// public static com.mojang.brigadier.exceptions.SimpleCommandExceptionType ALREADY_OFF_EXCEPTION() { return net.minecraft.server.dedicated.command.WhitelistCommand.ALREADY_OFF_EXCEPTION; }
// public static void ALREADY_OFF_EXCEPTION(com.mojang.brigadier.exceptions.SimpleCommandExceptionType value, ) { net.minecraft.server.dedicated.command.WhitelistCommand.ALREADY_OFF_EXCEPTION = value; }

// public int method_13834(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13834(context); }
// public static int method_13834(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13834(context); }
// public int method_13835(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13835(context); }
// public static int method_13835(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13835(context); }
// public void register(com.mojang.brigadier.CommandDispatcher dispatcher) { wrapperContained.register(dispatcher); }
// public static void register(com.mojang.brigadier.CommandDispatcher dispatcher, ) { net.minecraft.server.dedicated.command.WhitelistCommand.register(dispatcher); }
...
// public static int executeOff(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.executeOff(source.wrapperContained); }
...
// public static int executeAdd(yarnwrap.server.command.ServerCommandSource source,java.util.Collection targets, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.executeAdd(source.wrapperContained,targets); }
...
// public static int executeOn(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.executeOn(source.wrapperContained); }
...
// public static int executeList(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.executeList(source.wrapperContained); }
...
// public static boolean method_13841(yarnwrap.server.PlayerManager player, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13841(player.wrapperContained); }
// public int method_13842(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13842(context); }
// public static int method_13842(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13842(context); }
// public int method_13843(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13843(context); }
// public static int method_13843(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13843(context); }
...
// public static java.lang.String method_13844(yarnwrap.server.network.ServerPlayerEntity player, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13844(player.wrapperContained); }
...
// public static java.util.concurrent.CompletableFuture method_13849(com.mojang.brigadier.context.CommandContext context,com.mojang.brigadier.suggestion.SuggestionsBuilder builder, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13849(context,builder); }
...
// public static int executeReload(yarnwrap.server.command.ServerCommandSource source, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.executeReload(source.wrapperContained); }
// public int method_13851(com.mojang.brigadier.context.CommandContext context) { return wrapperContained.method_13851(context); }
// public static int method_13851(com.mojang.brigadier.context.CommandContext context, ) { return net.minecraft.server.dedicated.command.WhitelistCommand.method_13851(context); }
