...
// public static void forceUpgradeWorld(Object session,com.mojang.datafixers.DataFixer dataFixer,boolean eraseCache,java.util.function.BooleanSupplier continueCheck,yarnwrap.registry.DynamicRegistryManager dynamicRegistryManager,boolean recreateRegionFiles, ) { net.minecraft.server.Main.forceUpgradeWorld(session,dataFixer,eraseCache,continueCheck,dynamicRegistryManager.wrapperContained,recreateRegionFiles); }
