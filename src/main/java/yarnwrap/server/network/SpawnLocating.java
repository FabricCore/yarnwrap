...
// public static yarnwrap.util.math.BlockPos findOverworldSpawn(yarnwrap.server.world.ServerWorld world,int x,int z, ) { return new yarnwrap.util.math.BlockPos(net.minecraft.server.network.SpawnLocating.findOverworldSpawn(world.wrapperContained,x,z)); }
...
// public static yarnwrap.util.math.BlockPos findServerSpawnPoint(yarnwrap.server.world.ServerWorld world,yarnwrap.util.math.ChunkPos chunkPos, ) { return new yarnwrap.util.math.BlockPos(net.minecraft.server.network.SpawnLocating.findServerSpawnPoint(world.wrapperContained,chunkPos.wrapperContained)); }
