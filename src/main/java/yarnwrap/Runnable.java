...
@Override
public boolean beforeBlockOutline(WorldRenderContext context, HitResult hitResult) { Object res = runF(context, new yarnwrap.util.hit.HitResult(hitResult)); try { return (boolean) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (boolean) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (beforeBlockOutline)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public void beforeEntities(WorldRenderContext context) { runF(context); }

@Override
public boolean onBlockOutline(WorldRenderContext worldRenderContext, BlockOutlineContext blockOutlineContext) { Object res = runF(worldRenderContext, blockOutlineContext); try { return (boolean) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (boolean) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (onBlockOutline)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public boolean beforeBlockBreak(World world, PlayerEntity player, BlockPos pos, BlockState state, BlockEntity blockEntity) { Object res = runF(new yarnwrap.world.World(world), new yarnwrap.entity.player.PlayerEntity(player), new yarnwrap.util.math.BlockPos(pos), new yarnwrap.block.BlockState(state), new yarnwrap.block.entity.BlockEntity(blockEntity)); try { return (boolean) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (boolean) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (beforeBlockBreak)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public TriState allowEnchanting(RegistryEntry<Enchantment> enchantment, ItemStack target, EnchantingContext enchantingContext) { Object res = runF(enchantment, new yarnwrap.item.ItemStack(target), enchantingContext); try { return (TriState) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (TriState) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (allowEnchanting)\u00A77] \u00A7c" + e.toString()); return null; } }
...
@Override
public 		LootTable replaceLootTable(RegistryKey<LootTable> key, LootTable original, LootTableSource source, RegistryWrapper.WrapperLookup registries) { Object res = runF(key, new yarnwrap.loot.LootTable(original), source, registries); try { return (		LootTable) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (		LootTable) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (replaceLootTable)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public boolean allowChatMessage(SignedMessage message, ServerPlayerEntity sender, MessageType.Parameters params) { Object res = runF(new yarnwrap.network.message.SignedMessage(message), new yarnwrap.server.network.ServerPlayerEntity(sender), params); try { return (boolean) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (boolean) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (allowChatMessage)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowCommandMessage(SignedMessage message, ServerCommandSource source, MessageType.Parameters params) { Object res = runF(new yarnwrap.network.message.SignedMessage(message), new yarnwrap.server.command.ServerCommandSource(source), params); try { return (boolean) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (boolean) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (allowCommandMessage)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public 		Storage<FluidVariant> find(ContainerItemContext context) { Object res = runF(context); try { return (		Storage<FluidVariant>) res; } catch (Exception e) { try { Object step = ((org.mozilla.javascript.NativeJavaObject) res).unwrap(); return (		Storage<FluidVariant>) step.getClass().getField("wrapperContained").get(step); } catch (Exception _e) {} ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (find)\u00A77] \u00A7c" + e.toString()); return null; } }
}