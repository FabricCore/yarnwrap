...
@Override
public boolean allowReceiveChatMessage(Text message, SignedMessage signedMessage, GameProfile sender, MessageType.Parameters params, Instant receptionTimestamp) { Object res = runF(new yarnwrap.text.Text(message), new yarnwrap.network.message.SignedMessage(signedMessage), sender, params, receptionTimestamp); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowReceiveGameMessage(Text message, boolean overlay) { Object res = runF(new yarnwrap.text.Text(message), overlay); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public Text modifyReceivedGameMessage(Text message, boolean overlay) { Object res = runF(new yarnwrap.text.Text(message), overlay); try { return (Text) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public boolean allowSendChatMessage(String message) { Object res = runF(message); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowSendCommandMessage(String command) { Object res = runF(command); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public String modifySendChatMessage(String message) { Object res = runF(message); try { return (String) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public String modifySendCommandMessage(String command) { Object res = runF(command); try { return (String) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }
...
@Override
public boolean allowBlockDustTint(BlockState state, ClientWorld world, BlockPos pos) { Object res = runF(new yarnwrap.block.BlockState(state), new yarnwrap.client.world.ClientWorld(world), new yarnwrap.util.math.BlockPos(pos)); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowCapeRender(AbstractClientPlayerEntity player) { Object res = runF(new yarnwrap.client.network.AbstractClientPlayerEntity(player)); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public boolean beforeBlockOutline(WorldRenderContext context, HitResult hitResult) { Object res = runF(context, new yarnwrap.util.hit.HitResult(hitResult)); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public void beforeEntities(WorldRenderContext context) { runF(context); }

@Override
public boolean onBlockOutline(WorldRenderContext worldRenderContext, BlockOutlineContext blockOutlineContext) { Object res = runF(worldRenderContext, blockOutlineContext); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public boolean allowElytraFlight(LivingEntity entity) { Object res = runF(new yarnwrap.entity.LivingEntity(entity)); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean useCustomElytra(LivingEntity entity, boolean tickElytra) { Object res = runF(new yarnwrap.entity.LivingEntity(entity), tickElytra); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public ActionResult allowBed(LivingEntity entity, BlockPos sleepingPos, BlockState state, boolean vanillaResult) { Object res = runF(new yarnwrap.entity.LivingEntity(entity), new yarnwrap.util.math.BlockPos(sleepingPos), new yarnwrap.block.BlockState(state), vanillaResult); try { return (ActionResult) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public ActionResult allowNearbyMonsters(PlayerEntity player, BlockPos sleepingPos, boolean vanillaResult) { Object res = runF(new yarnwrap.entity.player.PlayerEntity(player), new yarnwrap.util.math.BlockPos(sleepingPos), vanillaResult); try { return (ActionResult) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public boolean allowResettingTime(PlayerEntity player) { Object res = runF(new yarnwrap.entity.player.PlayerEntity(player)); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowSettingSpawn(PlayerEntity player, BlockPos sleepingPos) { Object res = runF(new yarnwrap.entity.player.PlayerEntity(player), new yarnwrap.util.math.BlockPos(sleepingPos)); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public ActionResult allowSleepTime(PlayerEntity player, BlockPos sleepingPos, boolean vanillaResult) { Object res = runF(new yarnwrap.entity.player.PlayerEntity(player), new yarnwrap.util.math.BlockPos(sleepingPos), vanillaResult); try { return (ActionResult) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public 		PlayerEntity.SleepFailureReason allowSleep(PlayerEntity player, BlockPos sleepingPos) { Object res = runF(new yarnwrap.entity.player.PlayerEntity(player), new yarnwrap.util.math.BlockPos(sleepingPos)); try { return (		PlayerEntity.SleepFailureReason) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public 		Direction modifySleepDirection(LivingEntity entity, BlockPos sleepingPos, Direction sleepingDirection) { Object res = runF(new yarnwrap.entity.LivingEntity(entity), new yarnwrap.util.math.BlockPos(sleepingPos), new yarnwrap.util.math.Direction(sleepingDirection)); try { return (		Direction) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public 		Vec3d modifyWakeUpPosition(LivingEntity entity, BlockPos sleepingPos, BlockState bedState, Vec3d wakeUpPos) { Object res = runF(new yarnwrap.entity.LivingEntity(entity), new yarnwrap.util.math.BlockPos(sleepingPos), new yarnwrap.block.BlockState(bedState), new yarnwrap.util.math.Vec3d(wakeUpPos)); try { return (		Vec3d) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public boolean setBedOccupationState(LivingEntity entity, BlockPos sleepingPos, BlockState bedState, boolean occupied) { Object res = runF(new yarnwrap.entity.LivingEntity(entity), new yarnwrap.util.math.BlockPos(sleepingPos), new yarnwrap.block.BlockState(bedState), occupied); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public boolean allowDamage(LivingEntity entity, DamageSource source, float amount) { Object res = runF(new yarnwrap.entity.LivingEntity(entity), new yarnwrap.entity.damage.DamageSource(source), amount); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowDeath(LivingEntity entity, DamageSource damageSource, float damageAmount) { Object res = runF(new yarnwrap.entity.LivingEntity(entity), new yarnwrap.entity.damage.DamageSource(damageSource), damageAmount); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public boolean beforeBlockBreak(World world, PlayerEntity player, BlockPos pos, BlockState state, BlockEntity blockEntity) { Object res = runF(new yarnwrap.world.World(world), new yarnwrap.entity.player.PlayerEntity(player), new yarnwrap.util.math.BlockPos(pos), new yarnwrap.block.BlockState(state), new yarnwrap.block.entity.BlockEntity(blockEntity)); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public TriState allowEnchanting(RegistryEntry<Enchantment> enchantment, ItemStack target, EnchantingContext enchantingContext) { Object res = runF(enchantment, new yarnwrap.item.ItemStack(target), enchantingContext); try { return (TriState) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }
...
@Override
public 		LootTable replaceLootTable(RegistryKey<LootTable> key, LootTable original, LootTableSource source, RegistryWrapper.WrapperLookup registries) { Object res = runF(key, new yarnwrap.loot.LootTable(original), source, registries); try { return (		LootTable) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }

@Override
public boolean allowChatMessage(SignedMessage message, ServerPlayerEntity sender, MessageType.Parameters params) { Object res = runF(new yarnwrap.network.message.SignedMessage(message), new yarnwrap.server.network.ServerPlayerEntity(sender), params); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowCommandMessage(SignedMessage message, ServerCommandSource source, MessageType.Parameters params) { Object res = runF(new yarnwrap.network.message.SignedMessage(message), new yarnwrap.server.command.ServerCommandSource(source), params); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }

@Override
public boolean allowGameMessage(MinecraftServer server, Text message, boolean overlay) { Object res = runF(new yarnwrap.server.MinecraftServer(server), new yarnwrap.text.Text(message), overlay); try { return (boolean) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return true; } }
...
@Override
public 		Storage<FluidVariant> find(ContainerItemContext context) { Object res = runF(context); try { return (		Storage<FluidVariant>) res; } catch (Exception e) { ws.siri.jscore.Core.log("\u00A77[\u00A7cCastError (Event)\u00A77] \u00A7c" + e.toString()); return null; } }
}