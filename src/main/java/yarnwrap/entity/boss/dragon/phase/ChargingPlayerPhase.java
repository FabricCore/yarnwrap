...
// public static void chargingTicks(int value, ) { net.minecraft.entity.boss.dragon.phase.ChargingPlayerPhase.chargingTicks = value; }
...
// public static yarnwrap.util.math.Vec3d pathTarget() { return new yarnwrap.util.math.Vec3d(net.minecraft.entity.boss.dragon.phase.ChargingPlayerPhase.pathTarget); }
// public static void pathTarget(yarnwrap.util.math.Vec3d value, ) { net.minecraft.entity.boss.dragon.phase.ChargingPlayerPhase.pathTarget = value.wrapperContained; }
