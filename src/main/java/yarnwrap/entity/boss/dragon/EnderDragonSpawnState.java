...
// public static void run(yarnwrap.server.world.ServerWorld world,yarnwrap.entity.boss.dragon.EnderDragonFight fight,java.util.List crystals,int tick,yarnwrap.util.math.BlockPos pos, ) { net.minecraft.entity.boss.dragon.EnderDragonSpawnState.run(world.wrapperContained,fight.wrapperContained,crystals,tick,pos.wrapperContained); }
