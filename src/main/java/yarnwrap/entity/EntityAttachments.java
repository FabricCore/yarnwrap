...
// public java.util.List method_66251(float type) { return wrapperContained.method_66251(type); }
// public static java.util.List method_66251(float type, ) { return net.minecraft.entity.EntityAttachments.method_66251(type); }
// public yarnwrap.util.math.Vec3d getPointOrDefault(yarnwrap.entity.EntityAttachmentType type) { return new yarnwrap.util.math.Vec3d(wrapperContained.getPointOrDefault(type.wrapperContained)); }
// public static yarnwrap.util.math.Vec3d getPointOrDefault(yarnwrap.entity.EntityAttachmentType type, ) { return new yarnwrap.util.math.Vec3d(net.minecraft.entity.EntityAttachments.getPointOrDefault(type.wrapperContained)); }
