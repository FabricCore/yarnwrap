...
// public static yarnwrap.entity.EntityInteraction create(java.lang.String key, ) { return new yarnwrap.entity.EntityInteraction(net.minecraft.entity.EntityInteraction.create(key)); }
