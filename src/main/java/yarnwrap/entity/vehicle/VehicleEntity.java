...
// public static void killAndDropItem(yarnwrap.item.Item selfAsItem, ) { net.minecraft.entity.vehicle.VehicleEntity.killAndDropItem(selfAsItem.wrapperContained); }
...
// public static void killAndDropSelf(yarnwrap.entity.damage.DamageSource source, ) { net.minecraft.entity.vehicle.VehicleEntity.killAndDropSelf(source.wrapperContained); }
