...
// public static yarnwrap.entity.Entity thrower() { return new yarnwrap.entity.Entity(net.minecraft.entity.ItemEntity.thrower); }
// public static void thrower(yarnwrap.entity.Entity value, ) { net.minecraft.entity.ItemEntity.thrower = value.wrapperContained; }
...
// public static java.util.UUID throwerUuid() { return net.minecraft.entity.ItemEntity.throwerUuid; }
// public static void throwerUuid(java.util.UUID value, ) { net.minecraft.entity.ItemEntity.throwerUuid = value; }
...
// public static float getRotation(float tickDelta, ) { return net.minecraft.entity.ItemEntity.getRotation(tickDelta); }
