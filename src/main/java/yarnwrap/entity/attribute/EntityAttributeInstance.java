...
public void addPersistentModifiers(java.util.Collection modifiers) { wrapperContained.addPersistentModifiers(modifiers); }
// public static void addPersistentModifiers(java.util.Collection modifiers, ) { net.minecraft.entity.attribute.EntityAttributeInstance.addPersistentModifiers(modifiers); }
public java.util.Set getPersistentModifiers() { return wrapperContained.getPersistentModifiers(); }
// public static java.util.Set getPersistentModifiers() { return net.minecraft.entity.attribute.EntityAttributeInstance.getPersistentModifiers(); }
// public void unpack(Object packed) { wrapperContained.unpack(packed); }
// public static void unpack(Object packed, ) { net.minecraft.entity.attribute.EntityAttributeInstance.unpack(packed); }
// public Object pack() { return wrapperContained.pack(); }
// public static Object pack() { return net.minecraft.entity.attribute.EntityAttributeInstance.pack(); }
