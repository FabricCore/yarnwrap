...
// public boolean DEFAULT_SITTING() { return wrapperContained.DEFAULT_SITTING; }
// public void DEFAULT_SITTING(boolean value) { wrapperContained.DEFAULT_SITTING = value; }
// public static boolean DEFAULT_SITTING() { return net.minecraft.entity.passive.TameableEntity.DEFAULT_SITTING; }
// public static void DEFAULT_SITTING(boolean value, ) { net.minecraft.entity.passive.TameableEntity.DEFAULT_SITTING = value; }

public void setTamedBy(yarnwrap.entity.player.PlayerEntity player) { wrapperContained.setTamedBy(player.wrapperContained); }
// public static void setTamedBy(yarnwrap.entity.player.PlayerEntity player, ) { net.minecraft.entity.passive.TameableEntity.setTamedBy(player.wrapperContained); }
...
// public static void setOwner(yarnwrap.entity.LivingEntity owner, ) { net.minecraft.entity.passive.TameableEntity.setOwner(owner.wrapperContained); }
...
// public static void setOwner(yarnwrap.entity.LazyEntityReference owner, ) { net.minecraft.entity.passive.TameableEntity.setOwner(owner.wrapperContained); }
