...
// public static yarnwrap.util.math.intprovider.UniformIntProvider WALK_TOWARD_ADULT_RANGE() { return new yarnwrap.util.math.intprovider.UniformIntProvider(net.minecraft.entity.passive.AxolotlBrain.WALK_TOWARD_ADULT_RANGE); }
// public static void WALK_TOWARD_ADULT_RANGE(yarnwrap.util.math.intprovider.UniformIntProvider value, ) { net.minecraft.entity.passive.AxolotlBrain.WALK_TOWARD_ADULT_RANGE = value.wrapperContained; }
...
// public static float BREEDING_SPEED() { return net.minecraft.entity.passive.AxolotlBrain.BREEDING_SPEED; }
// public static void BREEDING_SPEED(float value, ) { net.minecraft.entity.passive.AxolotlBrain.BREEDING_SPEED = value; }
...
// public static float ON_LAND_SPEED() { return net.minecraft.entity.passive.AxolotlBrain.ON_LAND_SPEED; }
// public static void ON_LAND_SPEED(float value, ) { net.minecraft.entity.passive.AxolotlBrain.ON_LAND_SPEED = value; }
...
// public static float IDLE_SPEED() { return net.minecraft.entity.passive.AxolotlBrain.IDLE_SPEED; }
// public static void IDLE_SPEED(float value, ) { net.minecraft.entity.passive.AxolotlBrain.IDLE_SPEED = value; }
...
// public static float TARGET_APPROACHING_SPEED() { return net.minecraft.entity.passive.AxolotlBrain.TARGET_APPROACHING_SPEED; }
// public static void TARGET_APPROACHING_SPEED(float value, ) { net.minecraft.entity.passive.AxolotlBrain.TARGET_APPROACHING_SPEED = value; }
...
// public static float ADULT_FOLLOWING_SPEED() { return net.minecraft.entity.passive.AxolotlBrain.ADULT_FOLLOWING_SPEED; }
// public static void ADULT_FOLLOWING_SPEED(float value, ) { net.minecraft.entity.passive.AxolotlBrain.ADULT_FOLLOWING_SPEED = value; }

// public java.util.function.Predicate getTemptItemPredicate() { return wrapperContained.getTemptItemPredicate(); }
public static java.util.function.Predicate getTemptItemPredicate() { return net.minecraft.entity.passive.AxolotlBrain.getTemptItemPredicate(); }
...
// public static float getTargetApproachingSpeed(yarnwrap.entity.LivingEntity entity, ) { return net.minecraft.entity.passive.AxolotlBrain.getTargetApproachingSpeed(entity.wrapperContained); }
...
// public static yarnwrap.entity.ai.brain.Brain create(yarnwrap.entity.ai.brain.Brain brain, ) { return new yarnwrap.entity.ai.brain.Brain(net.minecraft.entity.passive.AxolotlBrain.create(brain.wrapperContained)); }
...
// public static void updateActivities(yarnwrap.entity.passive.AxolotlEntity axolotl, ) { net.minecraft.entity.passive.AxolotlBrain.updateActivities(axolotl.wrapperContained); }
...
// public static void addFightActivities(yarnwrap.entity.ai.brain.Brain brain, ) { net.minecraft.entity.passive.AxolotlBrain.addFightActivities(brain.wrapperContained); }
...
// public static void addCoreActivities(yarnwrap.entity.ai.brain.Brain brain, ) { net.minecraft.entity.passive.AxolotlBrain.addCoreActivities(brain.wrapperContained); }
...
// public static void addIdleActivities(yarnwrap.entity.ai.brain.Brain brain, ) { net.minecraft.entity.passive.AxolotlBrain.addIdleActivities(brain.wrapperContained); }
...
// public static boolean canGoToLookTarget(yarnwrap.entity.LivingEntity entity, ) { return net.minecraft.entity.passive.AxolotlBrain.canGoToLookTarget(entity.wrapperContained); }
// public boolean method_58387(yarnwrap.item.ItemStack stack) { return wrapperContained.method_58387(stack.wrapperContained); }
// public static boolean method_58387(yarnwrap.item.ItemStack stack, ) { return net.minecraft.entity.passive.AxolotlBrain.method_58387(stack.wrapperContained); }
