...
// public static float getWarningAnimationProgress(float tickDelta, ) { return net.minecraft.entity.passive.PolarBearEntity.getWarningAnimationProgress(tickDelta); }
