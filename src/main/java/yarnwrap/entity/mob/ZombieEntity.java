...
// public static void ticksUntilWaterConversion(int value, ) { net.minecraft.entity.mob.ZombieEntity.ticksUntilWaterConversion = value; }
...
// public static yarnwrap.entity.data.TrackedData CONVERTING_IN_WATER() { return new yarnwrap.entity.data.TrackedData(net.minecraft.entity.mob.ZombieEntity.CONVERTING_IN_WATER); }
// public static void CONVERTING_IN_WATER(yarnwrap.entity.data.TrackedData value, ) { net.minecraft.entity.mob.ZombieEntity.CONVERTING_IN_WATER = value.wrapperContained; }
...
// public static int inWaterTime() { return net.minecraft.entity.mob.ZombieEntity.inWaterTime; }
// public static void inWaterTime(int value, ) { net.minecraft.entity.mob.ZombieEntity.inWaterTime = value; }
...
// public static yarnwrap.entity.data.TrackedData ZOMBIE_TYPE() { return new yarnwrap.entity.data.TrackedData(net.minecraft.entity.mob.ZombieEntity.ZOMBIE_TYPE); }
// public static void ZOMBIE_TYPE(yarnwrap.entity.data.TrackedData value, ) { net.minecraft.entity.mob.ZombieEntity.ZOMBIE_TYPE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier BABY_SPEED_MODIFIER_ID() { return new yarnwrap.util.Identifier(net.minecraft.entity.mob.ZombieEntity.BABY_SPEED_MODIFIER_ID); }
// public static void BABY_SPEED_MODIFIER_ID(yarnwrap.util.Identifier value, ) { net.minecraft.entity.mob.ZombieEntity.BABY_SPEED_MODIFIER_ID = value.wrapperContained; }
...
// public static yarnwrap.entity.attribute.EntityAttributeModifier BABY_SPEED_BONUS() { return new yarnwrap.entity.attribute.EntityAttributeModifier(net.minecraft.entity.mob.ZombieEntity.BABY_SPEED_BONUS); }
// public static void BABY_SPEED_BONUS(yarnwrap.entity.attribute.EntityAttributeModifier value, ) { net.minecraft.entity.mob.ZombieEntity.BABY_SPEED_BONUS = value.wrapperContained; }
...
// public static void canBreakDoors(boolean value, ) { net.minecraft.entity.mob.ZombieEntity.canBreakDoors = value; }
...
// public static yarnwrap.entity.ai.goal.BreakDoorGoal breakDoorsGoal() { return new yarnwrap.entity.ai.goal.BreakDoorGoal(net.minecraft.entity.mob.ZombieEntity.breakDoorsGoal); }
// public static void breakDoorsGoal(yarnwrap.entity.ai.goal.BreakDoorGoal value, ) { net.minecraft.entity.mob.ZombieEntity.breakDoorsGoal = value.wrapperContained; }
...
// public static void convertTo(yarnwrap.entity.EntityType entityType, ) { net.minecraft.entity.mob.ZombieEntity.convertTo(entityType.wrapperContained); }
public void setCanBreakDoors(boolean canBreakDoors) { wrapperContained.setCanBreakDoors(canBreakDoors); }
// public static void setCanBreakDoors(boolean canBreakDoors, ) { net.minecraft.entity.mob.ZombieEntity.setCanBreakDoors(canBreakDoors); }
// public void applyAttributeModifiers(float chanceMultiplier) { wrapperContained.applyAttributeModifiers(chanceMultiplier); }
// public static void applyAttributeModifiers(float chanceMultiplier, ) { net.minecraft.entity.mob.ZombieEntity.applyAttributeModifiers(chanceMultiplier); }
public boolean isConvertingInWater() { return wrapperContained.isConvertingInWater(); }
// public static boolean isConvertingInWater() { return net.minecraft.entity.mob.ZombieEntity.isConvertingInWater(); }
// public yarnwrap.sound.SoundEvent getStepSound() { return new yarnwrap.sound.SoundEvent(wrapperContained.getStepSound()); }
// public static yarnwrap.sound.SoundEvent getStepSound() { return new yarnwrap.sound.SoundEvent(net.minecraft.entity.mob.ZombieEntity.getStepSound()); }
// public void initCustomGoals() { wrapperContained.initCustomGoals(); }
// public static void initCustomGoals() { net.minecraft.entity.mob.ZombieEntity.initCustomGoals(); }
...
// public static yarnwrap.item.ItemStack getSkull() { return new yarnwrap.item.ItemStack(net.minecraft.entity.mob.ZombieEntity.getSkull()); }
