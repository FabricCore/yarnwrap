...
public class BreezeBrain { public net.minecraft.entity.mob.BreezeBrain wrapperContained; public BreezeBrain(net.minecraft.entity.mob.BreezeBrain wrapperContained) { this.wrapperContained = wrapperContained; }
...
// public static java.util.List SENSORS() { return net.minecraft.entity.mob.BreezeBrain.SENSORS; }
// public static void SENSORS(java.util.List value, ) { net.minecraft.entity.mob.BreezeBrain.SENSORS = value; }
...
// public static void addCoreTasks(yarnwrap.entity.ai.brain.Brain brain, ) { net.minecraft.entity.mob.BreezeBrain.addCoreTasks(brain.wrapperContained); }
