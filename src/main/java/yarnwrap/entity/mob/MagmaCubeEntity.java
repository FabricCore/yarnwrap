...
// public static boolean canMagmaCubeSpawn(yarnwrap.entity.EntityType type,yarnwrap.world.WorldAccess world,yarnwrap.entity.SpawnReason spawnReason,yarnwrap.util.math.BlockPos pos,yarnwrap.util.math.random.Random random, ) { return net.minecraft.entity.mob.MagmaCubeEntity.canMagmaCubeSpawn(type.wrapperContained,world.wrapperContained,spawnReason.wrapperContained,pos.wrapperContained,random.wrapperContained); }
// public Object createMagmaCubeAttributes() { return wrapperContained.createMagmaCubeAttributes(); }
public static Object createMagmaCubeAttributes() { return net.minecraft.entity.mob.MagmaCubeEntity.createMagmaCubeAttributes(); }
