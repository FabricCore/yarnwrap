...
// // public static yarnwrap.entity.LazyEntityReference owner() { return new yarnwrap.entity.LazyEntityReference(net.minecraft.entity.mob.VexEntity.owner); }
// // public static void owner(yarnwrap.entity.LazyEntityReference value, ) { net.minecraft.entity.mob.VexEntity.owner = value.wrapperContained; }
