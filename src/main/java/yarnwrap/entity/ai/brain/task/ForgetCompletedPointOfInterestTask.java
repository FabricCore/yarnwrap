...
// public static int MAX_RANGE() { return net.minecraft.entity.ai.brain.task.ForgetCompletedPointOfInterestTask.MAX_RANGE; }
// public static void MAX_RANGE(int value, ) { net.minecraft.entity.ai.brain.task.ForgetCompletedPointOfInterestTask.MAX_RANGE = value; }
...
// public static boolean isBedOccupiedByOthers(yarnwrap.server.world.ServerWorld world,yarnwrap.util.math.BlockPos pos,yarnwrap.entity.LivingEntity entity, ) { return net.minecraft.entity.ai.brain.task.ForgetCompletedPointOfInterestTask.isBedOccupiedByOthers(world.wrapperContained,pos.wrapperContained,entity.wrapperContained); }
...
// public static boolean method_47187(Object world,yarnwrap.entity.ai.brain.MemoryQueryResult entity,java.util.function.Predicate time, ) { return net.minecraft.entity.ai.brain.task.ForgetCompletedPointOfInterestTask.method_47187(world,entity.wrapperContained,time); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_47188(Object poiPos, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.ForgetCompletedPointOfInterestTask.method_47188(poiPos)); }
