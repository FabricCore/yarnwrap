...
// public static com.mojang.datafixers.kinds.App method_47081(int context, ) { return net.minecraft.entity.ai.brain.task.FindInteractionTargetTask.method_47081(context); }
...
// public static yarnwrap.entity.ai.brain.task.Task create(yarnwrap.entity.EntityType type,int maxDistance, ) { return new yarnwrap.entity.ai.brain.task.Task(net.minecraft.entity.ai.brain.task.FindInteractionTargetTask.create(type.wrapperContained,maxDistance)); }
...
// public static boolean method_47083(yarnwrap.entity.LivingEntity target, ) { return net.minecraft.entity.ai.brain.task.FindInteractionTargetTask.method_47083(target.wrapperContained); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_47084(Object lookTarget,int interactionTarget,yarnwrap.entity.EntityType visibleMobs, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.FindInteractionTargetTask.method_47084(lookTarget,interactionTarget,visibleMobs.wrapperContained)); }
...
// public static boolean method_47085(Object world,yarnwrap.entity.ai.brain.MemoryQueryResult entity,int time, ) { return net.minecraft.entity.ai.brain.task.FindInteractionTargetTask.method_47085(world,entity.wrapperContained,time); }
