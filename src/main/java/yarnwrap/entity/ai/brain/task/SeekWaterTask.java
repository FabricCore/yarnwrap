...
// public static yarnwrap.entity.ai.brain.task.Task create(int range,float speed, ) { return new yarnwrap.entity.ai.brain.task.Task(net.minecraft.entity.ai.brain.task.SeekWaterTask.create(range,speed)); }
...
// public static com.mojang.datafixers.kinds.App method_47177(org.apache.commons.lang3.mutable.MutableLong context, ) { return net.minecraft.entity.ai.brain.task.SeekWaterTask.method_47177(context); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_47178(org.apache.commons.lang3.mutable.MutableLong attackTarget,int walkTarget,float lookTarget, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.SeekWaterTask.method_47178(attackTarget,walkTarget,lookTarget)); }
...
// public static boolean method_47179(org.apache.commons.lang3.mutable.MutableLong world,int entity,yarnwrap.entity.ai.brain.MemoryQueryResult time, ) { return net.minecraft.entity.ai.brain.task.SeekWaterTask.method_47179(world,entity,time.wrapperContained); }
