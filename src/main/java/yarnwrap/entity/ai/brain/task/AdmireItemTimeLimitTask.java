...
// public static yarnwrap.entity.ai.brain.task.Task create(int cooldown,int timeLimit, ) { return new yarnwrap.entity.ai.brain.task.Task(net.minecraft.entity.ai.brain.task.AdmireItemTimeLimitTask.create(cooldown,timeLimit)); }
// public com.mojang.datafixers.kinds.App method_47295(int context) { return wrapperContained.method_47295(context); }
// public static com.mojang.datafixers.kinds.App method_47295(int context, ) { return net.minecraft.entity.ai.brain.task.AdmireItemTimeLimitTask.method_47295(context); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_47296(Object admiringItem,int nearestVisibleWantedItem,int timeTryingToReachAdmireItem,yarnwrap.entity.ai.brain.MemoryQueryResult disableWalkToAdmireItem, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.AdmireItemTimeLimitTask.method_47296(admiringItem,nearestVisibleWantedItem,timeTryingToReachAdmireItem,disableWalkToAdmireItem.wrapperContained)); }
...
// public static boolean method_47297(Object world,yarnwrap.entity.ai.brain.MemoryQueryResult entity,int time, ) { return net.minecraft.entity.ai.brain.task.AdmireItemTimeLimitTask.method_47297(world,entity.wrapperContained,time); }
