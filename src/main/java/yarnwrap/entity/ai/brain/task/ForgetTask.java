...
// public static com.mojang.datafixers.kinds.App method_46919(yarnwrap.entity.ai.brain.MemoryModuleType context, ) { return net.minecraft.entity.ai.brain.task.ForgetTask.method_46919(context.wrapperContained); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_46920(java.util.function.Predicate queryResult, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.ForgetTask.method_46920(queryResult)); }
...
// public static boolean method_46921(java.util.function.Predicate world,yarnwrap.entity.ai.brain.MemoryQueryResult entity,yarnwrap.server.world.ServerWorld time, ) { return net.minecraft.entity.ai.brain.task.ForgetTask.method_46921(world,entity.wrapperContained,time.wrapperContained); }
...
// public static yarnwrap.entity.ai.brain.task.Task create(java.util.function.Predicate condition,yarnwrap.entity.ai.brain.MemoryModuleType memory, ) { return new yarnwrap.entity.ai.brain.task.Task(net.minecraft.entity.ai.brain.task.ForgetTask.create(condition,memory.wrapperContained)); }
