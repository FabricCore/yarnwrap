...
public static yarnwrap.entity.ai.brain.task.Task create() { return new yarnwrap.entity.ai.brain.task.Task(net.minecraft.entity.ai.brain.task.LookAtDisturbanceTask.create()); }
// public com.mojang.datafixers.kinds.App method_47260(Object context) { return wrapperContained.method_47260(context); }
// public static com.mojang.datafixers.kinds.App method_47260(Object context, ) { return net.minecraft.entity.ai.brain.task.LookAtDisturbanceTask.method_47260(context); }
...
// public static boolean method_47262(Object world,yarnwrap.entity.ai.brain.MemoryQueryResult entity,yarnwrap.entity.ai.brain.MemoryQueryResult time, ) { return net.minecraft.entity.ai.brain.task.LookAtDisturbanceTask.method_47262(world,entity.wrapperContained,time.wrapperContained); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_47263(Object lookTarget,yarnwrap.entity.ai.brain.MemoryQueryResult disturbanceLocation,yarnwrap.entity.ai.brain.MemoryQueryResult roarTarget,yarnwrap.entity.ai.brain.MemoryQueryResult attackTarget, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.LookAtDisturbanceTask.method_47263(lookTarget,disturbanceLocation.wrapperContained,roarTarget.wrapperContained,attackTarget.wrapperContained)); }
