...
// public static yarnwrap.entity.ai.brain.task.SingleTickTask create(float speed,int completionRange, ) { return new yarnwrap.entity.ai.brain.task.SingleTickTask(net.minecraft.entity.ai.brain.task.GoTowardsLookTargetTask.create(speed,completionRange)); }
// public java.lang.Float method_47105(float entity) { return wrapperContained.method_47105(entity); }
// public static java.lang.Float method_47105(float entity, ) { return net.minecraft.entity.ai.brain.task.GoTowardsLookTargetTask.method_47105(entity); }
...
// public static boolean method_47106(yarnwrap.entity.LivingEntity entity, ) { return net.minecraft.entity.ai.brain.task.GoTowardsLookTargetTask.method_47106(entity.wrapperContained); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_47107(java.util.function.Predicate walkTarget,Object lookTarget, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.GoTowardsLookTargetTask.method_47107(walkTarget,lookTarget)); }
...
// public static boolean method_47108(java.util.function.Predicate world,yarnwrap.entity.ai.brain.MemoryQueryResult entity,Object time, ) { return net.minecraft.entity.ai.brain.task.GoTowardsLookTargetTask.method_47108(world,entity.wrapperContained,time); }
...
// public static yarnwrap.entity.ai.brain.task.SingleTickTask create(java.util.function.Predicate predicate,java.util.function.Function speed,int completionRange, ) { return new yarnwrap.entity.ai.brain.task.SingleTickTask(net.minecraft.entity.ai.brain.task.GoTowardsLookTargetTask.create(predicate,speed,completionRange)); }
...
// public static com.mojang.datafixers.kinds.App method_47110(java.util.function.Predicate context, ) { return net.minecraft.entity.ai.brain.task.GoTowardsLookTargetTask.method_47110(context); }
