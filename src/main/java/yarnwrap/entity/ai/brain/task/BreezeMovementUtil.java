...
// public void MAX_MOVE_DISTANCE(double value) { wrapperContained.MAX_MOVE_DISTANCE = value; }
// public static double MAX_MOVE_DISTANCE() { return net.minecraft.entity.ai.brain.task.BreezeMovementUtil.MAX_MOVE_DISTANCE; }
// public static void MAX_MOVE_DISTANCE(double value, ) { net.minecraft.entity.ai.brain.task.BreezeMovementUtil.MAX_MOVE_DISTANCE = value; }
