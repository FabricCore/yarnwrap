...
public static yarnwrap.entity.ai.brain.task.Task create() { return new yarnwrap.entity.ai.brain.task.Task(net.minecraft.entity.ai.brain.task.RemoveOffHandItemTask.create()); }
...
// public static boolean method_47299(yarnwrap.server.world.ServerWorld world,yarnwrap.entity.mob.PiglinEntity entity,long time, ) { return net.minecraft.entity.ai.brain.task.RemoveOffHandItemTask.method_47299(world.wrapperContained,entity.wrapperContained,time); }
// public com.mojang.datafixers.kinds.App method_47300(Object context) { return wrapperContained.method_47300(context); }
// public static com.mojang.datafixers.kinds.App method_47300(Object context, ) { return net.minecraft.entity.ai.brain.task.RemoveOffHandItemTask.method_47300(context); }
...
// public static yarnwrap.entity.ai.brain.task.TaskRunnable method_47301(yarnwrap.entity.ai.brain.MemoryQueryResult admiringItem, ) { return new yarnwrap.entity.ai.brain.task.TaskRunnable(net.minecraft.entity.ai.brain.task.RemoveOffHandItemTask.method_47301(admiringItem.wrapperContained)); }
