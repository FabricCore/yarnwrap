...
// public static boolean trigger(yarnwrap.server.world.ServerWorld world,yarnwrap.entity.LivingEntity entity,long time, ) { return net.minecraft.entity.ai.brain.task.TaskRunnable.trigger(world.wrapperContained,entity.wrapperContained,time); }
