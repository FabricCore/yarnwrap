...
// public static void MAX_SQUARED_RANGE(int value, ) { net.minecraft.entity.ai.brain.task.BreezeShootTask.MAX_SQUARED_RANGE = value; }
...
// public static int BASE_PROJECTILE_DIVERGENCY() { return net.minecraft.entity.ai.brain.task.BreezeShootTask.BASE_PROJECTILE_DIVERGENCY; }
// public static void BASE_PROJECTILE_DIVERGENCY(int value, ) { net.minecraft.entity.ai.brain.task.BreezeShootTask.BASE_PROJECTILE_DIVERGENCY = value; }
...
// public static int PROJECTILE_DIVERGENCY_DIFFICULTY_MODIFIER() { return net.minecraft.entity.ai.brain.task.BreezeShootTask.PROJECTILE_DIVERGENCY_DIFFICULTY_MODIFIER; }
// public static void PROJECTILE_DIVERGENCY_DIFFICULTY_MODIFIER(int value, ) { net.minecraft.entity.ai.brain.task.BreezeShootTask.PROJECTILE_DIVERGENCY_DIFFICULTY_MODIFIER = value; }
...
// public static float PROJECTILE_SPEED() { return net.minecraft.entity.ai.brain.task.BreezeShootTask.PROJECTILE_SPEED; }
// public static void PROJECTILE_SPEED(float value, ) { net.minecraft.entity.ai.brain.task.BreezeShootTask.PROJECTILE_SPEED = value; }
...
// public static int SHOOT_CHARGING_EXPIRY() { return net.minecraft.entity.ai.brain.task.BreezeShootTask.SHOOT_CHARGING_EXPIRY; }
// public static void SHOOT_CHARGING_EXPIRY(int value, ) { net.minecraft.entity.ai.brain.task.BreezeShootTask.SHOOT_CHARGING_EXPIRY = value; }
...
// public static int RECOVER_EXPIRY() { return net.minecraft.entity.ai.brain.task.BreezeShootTask.RECOVER_EXPIRY; }
// public static void RECOVER_EXPIRY(int value, ) { net.minecraft.entity.ai.brain.task.BreezeShootTask.RECOVER_EXPIRY = value; }
...
// public static boolean isTargetWithinRange(yarnwrap.entity.mob.BreezeEntity breeze,yarnwrap.entity.LivingEntity target, ) { return net.minecraft.entity.ai.brain.task.BreezeShootTask.isTargetWithinRange(breeze.wrapperContained,target.wrapperContained); }
// public void method_55043(yarnwrap.entity.mob.BreezeEntity target) { wrapperContained.method_55043(target.wrapperContained); }
// public static void method_55043(yarnwrap.entity.mob.BreezeEntity target, ) { net.minecraft.entity.ai.brain.task.BreezeShootTask.method_55043(target.wrapperContained); }
...
// public static java.lang.Boolean method_55045(yarnwrap.entity.mob.BreezeEntity target, ) { return net.minecraft.entity.ai.brain.task.BreezeShootTask.method_55045(target.wrapperContained); }
