...
public static int MAX_RANGE() { return net.minecraft.entity.ai.brain.sensor.NearestItemsSensor.MAX_RANGE; }
// public static void MAX_RANGE(int value, ) { net.minecraft.entity.ai.brain.sensor.NearestItemsSensor.MAX_RANGE = value; }
...
// public static long HORIZONTAL_RANGE() { return net.minecraft.entity.ai.brain.sensor.NearestItemsSensor.HORIZONTAL_RANGE; }
// public static void HORIZONTAL_RANGE(long value, ) { net.minecraft.entity.ai.brain.sensor.NearestItemsSensor.HORIZONTAL_RANGE = value; }
...
// public static boolean method_24646(yarnwrap.entity.mob.MobEntity itemEntity, ) { return net.minecraft.entity.ai.brain.sensor.NearestItemsSensor.method_24646(itemEntity.wrapperContained); }
