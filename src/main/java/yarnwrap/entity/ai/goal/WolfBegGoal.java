...
// public static yarnwrap.server.world.ServerWorld world() { return new yarnwrap.server.world.ServerWorld(net.minecraft.entity.ai.goal.WolfBegGoal.world); }
// public static void world(yarnwrap.server.world.ServerWorld value, ) { net.minecraft.entity.ai.goal.WolfBegGoal.world = value.wrapperContained; }
