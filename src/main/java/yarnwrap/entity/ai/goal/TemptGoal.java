...
// public static void lastPlayerY(double value, ) { net.minecraft.entity.ai.goal.TemptGoal.lastPlayerY = value; }

// public int cooldown() { return wrapperContained.cooldown; }
// public void cooldown(int value) { wrapperContained.cooldown = value; }
// public static int cooldown() { return net.minecraft.entity.ai.goal.TemptGoal.cooldown; }
// public static void cooldown(int value, ) { net.minecraft.entity.ai.goal.TemptGoal.cooldown = value; }

// public boolean active() { return wrapperContained.active; }
// public void active(boolean value) { wrapperContained.active = value; }
// public static boolean active() { return net.minecraft.entity.ai.goal.TemptGoal.active; }
// public static void active(boolean value, ) { net.minecraft.entity.ai.goal.TemptGoal.active = value; }
...
// public static double lastPlayerX() { return net.minecraft.entity.ai.goal.TemptGoal.lastPlayerX; }
// public static void lastPlayerX(double value, ) { net.minecraft.entity.ai.goal.TemptGoal.lastPlayerX = value; }
...
// public static yarnwrap.entity.player.PlayerEntity closestPlayer() { return new yarnwrap.entity.player.PlayerEntity(net.minecraft.entity.ai.goal.TemptGoal.closestPlayer); }
// public static void closestPlayer(yarnwrap.entity.player.PlayerEntity value, ) { net.minecraft.entity.ai.goal.TemptGoal.closestPlayer = value.wrapperContained; }
...
// public static double lastPlayerYaw() { return net.minecraft.entity.ai.goal.TemptGoal.lastPlayerYaw; }
// public static void lastPlayerYaw(double value, ) { net.minecraft.entity.ai.goal.TemptGoal.lastPlayerYaw = value; }
...
// public static double lastPlayerPitch() { return net.minecraft.entity.ai.goal.TemptGoal.lastPlayerPitch; }
// public static void lastPlayerPitch(double value, ) { net.minecraft.entity.ai.goal.TemptGoal.lastPlayerPitch = value; }
...
// public static void canBeScared(boolean value, ) { net.minecraft.entity.ai.goal.TemptGoal.canBeScared = value; }
