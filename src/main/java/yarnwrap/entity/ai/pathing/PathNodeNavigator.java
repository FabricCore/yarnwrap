...
// public static yarnwrap.entity.ai.pathing.Path findPathToAny(yarnwrap.util.profiler.Profiler profiler,yarnwrap.entity.ai.pathing.PathNode startNode,java.util.Map positions,float followRange,int distance,float rangeMultiplier, ) { return new yarnwrap.entity.ai.pathing.Path(net.minecraft.entity.ai.pathing.PathNodeNavigator.findPathToAny(profiler.wrapperContained,startNode.wrapperContained,positions,followRange,distance,rangeMultiplier)); }
