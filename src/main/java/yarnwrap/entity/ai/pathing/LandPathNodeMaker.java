...
// public yarnwrap.entity.ai.pathing.PathNode getPathNode(int x,int y,int z,int maxYStep,double lastFeetY,yarnwrap.util.math.Direction direction,yarnwrap.entity.ai.pathing.PathNodeType nodeType) { return new yarnwrap.entity.ai.pathing.PathNode(wrapperContained.getPathNode(x,y,z,maxYStep,lastFeetY,direction.wrapperContained,nodeType.wrapperContained)); }
// public static yarnwrap.entity.ai.pathing.PathNode getPathNode(int x,int y,int z,int maxYStep,double lastFeetY,yarnwrap.util.math.Direction direction,yarnwrap.entity.ai.pathing.PathNodeType nodeType, ) { return new yarnwrap.entity.ai.pathing.PathNode(net.minecraft.entity.ai.pathing.LandPathNodeMaker.getPathNode(x,y,z,maxYStep,lastFeetY,direction.wrapperContained,nodeType.wrapperContained)); }
...
// public yarnwrap.entity.ai.pathing.PathNode getJumpOnTopNode(int x,int y,int z,int maxYStep,double lastFeetY,yarnwrap.util.math.Direction direction,yarnwrap.entity.ai.pathing.PathNodeType nodeType,Object mutablePos) { return new yarnwrap.entity.ai.pathing.PathNode(wrapperContained.getJumpOnTopNode(x,y,z,maxYStep,lastFeetY,direction.wrapperContained,nodeType.wrapperContained,mutablePos)); }
// public static yarnwrap.entity.ai.pathing.PathNode getJumpOnTopNode(int x,int y,int z,int maxYStep,double lastFeetY,yarnwrap.util.math.Direction direction,yarnwrap.entity.ai.pathing.PathNodeType nodeType,Object mutablePos, ) { return new yarnwrap.entity.ai.pathing.PathNode(net.minecraft.entity.ai.pathing.LandPathNodeMaker.getJumpOnTopNode(x,y,z,maxYStep,lastFeetY,direction.wrapperContained,nodeType.wrapperContained,mutablePos)); }
