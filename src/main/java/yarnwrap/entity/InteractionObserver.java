...
// public static void onInteractionWith(yarnwrap.entity.EntityInteraction interaction,yarnwrap.entity.Entity entity, ) { net.minecraft.entity.InteractionObserver.onInteractionWith(interaction.wrapperContained,entity.wrapperContained); }
