...
// public static void setEquipmentFromTable(yarnwrap.entity.EquipmentTable equipmentTable,yarnwrap.loot.context.LootContextParameterSet parameters, ) { net.minecraft.entity.EquipmentHolder.setEquipmentFromTable(equipmentTable.wrapperContained,parameters.wrapperContained); }
...
// public static void setEquipmentFromTable(yarnwrap.registry.RegistryKey lootTable,yarnwrap.loot.context.LootContextParameterSet parameters,long seed,java.util.Map slotDropChances, ) { net.minecraft.entity.EquipmentHolder.setEquipmentFromTable(lootTable.wrapperContained,parameters.wrapperContained,seed,slotDropChances); }
...
// public static void setEquipmentFromTable(yarnwrap.registry.RegistryKey lootTable,yarnwrap.loot.context.LootContextParameterSet parameters,java.util.Map slotDropChances, ) { net.minecraft.entity.EquipmentHolder.setEquipmentFromTable(lootTable.wrapperContained,parameters.wrapperContained,slotDropChances); }
