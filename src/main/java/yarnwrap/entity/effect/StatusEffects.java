...
// public static int DARKNESS_PADDING_DURATION() { return net.minecraft.entity.effect.StatusEffects.DARKNESS_PADDING_DURATION; }
// public static void DARKNESS_PADDING_DURATION(int value, ) { net.minecraft.entity.effect.StatusEffects.DARKNESS_PADDING_DURATION = value; }
...
// public static yarnwrap.registry.entry.RegistryEntry register(java.lang.String id,yarnwrap.entity.effect.StatusEffect statusEffect, ) { return new yarnwrap.registry.entry.RegistryEntry(net.minecraft.entity.effect.StatusEffects.register(id,statusEffect.wrapperContained)); }
...
// public static yarnwrap.registry.entry.RegistryEntry registerAndGetDefault(yarnwrap.registry.Registry registry, ) { return new yarnwrap.registry.entry.RegistryEntry(net.minecraft.entity.effect.StatusEffects.registerAndGetDefault(registry.wrapperContained)); }
...
// public static int method_58624(yarnwrap.util.math.random.Random random, ) { return net.minecraft.entity.effect.StatusEffects.method_58624(random.wrapperContained); }
...
// public static int method_58625(yarnwrap.util.math.random.Random random, ) { return net.minecraft.entity.effect.StatusEffects.method_58625(random.wrapperContained); }
...
// public static int method_58626(yarnwrap.util.math.random.Random random, ) { return net.minecraft.entity.effect.StatusEffects.method_58626(random.wrapperContained); }
