...
// public static float getFadeFactor(yarnwrap.entity.LivingEntity entity,float tickDelta, ) { return net.minecraft.entity.effect.StatusEffectInstance.getFadeFactor(entity.wrapperContained,tickDelta); }
...
// public static yarnwrap.nbt.NbtElement writeNbt() { return new yarnwrap.nbt.NbtElement(net.minecraft.entity.effect.StatusEffectInstance.writeNbt()); }
...
// public static yarnwrap.entity.effect.StatusEffectInstance fromNbt(yarnwrap.nbt.NbtCompound nbt, ) { return new yarnwrap.entity.effect.StatusEffectInstance(net.minecraft.entity.effect.StatusEffectInstance.fromNbt(nbt.wrapperContained)); }
...
// public static boolean update(yarnwrap.entity.LivingEntity entity,java.lang.Runnable overwriteCallback, ) { return net.minecraft.entity.effect.StatusEffectInstance.update(entity.wrapperContained,overwriteCallback); }
...
// public static int updateDuration() { return net.minecraft.entity.effect.StatusEffectInstance.updateDuration(); }
...
// public static void onEntityDamage(yarnwrap.entity.LivingEntity entity,yarnwrap.entity.damage.DamageSource source,float amount, ) { net.minecraft.entity.effect.StatusEffectInstance.onEntityDamage(entity.wrapperContained,source.wrapperContained,amount); }
...
// public static void onEntityRemoval(yarnwrap.entity.LivingEntity entity,Object reason, ) { net.minecraft.entity.effect.StatusEffectInstance.onEntityRemoval(entity.wrapperContained,reason); }
