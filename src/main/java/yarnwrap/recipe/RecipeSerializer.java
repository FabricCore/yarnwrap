...
// public static void ARMOR_DYE(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.ARMOR_DYE = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer SHAPELESS() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.SHAPELESS); }
// public static void SHAPELESS(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.SHAPELESS = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer FIREWORK_STAR_FADE() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.FIREWORK_STAR_FADE); }
// public static void FIREWORK_STAR_FADE(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.FIREWORK_STAR_FADE = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer SHAPED() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.SHAPED); }
// public static void SHAPED(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.SHAPED = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer FIREWORK_STAR() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.FIREWORK_STAR); }
// public static void FIREWORK_STAR(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.FIREWORK_STAR = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer TIPPED_ARROW() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.TIPPED_ARROW); }
// public static void TIPPED_ARROW(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.TIPPED_ARROW = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer BANNER_DUPLICATE() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.BANNER_DUPLICATE); }
// public static void BANNER_DUPLICATE(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.BANNER_DUPLICATE = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer MAP_EXTENDING() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.MAP_EXTENDING); }
// public static void MAP_EXTENDING(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.MAP_EXTENDING = value.wrapperContained; }
...
// public static void SMELTING(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.SMELTING = value.wrapperContained; }
...
public static yarnwrap.recipe.RecipeSerializer FIREWORK_ROCKET() { return new yarnwrap.recipe.RecipeSerializer(net.minecraft.recipe.RecipeSerializer.FIREWORK_ROCKET); }
// public static void FIREWORK_ROCKET(yarnwrap.recipe.RecipeSerializer value, ) { net.minecraft.recipe.RecipeSerializer.FIREWORK_ROCKET = value.wrapperContained; }
...
// public static com.mojang.serialization.MapCodec codec() { return net.minecraft.recipe.RecipeSerializer.codec(); }
...
// public static yarnwrap.network.codec.PacketCodec packetCodec() { return new yarnwrap.network.codec.PacketCodec(net.minecraft.recipe.RecipeSerializer.packetCodec()); }
