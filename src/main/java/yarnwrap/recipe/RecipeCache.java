...
// public static java.util.Optional getAndCacheRecipe(yarnwrap.recipe.input.CraftingRecipeInput input,yarnwrap.world.World world, ) { return net.minecraft.recipe.RecipeCache.getAndCacheRecipe(input.wrapperContained,world.wrapperContained); }
...
// public static void validateRecipeManager(yarnwrap.world.World world, ) { net.minecraft.recipe.RecipeCache.validateRecipeManager(world.wrapperContained); }
...
// public static java.util.Optional getRecipe(yarnwrap.world.World world,yarnwrap.recipe.input.CraftingRecipeInput input, ) { return net.minecraft.recipe.RecipeCache.getRecipe(world.wrapperContained,input.wrapperContained); }
