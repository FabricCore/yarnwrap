...
// public yarnwrap.component.MergedComponentMap components() { return new yarnwrap.component.MergedComponentMap(wrapperContained.components); }
// public void components(yarnwrap.component.MergedComponentMap value) { wrapperContained.components = value.wrapperContained; }
// public static yarnwrap.component.MergedComponentMap components() { return new yarnwrap.component.MergedComponentMap(net.minecraft.item.ItemStack.components); }
// public static void components(yarnwrap.component.MergedComponentMap value, ) { net.minecraft.item.ItemStack.components = value.wrapperContained; }
...
// public java.util.List OPERATOR_WARNINGS() { return wrapperContained.OPERATOR_WARNINGS; }
// public void OPERATOR_WARNINGS(java.util.List value) { wrapperContained.OPERATOR_WARNINGS = value; }
// public static java.util.List OPERATOR_WARNINGS() { return net.minecraft.item.ItemStack.OPERATOR_WARNINGS; }
// public static void OPERATOR_WARNINGS(java.util.List value, ) { net.minecraft.item.ItemStack.OPERATOR_WARNINGS = value; }
...
public static com.mojang.serialization.MapCodec MAP_CODEC() { return net.minecraft.item.ItemStack.MAP_CODEC; }
// public static void MAP_CODEC(com.mojang.serialization.MapCodec value, ) { net.minecraft.item.ItemStack.MAP_CODEC = value; }

// public yarnwrap.text.Text UNBREAKABLE_TEXT() { return new yarnwrap.text.Text(wrapperContained.UNBREAKABLE_TEXT); }
// public void UNBREAKABLE_TEXT(yarnwrap.text.Text value) { wrapperContained.UNBREAKABLE_TEXT = value.wrapperContained; }
// public static yarnwrap.text.Text UNBREAKABLE_TEXT() { return new yarnwrap.text.Text(net.minecraft.item.ItemStack.UNBREAKABLE_TEXT); }
// public static void UNBREAKABLE_TEXT(yarnwrap.text.Text value, ) { net.minecraft.item.ItemStack.UNBREAKABLE_TEXT = value.wrapperContained; }

// public yarnwrap.network.codec.PacketCodec LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC() { return new yarnwrap.network.codec.PacketCodec(wrapperContained.LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC); }
// public void LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC(yarnwrap.network.codec.PacketCodec value) { wrapperContained.LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC = value.wrapperContained; }
public static yarnwrap.network.codec.PacketCodec LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC() { return new yarnwrap.network.codec.PacketCodec(net.minecraft.item.ItemStack.LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC); }
// public static void LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC(yarnwrap.network.codec.PacketCodec value, ) { net.minecraft.item.ItemStack.LENGTH_PREPENDED_OPTIONAL_PACKET_CODEC = value.wrapperContained; }
...
// public ItemStack(yarnwrap.item.ItemConvertible item,int count,yarnwrap.component.MergedComponentMap components) { this.wrapperContained = new net.minecraft.item.ItemStack(item.wrapperContained,count,components.wrapperContained); }
...
// public static yarnwrap.util.ActionResult use(yarnwrap.world.World world,yarnwrap.entity.player.PlayerEntity user,yarnwrap.util.Hand hand, ) { return new yarnwrap.util.ActionResult(net.minecraft.item.ItemStack.use(world.wrapperContained,user.wrapperContained,hand.wrapperContained)); }
...
public void inventoryTick(yarnwrap.world.World world,yarnwrap.entity.Entity entity,yarnwrap.entity.EquipmentSlot slot) { wrapperContained.inventoryTick(world.wrapperContained,entity.wrapperContained,slot.wrapperContained); }
// public static void inventoryTick(yarnwrap.world.World world,yarnwrap.entity.Entity entity,yarnwrap.entity.EquipmentSlot slot, ) { net.minecraft.item.ItemStack.inventoryTick(world.wrapperContained,entity.wrapperContained,slot.wrapperContained); }
...
public yarnwrap.item.consume.UseAction getUseAction() { return new yarnwrap.item.consume.UseAction(wrapperContained.getUseAction()); }
// public static yarnwrap.item.consume.UseAction getUseAction() { return new yarnwrap.item.consume.UseAction(net.minecraft.item.ItemStack.getUseAction()); }
...
public boolean postHit(yarnwrap.entity.LivingEntity target,yarnwrap.entity.LivingEntity user) { return wrapperContained.postHit(target.wrapperContained,user.wrapperContained); }
// public static boolean postHit(yarnwrap.entity.LivingEntity target,yarnwrap.entity.LivingEntity user, ) { return net.minecraft.item.ItemStack.postHit(target.wrapperContained,user.wrapperContained); }
...
public void onCraftByPlayer(yarnwrap.entity.player.PlayerEntity player,int amount) { wrapperContained.onCraftByPlayer(player.wrapperContained,amount); }
// public static void onCraftByPlayer(yarnwrap.entity.player.PlayerEntity player,int amount, ) { net.minecraft.item.ItemStack.onCraftByPlayer(player.wrapperContained,amount); }
...
// public com.mojang.serialization.MapCodec method_57352(com.mojang.serialization.Codec codec) { return wrapperContained.method_57352(codec); }
// public static com.mojang.serialization.MapCodec method_57352(com.mojang.serialization.Codec codec, ) { return net.minecraft.item.ItemStack.method_57352(codec); }
...
// public void appendAttributeModifiersTooltip(java.util.function.Consumer textConsumer,yarnwrap.component.type.TooltipDisplayComponent displayComponent,yarnwrap.entity.player.PlayerEntity player) { wrapperContained.appendAttributeModifiersTooltip(textConsumer,displayComponent.wrapperContained,player.wrapperContained); }
// public static void appendAttributeModifiersTooltip(java.util.function.Consumer textConsumer,yarnwrap.component.type.TooltipDisplayComponent displayComponent,yarnwrap.entity.player.PlayerEntity player, ) { net.minecraft.item.ItemStack.appendAttributeModifiersTooltip(textConsumer,displayComponent.wrapperContained,player.wrapperContained); }
...
// public void appendComponentTooltip(yarnwrap.component.ComponentType componentType,Object context,yarnwrap.component.type.TooltipDisplayComponent displayComponent,java.util.function.Consumer textConsumer,yarnwrap.item.tooltip.TooltipType type) { wrapperContained.appendComponentTooltip(componentType.wrapperContained,context,displayComponent.wrapperContained,textConsumer,type.wrapperContained); }
// public static void appendComponentTooltip(yarnwrap.component.ComponentType componentType,Object context,yarnwrap.component.type.TooltipDisplayComponent displayComponent,java.util.function.Consumer textConsumer,yarnwrap.item.tooltip.TooltipType type, ) { net.minecraft.item.ItemStack.appendComponentTooltip(componentType.wrapperContained,context,displayComponent.wrapperContained,textConsumer,type.wrapperContained); }
// public void method_57370(org.apache.commons.lang3.mutable.MutableBoolean attribute,java.util.function.Consumer modifier,yarnwrap.component.type.AttributeModifierSlot display) { wrapperContained.method_57370(attribute,modifier,display.wrapperContained); }
// public static void method_57370(org.apache.commons.lang3.mutable.MutableBoolean attribute,java.util.function.Consumer modifier,yarnwrap.component.type.AttributeModifierSlot display, ) { net.minecraft.item.ItemStack.method_57370(attribute,modifier,display.wrapperContained); }
...
public void postDamageEntity(yarnwrap.entity.LivingEntity target,yarnwrap.entity.LivingEntity user) { wrapperContained.postDamageEntity(target.wrapperContained,user.wrapperContained); }
// public static void postDamageEntity(yarnwrap.entity.LivingEntity target,yarnwrap.entity.LivingEntity user, ) { net.minecraft.item.ItemStack.postDamageEntity(target.wrapperContained,user.wrapperContained); }
...
// public void applyAttributeModifier(yarnwrap.component.type.AttributeModifierSlot slot,org.apache.commons.lang3.function.TriConsumer attributeModifierConsumer) { wrapperContained.applyAttributeModifier(slot.wrapperContained,attributeModifierConsumer); }
// public static void applyAttributeModifier(yarnwrap.component.type.AttributeModifierSlot slot,org.apache.commons.lang3.function.TriConsumer attributeModifierConsumer, ) { net.minecraft.item.ItemStack.applyAttributeModifier(slot.wrapperContained,attributeModifierConsumer); }
...
// public int calculateDamage(int baseDamage,yarnwrap.server.world.ServerWorld world,yarnwrap.server.network.ServerPlayerEntity player) { return wrapperContained.calculateDamage(baseDamage,world.wrapperContained,player.wrapperContained); }
// public static int calculateDamage(int baseDamage,yarnwrap.server.world.ServerWorld world,yarnwrap.server.network.ServerPlayerEntity player, ) { return net.minecraft.item.ItemStack.calculateDamage(baseDamage,world.wrapperContained,player.wrapperContained); }
// public void onDurabilityChange(int damage,yarnwrap.server.network.ServerPlayerEntity player,java.util.function.Consumer breakCallback) { wrapperContained.onDurabilityChange(damage,player.wrapperContained,breakCallback); }
// public static void onDurabilityChange(int damage,yarnwrap.server.network.ServerPlayerEntity player,java.util.function.Consumer breakCallback, ) { net.minecraft.item.ItemStack.onDurabilityChange(damage,player.wrapperContained,breakCallback); }
public void damage(int amount,yarnwrap.entity.player.PlayerEntity player) { wrapperContained.damage(amount,player.wrapperContained); }
// public static void damage(int amount,yarnwrap.entity.player.PlayerEntity player, ) { net.minecraft.item.ItemStack.damage(amount,player.wrapperContained); }
// public void method_61654(yarnwrap.item.Item item) { wrapperContained.method_61654(item.wrapperContained); }
// public static void method_61654(yarnwrap.item.Item item, ) { net.minecraft.item.ItemStack.method_61654(item.wrapperContained); }
public boolean canRepairWith(yarnwrap.item.ItemStack ingredient) { return wrapperContained.canRepairWith(ingredient.wrapperContained); }
// public static boolean canRepairWith(yarnwrap.item.ItemStack ingredient, ) { return net.minecraft.item.ItemStack.canRepairWith(ingredient.wrapperContained); }
public boolean shouldBreak() { return wrapperContained.shouldBreak(); }
// public static boolean shouldBreak() { return net.minecraft.item.ItemStack.shouldBreak(); }
// public yarnwrap.item.ItemStack applyRemainderAndCooldown(yarnwrap.entity.LivingEntity user,yarnwrap.item.ItemStack stack) { return new yarnwrap.item.ItemStack(wrapperContained.applyRemainderAndCooldown(user.wrapperContained,stack.wrapperContained)); }
// public static yarnwrap.item.ItemStack applyRemainderAndCooldown(yarnwrap.entity.LivingEntity user,yarnwrap.item.ItemStack stack, ) { return new yarnwrap.item.ItemStack(net.minecraft.item.ItemStack.applyRemainderAndCooldown(user.wrapperContained,stack.wrapperContained)); }
public yarnwrap.text.Text getFormattedName() { return new yarnwrap.text.Text(wrapperContained.getFormattedName()); }
// public static yarnwrap.text.Text getFormattedName() { return new yarnwrap.text.Text(net.minecraft.item.ItemStack.getFormattedName()); }
public boolean willBreakNextUse() { return wrapperContained.willBreakNextUse(); }
// public static boolean willBreakNextUse() { return net.minecraft.item.ItemStack.willBreakNextUse(); }
public yarnwrap.text.Text getItemName() { return new yarnwrap.text.Text(wrapperContained.getItemName()); }
// public static yarnwrap.text.Text getItemName() { return new yarnwrap.text.Text(net.minecraft.item.ItemStack.getItemName()); }
public yarnwrap.text.Text getCustomName() { return new yarnwrap.text.Text(wrapperContained.getCustomName()); }
// public static yarnwrap.text.Text getCustomName() { return new yarnwrap.text.Text(net.minecraft.item.ItemStack.getCustomName()); }
public yarnwrap.component.ComponentMap getImmutableComponents() { return new yarnwrap.component.ComponentMap(wrapperContained.getImmutableComponents()); }
// public static yarnwrap.component.ComponentMap getImmutableComponents() { return new yarnwrap.component.ComponentMap(net.minecraft.item.ItemStack.getImmutableComponents()); }
public boolean hasChangedComponent(yarnwrap.component.ComponentType type) { return wrapperContained.hasChangedComponent(type.wrapperContained); }
// public static boolean hasChangedComponent(yarnwrap.component.ComponentType type, ) { return net.minecraft.item.ItemStack.hasChangedComponent(type.wrapperContained); }
public boolean canMine(yarnwrap.block.BlockState state,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.entity.player.PlayerEntity player) { return wrapperContained.canMine(state.wrapperContained,world.wrapperContained,pos.wrapperContained,player.wrapperContained); }
// public static boolean canMine(yarnwrap.block.BlockState state,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.entity.player.PlayerEntity player, ) { return net.minecraft.item.ItemStack.canMine(state.wrapperContained,world.wrapperContained,pos.wrapperContained,player.wrapperContained); }
public void copy(yarnwrap.component.ComponentType type,yarnwrap.component.ComponentsAccess from) { wrapperContained.copy(type.wrapperContained,from.wrapperContained); }
// public static void copy(yarnwrap.component.ComponentType type,yarnwrap.component.ComponentsAccess from, ) { net.minecraft.item.ItemStack.copy(type.wrapperContained,from.wrapperContained); }
// public void appendTooltip(Object context,yarnwrap.component.type.TooltipDisplayComponent displayComponent,yarnwrap.entity.player.PlayerEntity player,yarnwrap.item.tooltip.TooltipType type,java.util.function.Consumer textConsumer) { wrapperContained.appendTooltip(context,displayComponent.wrapperContained,player.wrapperContained,type.wrapperContained,textConsumer); }
// public static void appendTooltip(Object context,yarnwrap.component.type.TooltipDisplayComponent displayComponent,yarnwrap.entity.player.PlayerEntity player,yarnwrap.item.tooltip.TooltipType type,java.util.function.Consumer textConsumer, ) { net.minecraft.item.ItemStack.appendTooltip(context,displayComponent.wrapperContained,player.wrapperContained,type.wrapperContained,textConsumer); }
// public yarnwrap.network.codec.PacketCodec createOptionalPacketCodec(yarnwrap.network.codec.PacketCodec componentsPacketCodec) { return new yarnwrap.network.codec.PacketCodec(wrapperContained.createOptionalPacketCodec(componentsPacketCodec.wrapperContained)); }
// public static yarnwrap.network.codec.PacketCodec createOptionalPacketCodec(yarnwrap.network.codec.PacketCodec componentsPacketCodec, ) { return new yarnwrap.network.codec.PacketCodec(net.minecraft.item.ItemStack.createOptionalPacketCodec(componentsPacketCodec.wrapperContained)); }
// public void method_70724(org.apache.commons.lang3.function.TriConsumer attribute,yarnwrap.registry.entry.RegistryEntry modifier) { wrapperContained.method_70724(attribute,modifier.wrapperContained); }
// public static void method_70724(org.apache.commons.lang3.function.TriConsumer attribute,yarnwrap.registry.entry.RegistryEntry modifier, ) { net.minecraft.item.ItemStack.method_70724(attribute,modifier.wrapperContained); }
// public void damage(int amount,yarnwrap.entity.LivingEntity entity,yarnwrap.util.Hand hand) { wrapperContained.damage(amount,entity.wrapperContained,hand.wrapperContained); }
// public static void damage(int amount,yarnwrap.entity.LivingEntity entity,yarnwrap.util.Hand hand, ) { net.minecraft.item.ItemStack.damage(amount,entity.wrapperContained,hand.wrapperContained); }
