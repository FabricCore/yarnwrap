...
// public static void setBlockEntityData(yarnwrap.item.ItemStack stack,yarnwrap.block.entity.BlockEntityType type,yarnwrap.nbt.NbtCompound nbt, ) { net.minecraft.item.BlockItem.setBlockEntityData(stack.wrapperContained,type.wrapperContained,nbt.wrapperContained); }
