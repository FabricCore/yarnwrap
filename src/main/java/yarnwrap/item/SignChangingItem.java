...
// public static boolean useOnSign(yarnwrap.world.World world,yarnwrap.block.entity.SignBlockEntity signBlockEntity,boolean front,yarnwrap.entity.player.PlayerEntity player, ) { return net.minecraft.item.SignChangingItem.useOnSign(world.wrapperContained,signBlockEntity.wrapperContained,front,player.wrapperContained); }
...
// public static boolean canUseOnSignText(yarnwrap.block.entity.SignText signText,yarnwrap.entity.player.PlayerEntity player, ) { return net.minecraft.item.SignChangingItem.canUseOnSignText(signText.wrapperContained,player.wrapperContained); }
