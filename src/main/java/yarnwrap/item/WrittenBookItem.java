...
// public static boolean resolve(yarnwrap.item.ItemStack book,yarnwrap.server.command.ServerCommandSource commandSource,yarnwrap.entity.player.PlayerEntity player, ) { return net.minecraft.item.WrittenBookItem.resolve(book.wrapperContained,commandSource.wrapperContained,player.wrapperContained); }
