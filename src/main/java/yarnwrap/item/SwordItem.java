...
// public static yarnwrap.component.type.AttributeModifiersComponent createAttributeModifiers(yarnwrap.item.ToolMaterial material,int baseAttackDamage,float attackSpeed, ) { return new yarnwrap.component.type.AttributeModifiersComponent(net.minecraft.item.SwordItem.createAttributeModifiers(material.wrapperContained,baseAttackDamage,attackSpeed)); }
...
// public static yarnwrap.component.type.ToolComponent createToolComponent() { return new yarnwrap.component.type.ToolComponent(net.minecraft.item.SwordItem.createToolComponent()); }
