...
// public static yarnwrap.entity.projectile.PersistentProjectileEntity createArrow(yarnwrap.world.World world,yarnwrap.item.ItemStack stack,yarnwrap.entity.LivingEntity shooter,yarnwrap.item.ItemStack shotFrom, ) { return new yarnwrap.entity.projectile.PersistentProjectileEntity(net.minecraft.item.ArrowItem.createArrow(world.wrapperContained,stack.wrapperContained,shooter.wrapperContained,shotFrom.wrapperContained)); }
