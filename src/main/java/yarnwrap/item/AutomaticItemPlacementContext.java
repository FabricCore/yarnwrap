...
// public static yarnwrap.util.math.Direction facing() { return new yarnwrap.util.math.Direction(net.minecraft.item.AutomaticItemPlacementContext.facing); }
// public static void facing(yarnwrap.util.math.Direction value, ) { net.minecraft.item.AutomaticItemPlacementContext.facing = value.wrapperContained; }
