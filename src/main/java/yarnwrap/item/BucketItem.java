...
// public void playEmptyingSound(yarnwrap.entity.LivingEntity user,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos) { wrapperContained.playEmptyingSound(user.wrapperContained,world.wrapperContained,pos.wrapperContained); }
// public static void playEmptyingSound(yarnwrap.entity.LivingEntity user,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos, ) { net.minecraft.item.BucketItem.playEmptyingSound(user.wrapperContained,world.wrapperContained,pos.wrapperContained); }
