...
public static com.mojang.serialization.Codec LIST_CODEC() { return net.minecraft.item.map.MapBannerMarker.LIST_CODEC; }
// public static void LIST_CODEC(com.mojang.serialization.Codec value, ) { net.minecraft.item.map.MapBannerMarker.LIST_CODEC = value; }
