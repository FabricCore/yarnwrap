...
// public static yarnwrap.block.BlockState method_34717(yarnwrap.block.BlockState block, ) { return new yarnwrap.block.BlockState(net.minecraft.item.AxeItem.method_34717(block.wrapperContained)); }
...
// public static java.util.Optional tryStrip(yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.entity.player.PlayerEntity player,yarnwrap.block.BlockState state, ) { return net.minecraft.item.AxeItem.tryStrip(world.wrapperContained,pos.wrapperContained,player.wrapperContained,state.wrapperContained); }
...
// public static yarnwrap.block.BlockState method_54761(yarnwrap.block.BlockState block, ) { return new yarnwrap.block.BlockState(net.minecraft.item.AxeItem.method_54761(block.wrapperContained)); }
...
// public static boolean shouldCancelStripAttempt(yarnwrap.item.ItemUsageContext context, ) { return net.minecraft.item.AxeItem.shouldCancelStripAttempt(context.wrapperContained); }
