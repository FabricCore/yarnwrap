...
public class FeatureFlag { public net.minecraft.resource.featuretoggle.FeatureFlag wrapperContained; public FeatureFlag(net.minecraft.resource.featuretoggle.FeatureFlag wrapperContained) { this.wrapperContained = wrapperContained; }
