...
// public static void trigger(yarnwrap.server.network.ServerPlayerEntity player,yarnwrap.util.math.Vec3d startPosition,yarnwrap.entity.Entity cause, ) { net.minecraft.advancement.criterion.FallAfterExplosionCriterion.trigger(player.wrapperContained,startPosition.wrapperContained,cause.wrapperContained); }
...
// public static boolean method_58359(yarnwrap.server.network.ServerPlayerEntity conditions, ) { return net.minecraft.advancement.criterion.FallAfterExplosionCriterion.method_58359(conditions.wrapperContained); }
