...
// public static boolean method_23888(yarnwrap.loot.context.LootContext conditions, ) { return net.minecraft.advancement.criterion.ItemCriterion.method_23888(conditions.wrapperContained); }
...
// public static void trigger(yarnwrap.server.network.ServerPlayerEntity player,yarnwrap.util.math.BlockPos pos,yarnwrap.item.ItemStack stack, ) { net.minecraft.advancement.criterion.ItemCriterion.trigger(player.wrapperContained,pos.wrapperContained,stack.wrapperContained); }
