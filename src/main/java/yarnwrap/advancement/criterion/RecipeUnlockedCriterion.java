...
// public yarnwrap.advancement.AdvancementCriterion create() { return new yarnwrap.advancement.AdvancementCriterion(wrapperContained.create()); }
// public static yarnwrap.advancement.AdvancementCriterion create() { return new yarnwrap.advancement.AdvancementCriterion(net.minecraft.advancement.criterion.RecipeUnlockedCriterion.create()); }
