...
// public static boolean method_22455(yarnwrap.loot.context.LootContext conditions, ) { return net.minecraft.advancement.criterion.BredAnimalsCriterion.method_22455(conditions.wrapperContained); }
...
// public static void trigger(yarnwrap.server.network.ServerPlayerEntity player,yarnwrap.entity.passive.AnimalEntity parent,yarnwrap.entity.passive.AnimalEntity partner,yarnwrap.entity.passive.PassiveEntity child, ) { net.minecraft.advancement.criterion.BredAnimalsCriterion.trigger(player.wrapperContained,parent.wrapperContained,partner.wrapperContained,child.wrapperContained); }
