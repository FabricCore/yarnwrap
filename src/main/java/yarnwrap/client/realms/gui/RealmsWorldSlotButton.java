...
// public static int slotIndex() { return net.minecraft.client.realms.gui.RealmsWorldSlotButton.slotIndex; }
// public static void slotIndex(int value, ) { net.minecraft.client.realms.gui.RealmsWorldSlotButton.slotIndex = value; }

// public Object state() { return wrapperContained.state; }
// // public void state(Object value) { wrapperContained.state = value; }
// // public static Object state() { return net.minecraft.client.realms.gui.RealmsWorldSlotButton.state; }
// // public static void state(Object value, ) { net.minecraft.client.realms.gui.RealmsWorldSlotButton.state = value; }
...
// public static yarnwrap.util.Identifier SLOT_FRAME() { return new yarnwrap.util.Identifier(net.minecraft.client.realms.gui.RealmsWorldSlotButton.SLOT_FRAME); }
// public static void SLOT_FRAME(yarnwrap.util.Identifier value, ) { net.minecraft.client.realms.gui.RealmsWorldSlotButton.SLOT_FRAME = value.wrapperContained; }
...
public static yarnwrap.util.Identifier EMPTY_FRAME() { return new yarnwrap.util.Identifier(net.minecraft.client.realms.gui.RealmsWorldSlotButton.EMPTY_FRAME); }
// public static void EMPTY_FRAME(yarnwrap.util.Identifier value, ) { net.minecraft.client.realms.gui.RealmsWorldSlotButton.EMPTY_FRAME = value.wrapperContained; }
...
public static yarnwrap.util.Identifier PANORAMA_0() { return new yarnwrap.util.Identifier(net.minecraft.client.realms.gui.RealmsWorldSlotButton.PANORAMA_0); }
// public static void PANORAMA_0(yarnwrap.util.Identifier value, ) { net.minecraft.client.realms.gui.RealmsWorldSlotButton.PANORAMA_0 = value.wrapperContained; }
...
public static yarnwrap.util.Identifier PANORAMA_2() { return new yarnwrap.util.Identifier(net.minecraft.client.realms.gui.RealmsWorldSlotButton.PANORAMA_2); }
// public static void PANORAMA_2(yarnwrap.util.Identifier value, ) { net.minecraft.client.realms.gui.RealmsWorldSlotButton.PANORAMA_2 = value.wrapperContained; }
...
// public static void MINIGAME_TOOLTIP(yarnwrap.text.Text value, ) { net.minecraft.client.realms.gui.RealmsWorldSlotButton.MINIGAME_TOOLTIP = value.wrapperContained; }
