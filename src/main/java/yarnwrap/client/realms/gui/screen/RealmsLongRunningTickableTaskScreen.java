...
// public static yarnwrap.client.realms.task.LongRunningTask tickableTask() { return new yarnwrap.client.realms.task.LongRunningTask(net.minecraft.client.realms.gui.screen.RealmsLongRunningTickableTaskScreen.tickableTask); }
// public static void tickableTask(yarnwrap.client.realms.task.LongRunningTask value, ) { net.minecraft.client.realms.gui.screen.RealmsLongRunningTickableTaskScreen.tickableTask = value.wrapperContained; }
