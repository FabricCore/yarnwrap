...
// public static java.util.List lineBreak(java.lang.String text, ) { return net.minecraft.client.realms.util.TextRenderingUtils.lineBreak(text); }
...
// public static java.util.List split(java.lang.String line,java.lang.String delimiter, ) { return net.minecraft.client.realms.util.TextRenderingUtils.split(line,delimiter); }
// public java.util.List decompose(java.lang.String text,java.util.List links) { return wrapperContained.decompose(text,links); }
// public static java.util.List decompose(java.lang.String text,java.util.List links, ) { return net.minecraft.client.realms.util.TextRenderingUtils.decompose(text,links); }
// public java.util.List decompose(java.lang.String text,Object[] links) { return wrapperContained.decompose(text,links); }
// public static java.util.List decompose(java.lang.String text,Object[] links, ) { return net.minecraft.client.realms.util.TextRenderingUtils.decompose(text,links); }
...
// public static java.util.List insertLinks(java.util.List lines,java.util.List links, ) { return net.minecraft.client.realms.util.TextRenderingUtils.insertLinks(lines,links); }
