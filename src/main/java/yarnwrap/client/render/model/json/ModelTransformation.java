...
// public static yarnwrap.client.render.model.json.Transformation gui() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.gui); }
// public static void gui(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.gui = value.wrapperContained; }
...
public static yarnwrap.client.render.model.json.ModelTransformation NONE() { return new yarnwrap.client.render.model.json.ModelTransformation(net.minecraft.client.render.model.json.ModelTransformation.NONE); }
// public static void NONE(yarnwrap.client.render.model.json.ModelTransformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.NONE = value.wrapperContained; }
...
// public static yarnwrap.client.render.model.json.Transformation firstPersonLeftHand() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.firstPersonLeftHand); }
// public static void firstPersonLeftHand(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.firstPersonLeftHand = value.wrapperContained; }
...
// public static yarnwrap.client.render.model.json.Transformation ground() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.ground); }
// public static void ground(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.ground = value.wrapperContained; }
...
// public static yarnwrap.client.render.model.json.Transformation firstPersonRightHand() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.firstPersonRightHand); }
// public static void firstPersonRightHand(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.firstPersonRightHand = value.wrapperContained; }
...
// public static yarnwrap.client.render.model.json.Transformation thirdPersonLeftHand() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.thirdPersonLeftHand); }
// public static void thirdPersonLeftHand(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.thirdPersonLeftHand = value.wrapperContained; }
...
// public static yarnwrap.client.render.model.json.Transformation fixed() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.fixed); }
// public static void fixed(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.fixed = value.wrapperContained; }
...
// public static yarnwrap.client.render.model.json.Transformation thirdPersonRightHand() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.thirdPersonRightHand); }
// public static void thirdPersonRightHand(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.thirdPersonRightHand = value.wrapperContained; }
...
// public static yarnwrap.client.render.model.json.Transformation head() { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.head); }
// public static void head(yarnwrap.client.render.model.json.Transformation value, ) { net.minecraft.client.render.model.json.ModelTransformation.head = value.wrapperContained; }
...
// public static boolean isTransformationDefined(yarnwrap.client.render.model.json.ModelTransformationMode renderMode, ) { return net.minecraft.client.render.model.json.ModelTransformation.isTransformationDefined(renderMode.wrapperContained); }
...
// public static yarnwrap.client.render.model.json.Transformation getTransformation(yarnwrap.client.render.model.json.ModelTransformationMode renderMode, ) { return new yarnwrap.client.render.model.json.Transformation(net.minecraft.client.render.model.json.ModelTransformation.getTransformation(renderMode.wrapperContained)); }
