...
// public SkullBlockEntityRenderer(Object ctx) { this.wrapperContained = new net.minecraft.client.render.block.entity.SkullBlockEntityRenderer(ctx); }
...
// public void method_3580(java.util.HashMap map) { wrapperContained.method_3580(map); }
