...
// public static java.lang.String NECK() { return net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.NECK; }
// public static void NECK(java.lang.String value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.NECK = value; }
...
// public static java.lang.String FRONT() { return net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.FRONT; }
// public static void FRONT(java.lang.String value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.FRONT = value; }
...
// public static java.lang.String BACK() { return net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.BACK; }
// public static void BACK(java.lang.String value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.BACK = value; }
...
// public static java.lang.String LEFT() { return net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.LEFT; }
// public static void LEFT(java.lang.String value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.LEFT = value; }
...
// public static java.lang.String RIGHT() { return net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.RIGHT; }
// public static void RIGHT(java.lang.String value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.RIGHT = value; }

// public java.lang.String TOP() { return wrapperContained.TOP; }
// public void TOP(java.lang.String value) { wrapperContained.TOP = value; }
// public static java.lang.String TOP() { return net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.TOP; }
// public static void TOP(java.lang.String value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.TOP = value; }
...
// public static java.lang.String BOTTOM() { return net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.BOTTOM; }
// public static void BOTTOM(java.lang.String value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.BOTTOM = value; }
...
// public static yarnwrap.client.model.ModelPart neck() { return new yarnwrap.client.model.ModelPart(net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.neck); }
// public static void neck(yarnwrap.client.model.ModelPart value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.neck = value.wrapperContained; }
...
// public static yarnwrap.client.model.ModelPart front() { return new yarnwrap.client.model.ModelPart(net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.front); }
// public static void front(yarnwrap.client.model.ModelPart value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.front = value.wrapperContained; }
...
// public static yarnwrap.client.model.ModelPart back() { return new yarnwrap.client.model.ModelPart(net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.back); }
// public static void back(yarnwrap.client.model.ModelPart value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.back = value.wrapperContained; }
...
// public static yarnwrap.client.model.ModelPart left() { return new yarnwrap.client.model.ModelPart(net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.left); }
// public static void left(yarnwrap.client.model.ModelPart value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.left = value.wrapperContained; }
...
// public static yarnwrap.client.model.ModelPart right() { return new yarnwrap.client.model.ModelPart(net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.right); }
// public static void right(yarnwrap.client.model.ModelPart value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.right = value.wrapperContained; }
...
// public static yarnwrap.client.model.ModelPart top() { return new yarnwrap.client.model.ModelPart(net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.top); }
// public static void top(yarnwrap.client.model.ModelPart value, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.top = value.wrapperContained; }
...
// public static void renderDecoratedSide(yarnwrap.client.model.ModelPart part,yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,int light,int overlay,yarnwrap.client.util.SpriteIdentifier textureId, ) { net.minecraft.client.render.block.entity.DecoratedPotBlockEntityRenderer.renderDecoratedSide(part.wrapperContained,matrices.wrapperContained,vertexConsumers.wrapperContained,light,overlay,textureId.wrapperContained); }
