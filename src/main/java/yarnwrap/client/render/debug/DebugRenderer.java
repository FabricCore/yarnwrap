...
// // public static Object neighborUpdateDebugRenderer() { return net.minecraft.client.render.debug.DebugRenderer.neighborUpdateDebugRenderer; }
// // public static void neighborUpdateDebugRenderer(Object value, ) { net.minecraft.client.render.debug.DebugRenderer.neighborUpdateDebugRenderer = value; }
...
// public static void render(yarnwrap.client.util.math.MatrixStack matrices,Object vertexConsumers,double cameraX,double cameraY,double cameraZ, ) { net.minecraft.client.render.debug.DebugRenderer.render(matrices.wrapperContained,vertexConsumers,cameraX,cameraY,cameraZ); }
// public boolean method_23100(yarnwrap.entity.Entity entityx) { return wrapperContained.method_23100(entityx.wrapperContained); }
// public static boolean method_23100(yarnwrap.entity.Entity entityx, ) { return net.minecraft.client.render.debug.DebugRenderer.method_23100(entityx.wrapperContained); }
