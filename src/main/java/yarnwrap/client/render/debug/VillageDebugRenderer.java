...
// public static yarnwrap.client.MinecraftClient client() { return new yarnwrap.client.MinecraftClient(net.minecraft.client.render.debug.VillageDebugRenderer.client); }
// public static void client(yarnwrap.client.MinecraftClient value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.client = value.wrapperContained; }
...
// public static java.util.Map pointsOfInterest() { return net.minecraft.client.render.debug.VillageDebugRenderer.pointsOfInterest; }
// public static void pointsOfInterest(java.util.Map value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.pointsOfInterest = value; }

// public org.slf4j.Logger LOGGER() { return wrapperContained.LOGGER; }
// public void LOGGER(org.slf4j.Logger value) { wrapperContained.LOGGER = value; }
// public static org.slf4j.Logger LOGGER() { return net.minecraft.client.render.debug.VillageDebugRenderer.LOGGER; }
// public static void LOGGER(org.slf4j.Logger value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.LOGGER = value; }
...
// public static java.util.Map brains() { return net.minecraft.client.render.debug.VillageDebugRenderer.brains; }
// public static void brains(java.util.Map value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.brains = value; }
...
// public static int GRAY() { return net.minecraft.client.render.debug.VillageDebugRenderer.GRAY; }
// public static void GRAY(int value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.GRAY = value; }
...
// public static int ORANGE() { return net.minecraft.client.render.debug.VillageDebugRenderer.ORANGE; }
// public static void ORANGE(int value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.ORANGE = value; }

// public int POI_RANGE() { return wrapperContained.POI_RANGE; }
// public void POI_RANGE(int value) { wrapperContained.POI_RANGE = value; }
// public static int POI_RANGE() { return net.minecraft.client.render.debug.VillageDebugRenderer.POI_RANGE; }
// public static void POI_RANGE(int value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.POI_RANGE = value; }
...
// public static int BRAIN_RANGE() { return net.minecraft.client.render.debug.VillageDebugRenderer.BRAIN_RANGE; }
// public static void BRAIN_RANGE(int value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.BRAIN_RANGE = value; }
...
// public static int TARGET_ENTITY_RANGE() { return net.minecraft.client.render.debug.VillageDebugRenderer.TARGET_ENTITY_RANGE; }
// public static void TARGET_ENTITY_RANGE(int value, ) { net.minecraft.client.render.debug.VillageDebugRenderer.TARGET_ENTITY_RANGE = value; }
...
// public static void addBrain(Object brain, ) { net.minecraft.client.render.debug.VillageDebugRenderer.addBrain(brain); }
...
// public static void removePointOfInterest(yarnwrap.util.math.BlockPos pos, ) { net.minecraft.client.render.debug.VillageDebugRenderer.removePointOfInterest(pos.wrapperContained); }
// public void addPointOfInterest(Object poi) { wrapperContained.addPointOfInterest(poi); }
// public static void addPointOfInterest(Object poi, ) { net.minecraft.client.render.debug.VillageDebugRenderer.addPointOfInterest(poi); }
...
// public static void setFreeTicketCount(yarnwrap.util.math.BlockPos pos,int freeTicketCount, ) { net.minecraft.client.render.debug.VillageDebugRenderer.setFreeTicketCount(pos.wrapperContained,freeTicketCount); }
// public void method_23126(yarnwrap.entity.Entity entity) { wrapperContained.method_23126(entity.wrapperContained); }
// public static void method_23126(yarnwrap.entity.Entity entity, ) { net.minecraft.client.render.debug.VillageDebugRenderer.method_23126(entity.wrapperContained); }
...
// public static boolean method_23127(yarnwrap.util.math.BlockPos brain, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.method_23127(brain.wrapperContained); }
// public void method_23128(yarnwrap.util.math.BlockPos poi) { wrapperContained.method_23128(poi.wrapperContained); }
// public static void method_23128(yarnwrap.util.math.BlockPos poi, ) { net.minecraft.client.render.debug.VillageDebugRenderer.method_23128(poi.wrapperContained); }
...
// public static void method_23129(yarnwrap.util.math.BlockPos pos,yarnwrap.client.util.math.MatrixStack brains, ) { net.minecraft.client.render.debug.VillageDebugRenderer.method_23129(pos.wrapperContained,brains.wrapperContained); }
...
// public static void drawGhostPointOfInterest(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,yarnwrap.util.math.BlockPos pos,java.util.List brains, ) { net.minecraft.client.render.debug.VillageDebugRenderer.drawGhostPointOfInterest(matrices.wrapperContained,vertexConsumers.wrapperContained,pos.wrapperContained,brains); }
...
// public static void drawString(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,yarnwrap.util.math.Position pos,int offsetY,java.lang.String string,int color,float size, ) { net.minecraft.client.render.debug.VillageDebugRenderer.drawString(matrices.wrapperContained,vertexConsumers.wrapperContained,pos.wrapperContained,offsetY,string,color,size); }
...
// public static void drawString(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,java.lang.String string,Object pointOfInterest,int offsetY,int color, ) { net.minecraft.client.render.debug.VillageDebugRenderer.drawString(matrices.wrapperContained,vertexConsumers.wrapperContained,string,pointOfInterest,offsetY,color); }
...
// public static void draw(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,double x,double y,double z, ) { net.minecraft.client.render.debug.VillageDebugRenderer.draw(matrices.wrapperContained,vertexConsumers.wrapperContained,x,y,z); }
...
// public static void drawPath(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,Object brain,double cameraX,double cameraY,double cameraZ, ) { net.minecraft.client.render.debug.VillageDebugRenderer.drawPath(matrices.wrapperContained,vertexConsumers.wrapperContained,brain,cameraX,cameraY,cameraZ); }
...
// public static void drawPointOfInterestInfo(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,Object pointOfInterest, ) { net.minecraft.client.render.debug.VillageDebugRenderer.drawPointOfInterestInfo(matrices.wrapperContained,vertexConsumers.wrapperContained,pointOfInterest); }
...
// public static void drawPointOfInterest(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,yarnwrap.util.math.BlockPos pos, ) { net.minecraft.client.render.debug.VillageDebugRenderer.drawPointOfInterest(matrices.wrapperContained,vertexConsumers.wrapperContained,pos.wrapperContained); }
...
// public static void drawBrain(yarnwrap.client.util.math.MatrixStack matrices,yarnwrap.client.render.VertexConsumerProvider vertexConsumers,Object brain,double cameraX,double cameraY,double cameraZ, ) { net.minecraft.client.render.debug.VillageDebugRenderer.drawBrain(matrices.wrapperContained,vertexConsumers.wrapperContained,brain,cameraX,cameraY,cameraZ); }
...
// public static java.util.Set getNamesOfPointOfInterestTicketHolders(Object pointOfInterest, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.getNamesOfPointOfInterestTicketHolders(pointOfInterest); }
...
// public static java.util.Collection getBrainsContainingPointOfInterest(yarnwrap.util.math.BlockPos pointOfInterest, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.getBrainsContainingPointOfInterest(pointOfInterest.wrapperContained); }
// public java.util.Map getGhostPointsOfInterest() { return wrapperContained.getGhostPointsOfInterest(); }
// public static java.util.Map getGhostPointsOfInterest() { return net.minecraft.client.render.debug.VillageDebugRenderer.getGhostPointsOfInterest(); }
// public boolean isTargeted(Object brain) { return wrapperContained.isTargeted(brain); }
// public static boolean isTargeted(Object brain, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.isTargeted(brain); }
// public void updateTargetedEntity() { wrapperContained.updateTargetedEntity(); }
// public static void updateTargetedEntity() { net.minecraft.client.render.debug.VillageDebugRenderer.updateTargetedEntity(); }
// public boolean isClose(Object brain) { return wrapperContained.isClose(brain); }
// public static boolean isClose(Object brain, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.isClose(brain); }
...
// public static void method_23148(yarnwrap.client.util.math.MatrixStack brain, ) { net.minecraft.client.render.debug.VillageDebugRenderer.method_23148(brain.wrapperContained); }
// public boolean method_24804(Object entry) { return wrapperContained.method_24804(entry); }
// public static boolean method_24804(Object entry, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.method_24804(entry); }
// public void removeRemovedBrains() { wrapperContained.removeRemovedBrains(); }
// public static void removeRemovedBrains() { net.minecraft.client.render.debug.VillageDebugRenderer.removeRemovedBrains(); }
...
// public static boolean method_29384(yarnwrap.util.math.BlockPos brain, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.method_29384(brain.wrapperContained); }
...
// public static java.util.Set getNamesOfJobSitePotentialOwners(Object potentialJobSite, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.getNamesOfJobSitePotentialOwners(potentialJobSite); }
...
// public static java.util.Collection getBrainsContainingPotentialJobSite(yarnwrap.util.math.BlockPos potentialJobSite, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.getBrainsContainingPotentialJobSite(potentialJobSite.wrapperContained); }
...
// public static java.util.List method_30112(yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.method_30112(pos.wrapperContained); }
public void removeBrain(int entityId) { wrapperContained.removeBrain(entityId); }
// public static void removeBrain(int entityId, ) { net.minecraft.client.render.debug.VillageDebugRenderer.removeBrain(entityId); }
// public boolean method_35798(int brain) { return wrapperContained.method_35798(brain); }
// public static boolean method_35798(int brain, ) { return net.minecraft.client.render.debug.VillageDebugRenderer.method_35798(brain); }
