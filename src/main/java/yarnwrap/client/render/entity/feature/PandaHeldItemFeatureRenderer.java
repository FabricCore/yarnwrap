...
// public static yarnwrap.client.render.item.HeldItemRenderer heldItemRenderer() { return new yarnwrap.client.render.item.HeldItemRenderer(net.minecraft.client.render.entity.feature.PandaHeldItemFeatureRenderer.heldItemRenderer); }
// public static void heldItemRenderer(yarnwrap.client.render.item.HeldItemRenderer value, ) { net.minecraft.client.render.entity.feature.PandaHeldItemFeatureRenderer.heldItemRenderer = value.wrapperContained; }
