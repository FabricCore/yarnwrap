...
public SkeletonOverlayFeatureRenderer(yarnwrap.client.render.entity.feature.FeatureRendererContext context,yarnwrap.client.render.entity.model.EntityModelLoader loader,yarnwrap.client.render.entity.model.EntityModelLayer layer,yarnwrap.util.Identifier texture) { this.wrapperContained = new net.minecraft.client.render.entity.feature.SkeletonOverlayFeatureRenderer(context.wrapperContained,loader.wrapperContained,layer.wrapperContained,texture.wrapperContained); }
