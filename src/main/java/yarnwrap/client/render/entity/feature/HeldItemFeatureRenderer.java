...
public HeldItemFeatureRenderer(yarnwrap.client.render.entity.feature.FeatureRendererContext context,yarnwrap.client.render.item.HeldItemRenderer heldItemRenderer) { this.wrapperContained = new net.minecraft.client.render.entity.feature.HeldItemFeatureRenderer(context.wrapperContained,heldItemRenderer.wrapperContained); }
