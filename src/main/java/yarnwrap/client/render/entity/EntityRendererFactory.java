...
// public static yarnwrap.client.render.entity.EntityRenderer create(Object ctx, ) { return new yarnwrap.client.render.entity.EntityRenderer(net.minecraft.client.render.entity.EntityRendererFactory.create(ctx)); }
