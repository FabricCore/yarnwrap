...
// public static void setArmAngle(yarnwrap.util.Arm arm,yarnwrap.client.util.math.MatrixStack matrices, ) { net.minecraft.client.render.entity.model.ModelWithArms.setArmAngle(arm.wrapperContained,matrices.wrapperContained); }
