...
// public static yarnwrap.network.packet.Packet predict(int sequence, ) { return new yarnwrap.network.packet.Packet(net.minecraft.client.network.SequencedPacketCreator.predict(sequence)); }
