...
// public static float interpolateAngle(float angle1,float angle2,float progress, ) { return net.minecraft.client.model.ModelUtil.interpolateAngle(angle1,angle2,progress); }
