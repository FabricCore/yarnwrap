...
// public static yarnwrap.client.util.Monitor createMonitor(long pointer, ) { return new yarnwrap.client.util.Monitor(net.minecraft.client.util.MonitorFactory.createMonitor(pointer)); }
