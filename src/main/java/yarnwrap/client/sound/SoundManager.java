...
// public static void sounds(java.util.Map value, ) { net.minecraft.client.sound.SoundManager.sounds = value; }
...
// public static yarnwrap.client.sound.SoundSystem soundSystem() { return new yarnwrap.client.sound.SoundSystem(net.minecraft.client.sound.SoundManager.soundSystem); }
// public static void soundSystem(yarnwrap.client.sound.SoundSystem value, ) { net.minecraft.client.sound.SoundManager.soundSystem = value.wrapperContained; }
...
// public static com.google.gson.reflect.TypeToken TYPE() { return net.minecraft.client.sound.SoundManager.TYPE; }
// public static void TYPE(com.google.gson.reflect.TypeToken value, ) { net.minecraft.client.sound.SoundManager.TYPE = value; }
...
public static yarnwrap.client.sound.Sound MISSING_SOUND() { return new yarnwrap.client.sound.Sound(net.minecraft.client.sound.SoundManager.MISSING_SOUND); }
// public static void MISSING_SOUND(yarnwrap.client.sound.Sound value, ) { net.minecraft.client.sound.SoundManager.MISSING_SOUND = value.wrapperContained; }

// public org.slf4j.Logger LOGGER() { return wrapperContained.LOGGER; }
// public void LOGGER(org.slf4j.Logger value) { wrapperContained.LOGGER = value; }
// public static org.slf4j.Logger LOGGER() { return net.minecraft.client.sound.SoundManager.LOGGER; }
// public static void LOGGER(org.slf4j.Logger value, ) { net.minecraft.client.sound.SoundManager.LOGGER = value; }
...
// public static boolean isSoundResourcePresent(yarnwrap.client.sound.Sound sound,yarnwrap.util.Identifier id,yarnwrap.resource.ResourceFactory resourceFactory, ) { return net.minecraft.client.sound.SoundManager.isSoundResourcePresent(sound.wrapperContained,id.wrapperContained,resourceFactory.wrapperContained); }
...
// public static yarnwrap.client.sound.WeightedSoundSet get(yarnwrap.util.Identifier id, ) { return new yarnwrap.client.sound.WeightedSoundSet(net.minecraft.client.sound.SoundManager.get(id.wrapperContained)); }
...
// public static void updateListenerPosition(yarnwrap.client.render.Camera camera, ) { net.minecraft.client.sound.SoundManager.updateListenerPosition(camera.wrapperContained); }
