...
// public static int SPACING() { return net.minecraft.client.gui.widget.LayoutWidgets.SPACING; }
// public static void SPACING(int value, ) { net.minecraft.client.gui.widget.LayoutWidgets.SPACING = value; }
...
// public static yarnwrap.client.gui.widget.LayoutWidget createLabeledWidget(yarnwrap.client.font.TextRenderer textRenderer,yarnwrap.client.gui.widget.Widget widget,yarnwrap.text.Text label, ) { return new yarnwrap.client.gui.widget.LayoutWidget(net.minecraft.client.gui.widget.LayoutWidgets.createLabeledWidget(textRenderer.wrapperContained,widget.wrapperContained,label.wrapperContained)); }
...
// public static yarnwrap.client.gui.widget.LayoutWidget createLabeledWidget(yarnwrap.client.font.TextRenderer textRenderer,yarnwrap.client.gui.widget.Widget widget,yarnwrap.text.Text label,java.util.function.Consumer callback, ) { return new yarnwrap.client.gui.widget.LayoutWidget(net.minecraft.client.gui.widget.LayoutWidgets.createLabeledWidget(textRenderer.wrapperContained,widget.wrapperContained,label.wrapperContained,callback)); }
...
// public static void method_53551(yarnwrap.client.gui.widget.Positioner positioner, ) { net.minecraft.client.gui.widget.LayoutWidgets.method_53551(positioner.wrapperContained); }
