...
// public static void parent(yarnwrap.client.gui.screen.world.CustomizeFlatLevelScreen value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.parent = value.wrapperContained; }
...
// public static yarnwrap.text.Text shareText() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.PresetsScreen.shareText); }
// public static void shareText(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.shareText = value.wrapperContained; }
...
// // public static Object listWidget() { return net.minecraft.client.gui.screen.world.PresetsScreen.listWidget; }
// // public static void listWidget(Object value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.listWidget = value; }
...
// public static yarnwrap.client.gui.widget.TextFieldWidget customPresetField() { return new yarnwrap.client.gui.widget.TextFieldWidget(net.minecraft.client.gui.screen.world.PresetsScreen.customPresetField); }
// public static void customPresetField(yarnwrap.client.gui.widget.TextFieldWidget value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.customPresetField = value.wrapperContained; }
...
// public static yarnwrap.text.Text listText() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.PresetsScreen.listText); }
// public static void listText(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.listText = value.wrapperContained; }
...
// public static yarnwrap.registry.RegistryKey BIOME_KEY() { return new yarnwrap.registry.RegistryKey(net.minecraft.client.gui.screen.world.PresetsScreen.BIOME_KEY); }
// public static void BIOME_KEY(yarnwrap.registry.RegistryKey value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.BIOME_KEY = value.wrapperContained; }

// public int ICON_SIZE() { return wrapperContained.ICON_SIZE; }
// public void ICON_SIZE(int value) { wrapperContained.ICON_SIZE = value; }
// public static int ICON_SIZE() { return net.minecraft.client.gui.screen.world.PresetsScreen.ICON_SIZE; }
// public static void ICON_SIZE(int value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.ICON_SIZE = value; }
...
// public static int BUTTON_HEIGHT() { return net.minecraft.client.gui.screen.world.PresetsScreen.BUTTON_HEIGHT; }
// public static void BUTTON_HEIGHT(int value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.BUTTON_HEIGHT = value; }
...
// public static int ICON_BACKGROUND_OFFSET_X() { return net.minecraft.client.gui.screen.world.PresetsScreen.ICON_BACKGROUND_OFFSET_X; }
// public static void ICON_BACKGROUND_OFFSET_X(int value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.ICON_BACKGROUND_OFFSET_X = value; }
...
// public static int ICON_BACKGROUND_OFFSET_Y() { return net.minecraft.client.gui.screen.world.PresetsScreen.ICON_BACKGROUND_OFFSET_Y; }
// public static void ICON_BACKGROUND_OFFSET_Y(int value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.ICON_BACKGROUND_OFFSET_Y = value; }
...
// public static int ICON_OFFSET_X() { return net.minecraft.client.gui.screen.world.PresetsScreen.ICON_OFFSET_X; }
// public static void ICON_OFFSET_X(int value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.ICON_OFFSET_X = value; }
...
// public static int ICON_OFFSET_Y() { return net.minecraft.client.gui.screen.world.PresetsScreen.ICON_OFFSET_Y; }
// public static void ICON_OFFSET_Y(int value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.ICON_OFFSET_Y = value; }
...
public static yarnwrap.text.Text UNKNOWN_PRESET_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.PresetsScreen.UNKNOWN_PRESET_TEXT); }
// public static void UNKNOWN_PRESET_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.UNKNOWN_PRESET_TEXT = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier SLOT_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.PresetsScreen.SLOT_TEXTURE); }
// public static void SLOT_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.PresetsScreen.SLOT_TEXTURE = value.wrapperContained; }
...
// public static void method_19846(yarnwrap.client.gui.widget.ButtonWidget button, ) { net.minecraft.client.gui.screen.world.PresetsScreen.method_19846(button.wrapperContained); }
public void updateSelectButton(boolean hasSelected) { wrapperContained.updateSelectButton(hasSelected); }
// public static void updateSelectButton(boolean hasSelected, ) { net.minecraft.client.gui.screen.world.PresetsScreen.updateSelectButton(hasSelected); }
...
// public static java.util.List parsePresetLayersString(yarnwrap.registry.RegistryEntryLookup blockLookup,java.lang.String layers, ) { return net.minecraft.client.gui.screen.world.PresetsScreen.parsePresetLayersString(blockLookup.wrapperContained,layers); }
...
// public static yarnwrap.world.gen.chunk.FlatChunkGeneratorLayer parseLayerString(yarnwrap.registry.RegistryEntryLookup blockLookup,java.lang.String layer,int layerStartHeight, ) { return new yarnwrap.world.gen.chunk.FlatChunkGeneratorLayer(net.minecraft.client.gui.screen.world.PresetsScreen.parseLayerString(blockLookup.wrapperContained,layer,layerStartHeight)); }
...
// public static yarnwrap.world.gen.chunk.FlatChunkGeneratorConfig parsePresetString(yarnwrap.registry.RegistryEntryLookup blockLookup,yarnwrap.registry.RegistryEntryLookup biomeLookup,yarnwrap.registry.RegistryEntryLookup structureSetLookup,yarnwrap.registry.RegistryEntryLookup placedFeatureLookup,java.lang.String preset,yarnwrap.world.gen.chunk.FlatChunkGeneratorConfig config, ) { return new yarnwrap.world.gen.chunk.FlatChunkGeneratorConfig(net.minecraft.client.gui.screen.world.PresetsScreen.parsePresetString(blockLookup.wrapperContained,biomeLookup.wrapperContained,structureSetLookup.wrapperContained,placedFeatureLookup.wrapperContained,preset,config.wrapperContained)); }
...
// public static yarnwrap.registry.RegistryKey method_29061(yarnwrap.util.Identifier biomeId, ) { return new yarnwrap.registry.RegistryKey(net.minecraft.client.gui.screen.world.PresetsScreen.method_29061(biomeId.wrapperContained)); }
...
// public static java.lang.String getGeneratorConfigString(yarnwrap.world.gen.chunk.FlatChunkGeneratorConfig config, ) { return net.minecraft.client.gui.screen.world.PresetsScreen.getGeneratorConfigString(config.wrapperContained); }
