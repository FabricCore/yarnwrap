...
// public static void DATE_FORMAT(java.time.format.DateTimeFormatter value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.DATE_FORMAT = value; }
...
// public static yarnwrap.text.Text FROM_NEWER_VERSION_FIRST_LINE() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.WorldListWidget.FROM_NEWER_VERSION_FIRST_LINE); }
// public static void FROM_NEWER_VERSION_FIRST_LINE(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.FROM_NEWER_VERSION_FIRST_LINE = value.wrapperContained; }
...
// public static yarnwrap.text.Text FROM_NEWER_VERSION_SECOND_LINE() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.WorldListWidget.FROM_NEWER_VERSION_SECOND_LINE); }
// public static void FROM_NEWER_VERSION_SECOND_LINE(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.FROM_NEWER_VERSION_SECOND_LINE = value.wrapperContained; }
...
// public static yarnwrap.text.Text SNAPSHOT_FIRST_LINE() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.WorldListWidget.SNAPSHOT_FIRST_LINE); }
// public static void SNAPSHOT_FIRST_LINE(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.SNAPSHOT_FIRST_LINE = value.wrapperContained; }
...
// public static yarnwrap.text.Text SNAPSHOT_SECOND_LINE() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.WorldListWidget.SNAPSHOT_SECOND_LINE); }
// public static void SNAPSHOT_SECOND_LINE(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.SNAPSHOT_SECOND_LINE = value.wrapperContained; }
...
// public static yarnwrap.text.Text CONVERSION_TOOLTIP() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.WorldListWidget.CONVERSION_TOOLTIP); }
// public static void CONVERSION_TOOLTIP(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.CONVERSION_TOOLTIP = value.wrapperContained; }
...
// // public static Object loadingEntry() { return net.minecraft.client.gui.screen.world.WorldListWidget.loadingEntry; }
// // public static void loadingEntry(Object value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.loadingEntry = value; }
...
// public static java.lang.String search() { return net.minecraft.client.gui.screen.world.WorldListWidget.search; }
// public static void search(java.lang.String value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.search = value; }
...
// public static java.util.concurrent.CompletableFuture levelsFuture() { return net.minecraft.client.gui.screen.world.WorldListWidget.levelsFuture; }
// public static void levelsFuture(java.util.concurrent.CompletableFuture value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.levelsFuture = value; }
...
// public static java.util.List levels() { return net.minecraft.client.gui.screen.world.WorldListWidget.levels; }
// public static void levels(java.util.List value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.levels = value; }
...
// public static yarnwrap.text.Text EXPERIMENTAL_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.WorldListWidget.EXPERIMENTAL_TEXT); }
// public static void EXPERIMENTAL_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.EXPERIMENTAL_TEXT = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier ERROR_HIGHLIGHTED_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.ERROR_HIGHLIGHTED_TEXTURE); }
// public static void ERROR_HIGHLIGHTED_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.ERROR_HIGHLIGHTED_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier ERROR_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.ERROR_TEXTURE); }
// public static void ERROR_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.ERROR_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier MARKED_JOIN_HIGHLIGHTED_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.MARKED_JOIN_HIGHLIGHTED_TEXTURE); }
// public static void MARKED_JOIN_HIGHLIGHTED_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.MARKED_JOIN_HIGHLIGHTED_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier MARKED_JOIN_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.MARKED_JOIN_TEXTURE); }
// public static void MARKED_JOIN_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.MARKED_JOIN_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier WARNING_HIGHLIGHTED_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.WARNING_HIGHLIGHTED_TEXTURE); }
// public static void WARNING_HIGHLIGHTED_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.WARNING_HIGHLIGHTED_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier WARNING_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.WARNING_TEXTURE); }
// public static void WARNING_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.WARNING_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier JOIN_HIGHLIGHTED_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.JOIN_HIGHLIGHTED_TEXTURE); }
// public static void JOIN_HIGHLIGHTED_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.JOIN_HIGHLIGHTED_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier JOIN_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.world.WorldListWidget.JOIN_TEXTURE); }
// public static void JOIN_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.world.WorldListWidget.JOIN_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.text.Text INCOMPATIBLE_TOOLTIP() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.world.WorldListWidget.INCOMPATIBLE_TOOLTIP); }
...
// public static void showSummaries(java.lang.String search,java.util.List summaries, ) { net.minecraft.client.gui.screen.world.WorldListWidget.showSummaries(search,summaries); }
// public java.util.List method_43455(java.lang.Throwable throwable) { return wrapperContained.method_43455(throwable); }
// public static java.util.List method_43455(java.lang.Throwable throwable, ) { return net.minecraft.client.gui.screen.world.WorldListWidget.method_43455(throwable); }
...
// public static void showUnableToLoadScreen(yarnwrap.text.Text message, ) { net.minecraft.client.gui.screen.world.WorldListWidget.showUnableToLoadScreen(message.wrapperContained); }
// public java.util.concurrent.CompletableFuture loadLevels() { return wrapperContained.loadLevels(); }
// public static java.util.concurrent.CompletableFuture loadLevels() { return net.minecraft.client.gui.screen.world.WorldListWidget.loadLevels(); }
// public void showLoadingScreen() { wrapperContained.showLoadingScreen(); }
// public static void showLoadingScreen() { net.minecraft.client.gui.screen.world.WorldListWidget.showLoadingScreen(); }
// public void narrateScreenIfNarrationEnabled() { wrapperContained.narrateScreenIfNarrationEnabled(); }
// public static void narrateScreenIfNarrationEnabled() { net.minecraft.client.gui.screen.world.WorldListWidget.narrateScreenIfNarrationEnabled(); }
public void setSearch(java.lang.String search) { wrapperContained.setSearch(search); }
// public static void setSearch(java.lang.String search, ) { net.minecraft.client.gui.screen.world.WorldListWidget.setSearch(search); }
// public void show(java.util.List levels) { wrapperContained.show(levels); }
// public static void show(java.util.List levels, ) { net.minecraft.client.gui.screen.world.WorldListWidget.show(levels); }
// public java.util.List tryGet() { return wrapperContained.tryGet(); }
// public static java.util.List tryGet() { return net.minecraft.client.gui.screen.world.WorldListWidget.tryGet(); }
// public void load() { wrapperContained.load(); }
// public static void load() { net.minecraft.client.gui.screen.world.WorldListWidget.load(); }
