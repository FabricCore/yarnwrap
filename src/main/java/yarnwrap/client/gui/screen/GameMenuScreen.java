...
// public static boolean showMenu() { return net.minecraft.client.gui.screen.GameMenuScreen.showMenu; }
// public static void showMenu(boolean value, ) { net.minecraft.client.gui.screen.GameMenuScreen.showMenu = value; }
...
// public static void SAVING_LEVEL_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.SAVING_LEVEL_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text GAME_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.GAME_TEXT); }
// public static void GAME_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.GAME_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text PAUSED_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.PAUSED_TEXT); }
// public static void PAUSED_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.PAUSED_TEXT = value.wrapperContained; }
...
// public static int GRID_COLUMNS() { return net.minecraft.client.gui.screen.GameMenuScreen.GRID_COLUMNS; }
// public static void GRID_COLUMNS(int value, ) { net.minecraft.client.gui.screen.GameMenuScreen.GRID_COLUMNS = value; }
...
// public static int BUTTONS_TOP_MARGIN() { return net.minecraft.client.gui.screen.GameMenuScreen.BUTTONS_TOP_MARGIN; }
// public static void BUTTONS_TOP_MARGIN(int value, ) { net.minecraft.client.gui.screen.GameMenuScreen.BUTTONS_TOP_MARGIN = value; }
...
// public static int GRID_MARGIN() { return net.minecraft.client.gui.screen.GameMenuScreen.GRID_MARGIN; }
// public static void GRID_MARGIN(int value, ) { net.minecraft.client.gui.screen.GameMenuScreen.GRID_MARGIN = value; }
...
// public static int WIDE_BUTTON_WIDTH() { return net.minecraft.client.gui.screen.GameMenuScreen.WIDE_BUTTON_WIDTH; }
// public static void WIDE_BUTTON_WIDTH(int value, ) { net.minecraft.client.gui.screen.GameMenuScreen.WIDE_BUTTON_WIDTH = value; }
...
// public static int NORMAL_BUTTON_WIDTH() { return net.minecraft.client.gui.screen.GameMenuScreen.NORMAL_BUTTON_WIDTH; }
// public static void NORMAL_BUTTON_WIDTH(int value, ) { net.minecraft.client.gui.screen.GameMenuScreen.NORMAL_BUTTON_WIDTH = value; }
...
// public static yarnwrap.text.Text RETURN_TO_GAME_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.RETURN_TO_GAME_TEXT); }
// public static void RETURN_TO_GAME_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.RETURN_TO_GAME_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text ADVANCEMENTS_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.ADVANCEMENTS_TEXT); }
// public static void ADVANCEMENTS_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.ADVANCEMENTS_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text STATS_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.STATS_TEXT); }
// public static void STATS_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.STATS_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text SEND_FEEDBACK_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.SEND_FEEDBACK_TEXT); }
// public static void SEND_FEEDBACK_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.SEND_FEEDBACK_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text REPORT_BUGS_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.REPORT_BUGS_TEXT); }
// public static void REPORT_BUGS_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.REPORT_BUGS_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text OPTIONS_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.OPTIONS_TEXT); }
// public static void OPTIONS_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.OPTIONS_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text SHARE_TO_LAN_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.SHARE_TO_LAN_TEXT); }
// public static void SHARE_TO_LAN_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.SHARE_TO_LAN_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text PLAYER_REPORTING_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.GameMenuScreen.PLAYER_REPORTING_TEXT); }
// public static void PLAYER_REPORTING_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.GameMenuScreen.PLAYER_REPORTING_TEXT = value.wrapperContained; }
...
// public static void method_19836(yarnwrap.client.gui.widget.ButtonWidget button, ) { net.minecraft.client.gui.screen.GameMenuScreen.method_19836(button.wrapperContained); }
...
// public static void method_19845(yarnwrap.client.gui.widget.ButtonWidget button, ) { net.minecraft.client.gui.screen.GameMenuScreen.method_19845(button.wrapperContained); }
// public void initWidgets() { wrapperContained.initWidgets(); }
// public static void initWidgets() { net.minecraft.client.gui.screen.GameMenuScreen.initWidgets(); }
// public void disconnect() { wrapperContained.disconnect(); }
// public static void disconnect() { net.minecraft.client.gui.screen.GameMenuScreen.disconnect(); }
// public void method_47898(java.util.function.Supplier button) { wrapperContained.method_47898(button); }
// public static void method_47898(java.util.function.Supplier button, ) { net.minecraft.client.gui.screen.GameMenuScreen.method_47898(button); }
...
// public static yarnwrap.client.gui.widget.ButtonWidget createUrlButton(yarnwrap.client.gui.screen.Screen parent,yarnwrap.text.Text text,java.net.URI uri, ) { return new yarnwrap.client.gui.widget.ButtonWidget(net.minecraft.client.gui.screen.GameMenuScreen.createUrlButton(parent.wrapperContained,text.wrapperContained,uri)); }
...
// public static yarnwrap.client.gui.widget.ButtonWidget createButton(yarnwrap.text.Text text,java.util.function.Supplier screenSupplier, ) { return new yarnwrap.client.gui.widget.ButtonWidget(net.minecraft.client.gui.screen.GameMenuScreen.createButton(text.wrapperContained,screenSupplier)); }
