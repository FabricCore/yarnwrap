...
// public static yarnwrap.client.option.SimpleOption method_45628(yarnwrap.sound.SoundCategory category, ) { return new yarnwrap.client.option.SimpleOption(net.minecraft.client.gui.screen.option.SoundOptionsScreen.method_45628(category.wrapperContained)); }
...
// public static net.minecraft.client.option.SimpleOption[] getOptions(yarnwrap.client.option.GameOptions gameOptions, ) { return net.minecraft.client.gui.screen.option.SoundOptionsScreen.getOptions(gameOptions.wrapperContained); }
