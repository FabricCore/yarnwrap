...
// public static int mipmapLevels() { return net.minecraft.client.gui.screen.option.VideoOptionsScreen.mipmapLevels; }
// public static void mipmapLevels(int value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.mipmapLevels = value; }
...
// public static yarnwrap.text.Text GRAPHICS_FABULOUS_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_FABULOUS_TEXT); }
// public static void GRAPHICS_FABULOUS_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_FABULOUS_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text GRAPHICS_WARNING_MESSAGE_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_MESSAGE_TEXT); }
// public static void GRAPHICS_WARNING_MESSAGE_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_MESSAGE_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text GRAPHICS_WARNING_TITLE_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_TITLE_TEXT); }
// public static void GRAPHICS_WARNING_TITLE_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_TITLE_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text GRAPHICS_WARNING_ACCEPT_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_ACCEPT_TEXT); }
// public static void GRAPHICS_WARNING_ACCEPT_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_ACCEPT_TEXT = value.wrapperContained; }
...
// public static yarnwrap.text.Text GRAPHICS_WARNING_CANCEL_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_CANCEL_TEXT); }
// public static void GRAPHICS_WARNING_CANCEL_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.GRAPHICS_WARNING_CANCEL_TEXT = value.wrapperContained; }
...
// public static yarnwrap.client.resource.VideoWarningManager warningManager() { return new yarnwrap.client.resource.VideoWarningManager(net.minecraft.client.gui.screen.option.VideoOptionsScreen.warningManager); }
// public static void warningManager(yarnwrap.client.resource.VideoWarningManager value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.warningManager = value.wrapperContained; }
...
// public static yarnwrap.text.Text TITLE_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.option.VideoOptionsScreen.TITLE_TEXT); }
// public static void TITLE_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.TITLE_TEXT = value.wrapperContained; }
...
// public static void method_30052(yarnwrap.client.gui.widget.ButtonWidget button, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.method_30052(button.wrapperContained); }
...
// public static void method_30053(yarnwrap.client.gui.widget.ButtonWidget button, ) { net.minecraft.client.gui.screen.option.VideoOptionsScreen.method_30053(button.wrapperContained); }
...
// public static net.minecraft.client.option.SimpleOption[] getOptions(yarnwrap.client.option.GameOptions gameOptions, ) { return net.minecraft.client.gui.screen.option.VideoOptionsScreen.getOptions(gameOptions.wrapperContained); }
