...
// public static yarnwrap.client.gui.screen.Screen parent() { return new yarnwrap.client.gui.screen.Screen(net.minecraft.client.gui.screen.option.GameOptionsScreen.parent); }
// public static void parent(yarnwrap.client.gui.screen.Screen value, ) { net.minecraft.client.gui.screen.option.GameOptionsScreen.parent = value.wrapperContained; }
...
// public static yarnwrap.client.option.GameOptions gameOptions() { return new yarnwrap.client.option.GameOptions(net.minecraft.client.gui.screen.option.GameOptionsScreen.gameOptions); }
// public static void gameOptions(yarnwrap.client.option.GameOptions value, ) { net.minecraft.client.gui.screen.option.GameOptionsScreen.gameOptions = value.wrapperContained; }
...
// public static yarnwrap.client.gui.widget.ThreePartsLayoutWidget layout() { return new yarnwrap.client.gui.widget.ThreePartsLayoutWidget(net.minecraft.client.gui.screen.option.GameOptionsScreen.layout); }
// public static void layout(yarnwrap.client.gui.widget.ThreePartsLayoutWidget value, ) { net.minecraft.client.gui.screen.option.GameOptionsScreen.layout = value.wrapperContained; }
...
// public static yarnwrap.client.gui.widget.OptionListWidget body() { return new yarnwrap.client.gui.widget.OptionListWidget(net.minecraft.client.gui.screen.option.GameOptionsScreen.body); }
// public static void body(yarnwrap.client.gui.widget.OptionListWidget value, ) { net.minecraft.client.gui.screen.option.GameOptionsScreen.body = value.wrapperContained; }
...
// public static void initFooter() { net.minecraft.client.gui.screen.option.GameOptionsScreen.initFooter(); }
...
// public static void method_57731(yarnwrap.client.gui.widget.ButtonWidget button, ) { net.minecraft.client.gui.screen.option.GameOptionsScreen.method_57731(button.wrapperContained); }
// public void initHeader() { wrapperContained.initHeader(); }
// public static void initHeader() { net.minecraft.client.gui.screen.option.GameOptionsScreen.initHeader(); }
