...
// public static yarnwrap.util.Identifier TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.GrindstoneScreen.TEXTURE); }
// public static void TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.GrindstoneScreen.TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier ERROR_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.GrindstoneScreen.ERROR_TEXTURE); }
// public static void ERROR_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.GrindstoneScreen.ERROR_TEXTURE = value.wrapperContained; }
