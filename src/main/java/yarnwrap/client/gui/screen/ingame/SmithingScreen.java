...
// public static org.joml.Quaternionf ARMOR_STAND_ROTATION() { return net.minecraft.client.gui.screen.ingame.SmithingScreen.ARMOR_STAND_ROTATION; }
// public static void ARMOR_STAND_ROTATION(org.joml.Quaternionf value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.ARMOR_STAND_ROTATION = value; }
...
// public static yarnwrap.util.Identifier EMPTY_SLOT_SMITHING_TEMPLATE_ARMOR_TRIM_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.SmithingScreen.EMPTY_SLOT_SMITHING_TEMPLATE_ARMOR_TRIM_TEXTURE); }
// public static void EMPTY_SLOT_SMITHING_TEMPLATE_ARMOR_TRIM_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.EMPTY_SLOT_SMITHING_TEMPLATE_ARMOR_TRIM_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier EMPTY_SLOT_SMITHING_TEMPLATE_NETHERITE_UPGRADE_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.SmithingScreen.EMPTY_SLOT_SMITHING_TEMPLATE_NETHERITE_UPGRADE_TEXTURE); }
// public static void EMPTY_SLOT_SMITHING_TEMPLATE_NETHERITE_UPGRADE_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.EMPTY_SLOT_SMITHING_TEMPLATE_NETHERITE_UPGRADE_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.text.Text MISSING_TEMPLATE_TOOLTIP() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.ingame.SmithingScreen.MISSING_TEMPLATE_TOOLTIP); }
// public static void MISSING_TEMPLATE_TOOLTIP(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.MISSING_TEMPLATE_TOOLTIP = value.wrapperContained; }
...
// public static yarnwrap.text.Text ERROR_TOOLTIP() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.ingame.SmithingScreen.ERROR_TOOLTIP); }
// public static void ERROR_TOOLTIP(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.ERROR_TOOLTIP = value.wrapperContained; }
...
// public static java.util.List EMPTY_SLOT_TEXTURES() { return net.minecraft.client.gui.screen.ingame.SmithingScreen.EMPTY_SLOT_TEXTURES; }
// public static void EMPTY_SLOT_TEXTURES(java.util.List value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.EMPTY_SLOT_TEXTURES = value; }
...
// public static yarnwrap.client.gui.screen.ingame.CyclingSlotIcon templateSlotIcon() { return new yarnwrap.client.gui.screen.ingame.CyclingSlotIcon(net.minecraft.client.gui.screen.ingame.SmithingScreen.templateSlotIcon); }
// public static void templateSlotIcon(yarnwrap.client.gui.screen.ingame.CyclingSlotIcon value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.templateSlotIcon = value.wrapperContained; }
...
// public static yarnwrap.client.gui.screen.ingame.CyclingSlotIcon baseSlotIcon() { return new yarnwrap.client.gui.screen.ingame.CyclingSlotIcon(net.minecraft.client.gui.screen.ingame.SmithingScreen.baseSlotIcon); }
// public static void baseSlotIcon(yarnwrap.client.gui.screen.ingame.CyclingSlotIcon value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.baseSlotIcon = value.wrapperContained; }
...
// public static yarnwrap.client.gui.screen.ingame.CyclingSlotIcon additionsSlotIcon() { return new yarnwrap.client.gui.screen.ingame.CyclingSlotIcon(net.minecraft.client.gui.screen.ingame.SmithingScreen.additionsSlotIcon); }
// public static void additionsSlotIcon(yarnwrap.client.gui.screen.ingame.CyclingSlotIcon value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.additionsSlotIcon = value.wrapperContained; }
...
// public static void ERROR_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.ERROR_TEXTURE = value.wrapperContained; }
...
// public static java.util.Optional getSmithingTemplate() { return net.minecraft.client.gui.screen.ingame.SmithingScreen.getSmithingTemplate(); }
// public boolean hasInvalidRecipe() { return wrapperContained.hasInvalidRecipe(); }
// public static boolean hasInvalidRecipe() { return net.minecraft.client.gui.screen.ingame.SmithingScreen.hasInvalidRecipe(); }
// public void method_48475(yarnwrap.client.gui.DrawContext text) { wrapperContained.method_48475(text.wrapperContained); }
// public static void method_48475(yarnwrap.client.gui.DrawContext text, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.method_48475(text.wrapperContained); }
...
// public static void renderSlotTooltip(yarnwrap.client.gui.DrawContext context,int mouseX,int mouseY, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.renderSlotTooltip(context.wrapperContained,mouseX,mouseY); }
// public void equipArmorStand(yarnwrap.item.ItemStack stack) { wrapperContained.equipArmorStand(stack.wrapperContained); }
// public static void equipArmorStand(yarnwrap.item.ItemStack stack, ) { net.minecraft.client.gui.screen.ingame.SmithingScreen.equipArmorStand(stack.wrapperContained); }
