...
// public static void primaryEffect(yarnwrap.registry.entry.RegistryEntry value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.primaryEffect = value.wrapperContained; }
...
// public static yarnwrap.registry.entry.RegistryEntry secondaryEffect() { return new yarnwrap.registry.entry.RegistryEntry(net.minecraft.client.gui.screen.ingame.BeaconScreen.secondaryEffect); }
// public static void secondaryEffect(yarnwrap.registry.entry.RegistryEntry value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.secondaryEffect = value.wrapperContained; }
...
// public static yarnwrap.text.Text PRIMARY_POWER_TEXT() { return new yarnwrap.text.Text(net.minecraft.client.gui.screen.ingame.BeaconScreen.PRIMARY_POWER_TEXT); }
// public static void PRIMARY_POWER_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.PRIMARY_POWER_TEXT = value.wrapperContained; }
...
// public static java.util.List buttons() { return net.minecraft.client.gui.screen.ingame.BeaconScreen.buttons; }
// public static void buttons(java.util.List value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.buttons = value; }
...
// public static yarnwrap.util.Identifier BUTTON_HIGHLIGHTED_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_HIGHLIGHTED_TEXTURE); }
// public static void BUTTON_HIGHLIGHTED_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_HIGHLIGHTED_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier BUTTON_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_TEXTURE); }
// public static void BUTTON_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier CONFIRM_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.BeaconScreen.CONFIRM_TEXTURE); }
// public static void CONFIRM_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.CONFIRM_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier CANCEL_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.BeaconScreen.CANCEL_TEXTURE); }
// public static void CANCEL_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.CANCEL_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier BUTTON_DISABLED_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_DISABLED_TEXTURE); }
// public static void BUTTON_DISABLED_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_DISABLED_TEXTURE = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier BUTTON_SELECTED_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_SELECTED_TEXTURE); }
// public static void BUTTON_SELECTED_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.BUTTON_SELECTED_TEXTURE = value.wrapperContained; }
...
// public static void method_37075(int button, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.method_37075(button); }
...
// public static void addButton(yarnwrap.client.gui.widget.ClickableWidget button, ) { net.minecraft.client.gui.screen.ingame.BeaconScreen.addButton(button.wrapperContained); }
// public void tickButtons() { wrapperContained.tickButtons(); }
// public static void tickButtons() { net.minecraft.client.gui.screen.ingame.BeaconScreen.tickButtons(); }
