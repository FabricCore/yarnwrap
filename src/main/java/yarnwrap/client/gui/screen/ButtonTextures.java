...
// public static yarnwrap.util.Identifier get(boolean enabled,boolean focused, ) { return new yarnwrap.util.Identifier(net.minecraft.client.gui.screen.ButtonTextures.get(enabled,focused)); }
