...
// public static yarnwrap.client.gui.navigation.NavigationDirection getDirection() { return new yarnwrap.client.gui.navigation.NavigationDirection(net.minecraft.client.gui.navigation.GuiNavigation.getDirection()); }
