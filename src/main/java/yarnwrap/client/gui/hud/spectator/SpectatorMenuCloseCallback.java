...
// public static void close(yarnwrap.client.gui.hud.spectator.SpectatorMenu menu, ) { net.minecraft.client.gui.hud.spectator.SpectatorMenuCloseCallback.close(menu.wrapperContained); }
