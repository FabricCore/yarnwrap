...
// public static void TEAM_TELEPORT_TEXT(yarnwrap.text.Text value, ) { net.minecraft.client.gui.hud.spectator.TeamTeleportSpectatorMenu.TEAM_TELEPORT_TEXT = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.hud.spectator.TeamTeleportSpectatorMenu.TEXTURE); }
// public static void TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.hud.spectator.TeamTeleportSpectatorMenu.TEXTURE = value.wrapperContained; }
...
// public static java.util.stream.Stream method_47431(yarnwrap.client.MinecraftClient team, ) { return net.minecraft.client.gui.hud.spectator.TeamTeleportSpectatorMenu.method_47431(team.wrapperContained); }
...
// public static java.util.List getCommands(yarnwrap.client.MinecraftClient client,yarnwrap.scoreboard.Scoreboard scoreboard, ) { return net.minecraft.client.gui.hud.spectator.TeamTeleportSpectatorMenu.getCommands(client.wrapperContained,scoreboard.wrapperContained); }
