...
// public static void ORDERING(java.util.Comparator value, ) { net.minecraft.client.gui.hud.spectator.TeleportSpectatorMenu.ORDERING = value; }
...
// public static yarnwrap.util.Identifier TELEPORT_TO_PLAYER_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.client.gui.hud.spectator.TeleportSpectatorMenu.TELEPORT_TO_PLAYER_TEXTURE); }
// public static void TELEPORT_TO_PLAYER_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.client.gui.hud.spectator.TeleportSpectatorMenu.TELEPORT_TO_PLAYER_TEXTURE = value.wrapperContained; }
...
// public static java.util.UUID method_2785(yarnwrap.client.network.PlayerListEntry a, ) { return net.minecraft.client.gui.hud.spectator.TeleportSpectatorMenu.method_2785(a.wrapperContained); }
...
// public static yarnwrap.client.gui.hud.spectator.SpectatorMenuCommand method_46520(yarnwrap.client.network.PlayerListEntry entry, ) { return new yarnwrap.client.gui.hud.spectator.SpectatorMenuCommand(net.minecraft.client.gui.hud.spectator.TeleportSpectatorMenu.method_46520(entry.wrapperContained)); }
...
// public static boolean method_46521(yarnwrap.client.network.PlayerListEntry entry, ) { return net.minecraft.client.gui.hud.spectator.TeleportSpectatorMenu.method_46521(entry.wrapperContained); }
