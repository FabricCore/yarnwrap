...
// public static void renderIcon(yarnwrap.client.gui.DrawContext context,float brightness,int alpha, ) { net.minecraft.client.gui.hud.spectator.SpectatorMenuCommand.renderIcon(context.wrapperContained,brightness,alpha); }
