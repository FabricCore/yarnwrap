...
// public static yarnwrap.util.collection.IdList providers() { return new yarnwrap.util.collection.IdList(net.minecraft.client.color.block.BlockColors.providers); }
// public static void providers(yarnwrap.util.collection.IdList value, ) { net.minecraft.client.color.block.BlockColors.providers = value.wrapperContained; }
...
// public static java.util.Map properties() { return net.minecraft.client.color.block.BlockColors.properties; }
// public static void properties(java.util.Map value, ) { net.minecraft.client.color.block.BlockColors.properties = value; }
...
// public static int method_1685(yarnwrap.block.BlockState state,yarnwrap.world.BlockRenderView world,yarnwrap.util.math.BlockPos pos,int tintIndex, ) { return net.minecraft.client.color.block.BlockColors.method_1685(state.wrapperContained,world.wrapperContained,pos.wrapperContained,tintIndex); }
...
// public static int method_1686(yarnwrap.block.BlockState state,yarnwrap.world.BlockRenderView world,yarnwrap.util.math.BlockPos pos,int tintIndex, ) { return net.minecraft.client.color.block.BlockColors.method_1686(state.wrapperContained,world.wrapperContained,pos.wrapperContained,tintIndex); }
...
// public static int method_1687(yarnwrap.block.BlockState state,yarnwrap.world.BlockRenderView world,yarnwrap.util.math.BlockPos pos,int tintIndex, ) { return net.minecraft.client.color.block.BlockColors.method_1687(state.wrapperContained,world.wrapperContained,pos.wrapperContained,tintIndex); }
...
// public static int method_1688(yarnwrap.block.BlockState state,yarnwrap.world.BlockRenderView world,yarnwrap.util.math.BlockPos pos,int tintIndex, ) { return net.minecraft.client.color.block.BlockColors.method_1688(state.wrapperContained,world.wrapperContained,pos.wrapperContained,tintIndex); }
...
public static yarnwrap.client.color.block.BlockColors create() { return new yarnwrap.client.color.block.BlockColors(net.minecraft.client.color.block.BlockColors.create()); }
...
// public static void registerColorProvider(yarnwrap.client.color.block.BlockColorProvider provider,net.minecraft.block.Block[] blocks, ) { net.minecraft.client.color.block.BlockColors.registerColorProvider(provider.wrapperContained,blocks); }
...
// public static int getParticleColor(yarnwrap.block.BlockState state,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.client.color.block.BlockColors.getParticleColor(state.wrapperContained,world.wrapperContained,pos.wrapperContained); }
...
// public static void registerColorProperty(yarnwrap.state.property.Property property,net.minecraft.block.Block[] blocks, ) { net.minecraft.client.color.block.BlockColors.registerColorProperty(property.wrapperContained,blocks); }
