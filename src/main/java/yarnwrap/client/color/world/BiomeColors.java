...
// public static int method_23790(yarnwrap.world.biome.Biome biome,double x,double z, ) { return net.minecraft.client.color.world.BiomeColors.method_23790(biome.wrapperContained,x,z); }
