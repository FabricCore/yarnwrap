...
// public static int getColor(yarnwrap.item.ItemStack stack,int tintIndex, ) { return net.minecraft.client.color.item.ItemColorProvider.getColor(stack.wrapperContained,tintIndex); }
