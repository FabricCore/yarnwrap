...
// public static yarnwrap.client.particle.Particle createParticle(yarnwrap.particle.ParticleEffect parameters,yarnwrap.client.world.ClientWorld world,double x,double y,double z,double velocityX,double velocityY,double velocityZ, ) { return new yarnwrap.client.particle.Particle(net.minecraft.client.particle.ParticleFactory.createParticle(parameters.wrapperContained,world.wrapperContained,x,y,z,velocityX,velocityY,velocityZ)); }
