...
// public static yarnwrap.client.texture.SpriteAtlasTexture atlas() { return new yarnwrap.client.texture.SpriteAtlasTexture(net.minecraft.client.texture.SpriteAtlasHolder.atlas); }
// public static void atlas(yarnwrap.client.texture.SpriteAtlasTexture value, ) { net.minecraft.client.texture.SpriteAtlasHolder.atlas = value.wrapperContained; }
...
// public static yarnwrap.util.Identifier sourcePath() { return new yarnwrap.util.Identifier(net.minecraft.client.texture.SpriteAtlasHolder.sourcePath); }
// public static void sourcePath(yarnwrap.util.Identifier value, ) { net.minecraft.client.texture.SpriteAtlasHolder.sourcePath = value.wrapperContained; }
...
// public static java.util.Set metadataReaders() { return net.minecraft.client.texture.SpriteAtlasHolder.metadataReaders; }
// public static void metadataReaders(java.util.Set value, ) { net.minecraft.client.texture.SpriteAtlasHolder.metadataReaders = value; }
