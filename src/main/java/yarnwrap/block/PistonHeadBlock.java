...
// public void SHORT_WEST_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SHORT_WEST_ARM_SHAPE = value.wrapperContained; }
...
// public void NORTH_HEAD_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.NORTH_HEAD_SHAPE = value.wrapperContained; }
...
// public void WEST_HEAD_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.WEST_HEAD_SHAPE = value.wrapperContained; }
...
// public void UP_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.UP_ARM_SHAPE = value.wrapperContained; }
...
// public void SHORT_SOUTH_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SHORT_SOUTH_ARM_SHAPE = value.wrapperContained; }
...
// public void SHORT_DOWN_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SHORT_DOWN_ARM_SHAPE = value.wrapperContained; }
...
// public void EAST_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.EAST_ARM_SHAPE = value.wrapperContained; }
...
// public void SHORT_EAST_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SHORT_EAST_ARM_SHAPE = value.wrapperContained; }
...
// public void DOWN_HEAD_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.DOWN_HEAD_SHAPE = value.wrapperContained; }
...
// public void SOUTH_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SOUTH_ARM_SHAPE = value.wrapperContained; }
...
// public void EAST_HEAD_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.EAST_HEAD_SHAPE = value.wrapperContained; }
...
// public void WEST_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.WEST_ARM_SHAPE = value.wrapperContained; }
...
// public void SHORT_NORTH_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SHORT_NORTH_ARM_SHAPE = value.wrapperContained; }
...
// public void DOWN_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.DOWN_ARM_SHAPE = value.wrapperContained; }
...
// public void SOUTH_HEAD_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SOUTH_HEAD_SHAPE = value.wrapperContained; }
...
// public void NORTH_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.NORTH_ARM_SHAPE = value.wrapperContained; }
...
// public void UP_HEAD_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.UP_HEAD_SHAPE = value.wrapperContained; }
...
// public void SHORT_UP_ARM_SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SHORT_UP_ARM_SHAPE = value.wrapperContained; }
// public net.minecraft.util.shape.VoxelShape[] SHORT_HEAD_SHAPES() { return wrapperContained.SHORT_HEAD_SHAPES; }
// public void SHORT_HEAD_SHAPES(net.minecraft.util.shape.VoxelShape[] value) { wrapperContained.SHORT_HEAD_SHAPES = value; }
// public net.minecraft.util.shape.VoxelShape[] HEAD_SHAPES() { return wrapperContained.HEAD_SHAPES; }
// public void HEAD_SHAPES(net.minecraft.util.shape.VoxelShape[] value) { wrapperContained.HEAD_SHAPES = value; }
