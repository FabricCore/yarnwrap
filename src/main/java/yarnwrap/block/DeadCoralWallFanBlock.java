...
public static yarnwrap.state.property.EnumProperty FACING() { return new yarnwrap.state.property.EnumProperty(net.minecraft.block.DeadCoralWallFanBlock.FACING); }
// public static void FACING(yarnwrap.state.property.EnumProperty value, ) { net.minecraft.block.DeadCoralWallFanBlock.FACING = value.wrapperContained; }
...
// public static java.util.Map SHAPES_BY_DIRECTION() { return net.minecraft.block.DeadCoralWallFanBlock.SHAPES_BY_DIRECTION; }
// public static void SHAPES_BY_DIRECTION(java.util.Map value, ) { net.minecraft.block.DeadCoralWallFanBlock.SHAPES_BY_DIRECTION = value; }
