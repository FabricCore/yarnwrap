...
public static yarnwrap.state.property.BooleanProperty SHRIEKING() { return new yarnwrap.state.property.BooleanProperty(net.minecraft.block.SculkShriekerBlock.SHRIEKING); }
// public static void SHRIEKING(yarnwrap.state.property.BooleanProperty value, ) { net.minecraft.block.SculkShriekerBlock.SHRIEKING = value.wrapperContained; }

// public yarnwrap.state.property.BooleanProperty WATERLOGGED() { return new yarnwrap.state.property.BooleanProperty(wrapperContained.WATERLOGGED); }
// public void WATERLOGGED(yarnwrap.state.property.BooleanProperty value) { wrapperContained.WATERLOGGED = value.wrapperContained; }
public static yarnwrap.state.property.BooleanProperty WATERLOGGED() { return new yarnwrap.state.property.BooleanProperty(net.minecraft.block.SculkShriekerBlock.WATERLOGGED); }
// public static void WATERLOGGED(yarnwrap.state.property.BooleanProperty value, ) { net.minecraft.block.SculkShriekerBlock.WATERLOGGED = value.wrapperContained; }

// public yarnwrap.util.shape.VoxelShape SHAPE() { return new yarnwrap.util.shape.VoxelShape(wrapperContained.SHAPE); }
// public void SHAPE(yarnwrap.util.shape.VoxelShape value) { wrapperContained.SHAPE = value.wrapperContained; }
// public static yarnwrap.util.shape.VoxelShape SHAPE() { return new yarnwrap.util.shape.VoxelShape(net.minecraft.block.SculkShriekerBlock.SHAPE); }
// public static void SHAPE(yarnwrap.util.shape.VoxelShape value, ) { net.minecraft.block.SculkShriekerBlock.SHAPE = value.wrapperContained; }

// public double TOP() { return wrapperContained.TOP; }
// public void TOP(double value) { wrapperContained.TOP = value; }
public static double TOP() { return net.minecraft.block.SculkShriekerBlock.TOP; }
// public static void TOP(double value, ) { net.minecraft.block.SculkShriekerBlock.TOP = value; }
...
public static yarnwrap.state.property.BooleanProperty CAN_SUMMON() { return new yarnwrap.state.property.BooleanProperty(net.minecraft.block.SculkShriekerBlock.CAN_SUMMON); }
// public static void CAN_SUMMON(yarnwrap.state.property.BooleanProperty value, ) { net.minecraft.block.SculkShriekerBlock.CAN_SUMMON = value.wrapperContained; }

// public com.mojang.serialization.MapCodec CODEC() { return wrapperContained.CODEC; }
// public void CODEC(com.mojang.serialization.MapCodec value) { wrapperContained.CODEC = value; }
public static com.mojang.serialization.MapCodec CODEC() { return net.minecraft.block.SculkShriekerBlock.CODEC; }
// public static void CODEC(com.mojang.serialization.MapCodec value, ) { net.minecraft.block.SculkShriekerBlock.CODEC = value; }
