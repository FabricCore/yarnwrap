...
// public static net.minecraft.util.shape.VoxelShape[] SHAPES() { return net.minecraft.block.PropaguleBlock.SHAPES; }
// public static void SHAPES(net.minecraft.util.shape.VoxelShape[] value, ) { net.minecraft.block.PropaguleBlock.SHAPES = value; }
