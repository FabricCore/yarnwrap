...
// public static yarnwrap.block.BlockState getStateWithInstrument(yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos,yarnwrap.block.BlockState state, ) { return new yarnwrap.block.BlockState(net.minecraft.block.NoteBlock.getStateWithInstrument(world.wrapperContained,pos.wrapperContained,state.wrapperContained)); }
