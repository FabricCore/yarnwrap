...
// public static yarnwrap.registry.RegistryKey lootTableKey() { return new yarnwrap.registry.RegistryKey(net.minecraft.block.AbstractBlock.lootTableKey); }
// public static void lootTableKey(yarnwrap.registry.RegistryKey value, ) { net.minecraft.block.AbstractBlock.lootTableKey = value.wrapperContained; }
...
// public static yarnwrap.registry.RegistryKey getLootTableKey() { return new yarnwrap.registry.RegistryKey(net.minecraft.block.AbstractBlock.getLootTableKey()); }
...
// public static boolean isCullingShapeFullCube(yarnwrap.block.BlockState state,yarnwrap.world.BlockView world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.block.AbstractBlock.isCullingShapeFullCube(state.wrapperContained,world.wrapperContained,pos.wrapperContained); }
...
// public static yarnwrap.util.ItemActionResult onUseWithItem(yarnwrap.item.ItemStack stack,yarnwrap.block.BlockState state,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.entity.player.PlayerEntity player,yarnwrap.util.Hand hand,yarnwrap.util.hit.BlockHitResult hit, ) { return new yarnwrap.util.ItemActionResult(net.minecraft.block.AbstractBlock.onUseWithItem(stack.wrapperContained,state.wrapperContained,world.wrapperContained,pos.wrapperContained,player.wrapperContained,hand.wrapperContained,hit.wrapperContained)); }
...
// public static int getOpacity(yarnwrap.block.BlockState state,yarnwrap.world.BlockView world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.block.AbstractBlock.getOpacity(state.wrapperContained,world.wrapperContained,pos.wrapperContained); }
...
// public static void onStateReplaced(yarnwrap.block.BlockState state,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.block.BlockState newState,boolean moved, ) { net.minecraft.block.AbstractBlock.onStateReplaced(state.wrapperContained,world.wrapperContained,pos.wrapperContained,newState.wrapperContained,moved); }
...
// public static void onEntityCollision(yarnwrap.block.BlockState state,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.entity.Entity entity, ) { net.minecraft.block.AbstractBlock.onEntityCollision(state.wrapperContained,world.wrapperContained,pos.wrapperContained,entity.wrapperContained); }
...
// public static yarnwrap.block.BlockState getStateForNeighborUpdate(yarnwrap.block.BlockState state,yarnwrap.util.math.Direction direction,yarnwrap.block.BlockState neighborState,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos,yarnwrap.util.math.BlockPos neighborPos, ) { return new yarnwrap.block.BlockState(net.minecraft.block.AbstractBlock.getStateForNeighborUpdate(state.wrapperContained,direction.wrapperContained,neighborState.wrapperContained,world.wrapperContained,pos.wrapperContained,neighborPos.wrapperContained)); }
...
// public static yarnwrap.util.shape.VoxelShape getCullingShape(yarnwrap.block.BlockState state,yarnwrap.world.BlockView world,yarnwrap.util.math.BlockPos pos, ) { return new yarnwrap.util.shape.VoxelShape(net.minecraft.block.AbstractBlock.getCullingShape(state.wrapperContained,world.wrapperContained,pos.wrapperContained)); }
...
// public static boolean isTransparent(yarnwrap.block.BlockState state,yarnwrap.world.BlockView world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.block.AbstractBlock.isTransparent(state.wrapperContained,world.wrapperContained,pos.wrapperContained); }
...
// public static void neighborUpdate(yarnwrap.block.BlockState state,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.block.Block sourceBlock,yarnwrap.util.math.BlockPos sourcePos,boolean notify, ) { net.minecraft.block.AbstractBlock.neighborUpdate(state.wrapperContained,world.wrapperContained,pos.wrapperContained,sourceBlock.wrapperContained,sourcePos.wrapperContained,notify); }
