...
// public static boolean canSpread(yarnwrap.block.BlockState state,yarnwrap.world.WorldView world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.block.SpreadableBlock.canSpread(state.wrapperContained,world.wrapperContained,pos.wrapperContained); }
...
// public static boolean canSurvive(yarnwrap.block.BlockState state,yarnwrap.world.WorldView world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.block.SpreadableBlock.canSurvive(state.wrapperContained,world.wrapperContained,pos.wrapperContained); }
