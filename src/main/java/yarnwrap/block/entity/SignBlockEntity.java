...
// public boolean DEFAULT_WAXED() { return wrapperContained.DEFAULT_WAXED; }
// public void DEFAULT_WAXED(boolean value) { wrapperContained.DEFAULT_WAXED = value; }
// public static boolean DEFAULT_WAXED() { return net.minecraft.block.entity.SignBlockEntity.DEFAULT_WAXED; }
// public static void DEFAULT_WAXED(boolean value, ) { net.minecraft.block.entity.SignBlockEntity.DEFAULT_WAXED = value; }
...
// public yarnwrap.server.command.ServerCommandSource createCommandSource(yarnwrap.entity.player.PlayerEntity player,yarnwrap.server.world.ServerWorld world,yarnwrap.util.math.BlockPos pos) { return new yarnwrap.server.command.ServerCommandSource(wrapperContained.createCommandSource(player.wrapperContained,world.wrapperContained,pos.wrapperContained)); }
// public static yarnwrap.server.command.ServerCommandSource createCommandSource(yarnwrap.entity.player.PlayerEntity player,yarnwrap.server.world.ServerWorld world,yarnwrap.util.math.BlockPos pos, ) { return new yarnwrap.server.command.ServerCommandSource(net.minecraft.block.entity.SignBlockEntity.createCommandSource(player.wrapperContained,world.wrapperContained,pos.wrapperContained)); }
// public boolean runCommandClickEvent(yarnwrap.server.world.ServerWorld world,yarnwrap.entity.player.PlayerEntity player,yarnwrap.util.math.BlockPos pos,boolean front) { return wrapperContained.runCommandClickEvent(world.wrapperContained,player.wrapperContained,pos.wrapperContained,front); }
// public static boolean runCommandClickEvent(yarnwrap.server.world.ServerWorld world,yarnwrap.entity.player.PlayerEntity player,yarnwrap.util.math.BlockPos pos,boolean front, ) { return net.minecraft.block.entity.SignBlockEntity.runCommandClickEvent(world.wrapperContained,player.wrapperContained,pos.wrapperContained,front); }
