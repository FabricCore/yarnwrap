...
// public static int brewTime() { return net.minecraft.block.entity.BrewingStandBlockEntity.brewTime; }
// public static void brewTime(int value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.brewTime = value; }
...
// public static int[] BOTTOM_SLOTS() { return net.minecraft.block.entity.BrewingStandBlockEntity.BOTTOM_SLOTS; }
// public static void BOTTOM_SLOTS(int[] value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.BOTTOM_SLOTS = value; }
...
// public static int[] SIDE_SLOTS() { return net.minecraft.block.entity.BrewingStandBlockEntity.SIDE_SLOTS; }
// public static void SIDE_SLOTS(int[] value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.SIDE_SLOTS = value; }
...
// public static yarnwrap.item.Item itemBrewing() { return new yarnwrap.item.Item(net.minecraft.block.entity.BrewingStandBlockEntity.itemBrewing); }
// public static void itemBrewing(yarnwrap.item.Item value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.itemBrewing = value.wrapperContained; }
...
// public static yarnwrap.util.collection.DefaultedList inventory() { return new yarnwrap.util.collection.DefaultedList(net.minecraft.block.entity.BrewingStandBlockEntity.inventory); }
// public static void inventory(yarnwrap.util.collection.DefaultedList value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.inventory = value.wrapperContained; }
...
// public static boolean[] slotsEmptyLastTick() { return net.minecraft.block.entity.BrewingStandBlockEntity.slotsEmptyLastTick; }
// public static void slotsEmptyLastTick(boolean[] value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.slotsEmptyLastTick = value; }

// public int fuel() { return wrapperContained.fuel; }
// public void fuel(int value) { wrapperContained.fuel = value; }
// public static int fuel() { return net.minecraft.block.entity.BrewingStandBlockEntity.fuel; }
// public static void fuel(int value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.fuel = value; }

// public int[] TOP_SLOTS() { return wrapperContained.TOP_SLOTS; }
// public void TOP_SLOTS(int[] value) { wrapperContained.TOP_SLOTS = value; }
// public static int[] TOP_SLOTS() { return net.minecraft.block.entity.BrewingStandBlockEntity.TOP_SLOTS; }
// public static void TOP_SLOTS(int[] value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.TOP_SLOTS = value; }
...
// public static yarnwrap.screen.PropertyDelegate propertyDelegate() { return new yarnwrap.screen.PropertyDelegate(net.minecraft.block.entity.BrewingStandBlockEntity.propertyDelegate); }
// public static void propertyDelegate(yarnwrap.screen.PropertyDelegate value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.propertyDelegate = value.wrapperContained; }
...
public static int MAX_FUEL_USES() { return net.minecraft.block.entity.BrewingStandBlockEntity.MAX_FUEL_USES; }
// public static void MAX_FUEL_USES(int value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.MAX_FUEL_USES = value; }
...
public static int BREW_TIME_PROPERTY_INDEX() { return net.minecraft.block.entity.BrewingStandBlockEntity.BREW_TIME_PROPERTY_INDEX; }
// public static void BREW_TIME_PROPERTY_INDEX(int value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.BREW_TIME_PROPERTY_INDEX = value; }
...
public static int FUEL_PROPERTY_INDEX() { return net.minecraft.block.entity.BrewingStandBlockEntity.FUEL_PROPERTY_INDEX; }
// public static void FUEL_PROPERTY_INDEX(int value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.FUEL_PROPERTY_INDEX = value; }
...
public static int PROPERTY_COUNT() { return net.minecraft.block.entity.BrewingStandBlockEntity.PROPERTY_COUNT; }
// public static void PROPERTY_COUNT(int value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.PROPERTY_COUNT = value; }
...
// public static int INPUT_SLOT_INDEX() { return net.minecraft.block.entity.BrewingStandBlockEntity.INPUT_SLOT_INDEX; }
// public static void INPUT_SLOT_INDEX(int value, ) { net.minecraft.block.entity.BrewingStandBlockEntity.INPUT_SLOT_INDEX = value; }
...
// public static boolean[] getSlotsEmpty() { return net.minecraft.block.entity.BrewingStandBlockEntity.getSlotsEmpty(); }
...
// public static void craft(yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.util.collection.DefaultedList slots, ) { net.minecraft.block.entity.BrewingStandBlockEntity.craft(world.wrapperContained,pos.wrapperContained,slots.wrapperContained); }
