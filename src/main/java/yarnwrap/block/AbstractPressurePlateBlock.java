...
// public static void BOX(yarnwrap.util.math.Box value, ) { net.minecraft.block.AbstractPressurePlateBlock.BOX = value.wrapperContained; }
...
// public static yarnwrap.util.shape.VoxelShape PRESSED_SHAPE() { return new yarnwrap.util.shape.VoxelShape(net.minecraft.block.AbstractPressurePlateBlock.PRESSED_SHAPE); }
// public static void PRESSED_SHAPE(yarnwrap.util.shape.VoxelShape value, ) { net.minecraft.block.AbstractPressurePlateBlock.PRESSED_SHAPE = value.wrapperContained; }
...
// public static void updatePlateState(yarnwrap.entity.Entity entity,yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos,yarnwrap.block.BlockState state,int output, ) { net.minecraft.block.AbstractPressurePlateBlock.updatePlateState(entity.wrapperContained,world.wrapperContained,pos.wrapperContained,state.wrapperContained,output); }
...
// public static int getRedstoneOutput(yarnwrap.world.World world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.block.AbstractPressurePlateBlock.getRedstoneOutput(world.wrapperContained,pos.wrapperContained); }
...
// public static int getRedstoneOutput(yarnwrap.block.BlockState state, ) { return net.minecraft.block.AbstractPressurePlateBlock.getRedstoneOutput(state.wrapperContained); }
