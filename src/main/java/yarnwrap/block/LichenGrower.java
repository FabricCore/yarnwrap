...
// public static Object GROW_TYPES() { return net.minecraft.block.LichenGrower.GROW_TYPES; }
// // public static void GROW_TYPES(Object value, ) { net.minecraft.block.LichenGrower.GROW_TYPES = value; }
...
// // public static Object growChecker() { return net.minecraft.block.LichenGrower.growChecker; }
// // public static void growChecker(Object value, ) { net.minecraft.block.LichenGrower.growChecker = value; }
...
// public static java.util.Optional place(yarnwrap.world.WorldAccess world,Object pos,boolean markForPostProcessing, ) { return net.minecraft.block.LichenGrower.place(world.wrapperContained,pos,markForPostProcessing); }
...
// public static java.util.Optional method_41442(yarnwrap.world.WorldAccess growPos, ) { return net.minecraft.block.LichenGrower.method_41442(growPos.wrapperContained); }
...
// public static boolean method_41444(yarnwrap.block.BlockState direction2, ) { return net.minecraft.block.LichenGrower.method_41444(direction2.wrapperContained); }
...
// public static java.util.Optional getGrowPos(yarnwrap.block.BlockState state,yarnwrap.world.BlockView world,yarnwrap.util.math.BlockPos pos,yarnwrap.util.math.Direction oldDirection,yarnwrap.util.math.Direction newDirection,Object predicate, ) { return net.minecraft.block.LichenGrower.getGrowPos(state.wrapperContained,world.wrapperContained,pos.wrapperContained,oldDirection.wrapperContained,newDirection.wrapperContained,predicate); }
...
// public static java.util.Optional grow(yarnwrap.block.BlockState state,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos,yarnwrap.util.math.Direction oldDirection,yarnwrap.util.math.Direction newDirection,boolean markForPostProcessing, ) { return net.minecraft.block.LichenGrower.grow(state.wrapperContained,world.wrapperContained,pos.wrapperContained,oldDirection.wrapperContained,newDirection.wrapperContained,markForPostProcessing); }
...
// public static java.util.Optional grow(yarnwrap.block.BlockState state,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos,yarnwrap.util.math.Direction direction,yarnwrap.util.math.random.Random random,boolean markForPostProcessing, ) { return net.minecraft.block.LichenGrower.grow(state.wrapperContained,world.wrapperContained,pos.wrapperContained,direction.wrapperContained,random.wrapperContained,markForPostProcessing); }
...
// public static long grow(yarnwrap.block.BlockState state,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos,yarnwrap.util.math.Direction direction,boolean markForPostProcessing, ) { return net.minecraft.block.LichenGrower.grow(state.wrapperContained,world.wrapperContained,pos.wrapperContained,direction.wrapperContained,markForPostProcessing); }
...
// public static java.util.Optional method_41449(yarnwrap.block.BlockState direction2, ) { return net.minecraft.block.LichenGrower.method_41449(direction2.wrapperContained); }
...
// public static java.util.Optional grow(yarnwrap.block.BlockState state,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos,yarnwrap.util.math.random.Random random, ) { return net.minecraft.block.LichenGrower.grow(state.wrapperContained,world.wrapperContained,pos.wrapperContained,random.wrapperContained); }
...
// public static java.util.Optional method_41451(yarnwrap.block.BlockState direction, ) { return net.minecraft.block.LichenGrower.method_41451(direction.wrapperContained); }
...
// public static long grow(yarnwrap.block.BlockState state,yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockPos pos,boolean markForPostProcessing, ) { return net.minecraft.block.LichenGrower.grow(state.wrapperContained,world.wrapperContained,pos.wrapperContained,markForPostProcessing); }
...
// public static java.lang.Long method_41453(yarnwrap.block.BlockState direction, ) { return net.minecraft.block.LichenGrower.method_41453(direction.wrapperContained); }
...
// public static boolean method_41454(yarnwrap.block.BlockState direction, ) { return net.minecraft.block.LichenGrower.method_41454(direction.wrapperContained); }
...
// public static java.util.Optional method_41455(yarnwrap.block.BlockState direction2, ) { return net.minecraft.block.LichenGrower.method_41455(direction2.wrapperContained); }
...
// public static boolean method_41456(yarnwrap.block.BlockState direction, ) { return net.minecraft.block.LichenGrower.method_41456(direction.wrapperContained); }
