...
// public static void validate(yarnwrap.predicate.entity.LootContextPredicate predicate,yarnwrap.loot.context.LootContextType type,java.lang.String path, ) { net.minecraft.predicate.entity.LootContextPredicateValidator.validate(predicate.wrapperContained,type.wrapperContained,path); }
...
// public static void validate(java.util.List predicates,yarnwrap.loot.context.LootContextType type,java.lang.String path, ) { net.minecraft.predicate.entity.LootContextPredicateValidator.validate(predicates,type.wrapperContained,path); }
