...
// public static java.util.Map BLOCKS_TO_BLOCK_ENTITIES() { return net.minecraft.datafixer.schema.Schema99.BLOCKS_TO_BLOCK_ENTITIES; }
// public static void BLOCKS_TO_BLOCK_ENTITIES(java.util.Map value, ) { net.minecraft.datafixer.schema.Schema99.BLOCKS_TO_BLOCK_ENTITIES = value; }

// public org.slf4j.Logger LOGGER() { return wrapperContained.LOGGER; }
// public void LOGGER(org.slf4j.Logger value) { wrapperContained.LOGGER = value; }
// public static org.slf4j.Logger LOGGER() { return net.minecraft.datafixer.schema.Schema99.LOGGER; }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5342(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5342(name); }
// public void method_5344(java.util.HashMap map) { wrapperContained.method_5344(map); }
// public static void method_5344(java.util.HashMap map, ) { net.minecraft.datafixer.schema.Schema99.method_5344(map); }
...
// public static void targetItems(com.mojang.datafixers.schemas.Schema schema,java.util.Map map,java.lang.String entityId, ) { net.minecraft.datafixer.schema.Schema99.targetItems(schema,map,entityId); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5356(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5356(name); }
...
// public static com.mojang.serialization.Dynamic method_5357(com.mojang.serialization.Dynamic tag, ) { return net.minecraft.datafixer.schema.Schema99.method_5357(tag); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5358(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5358(name); }
...
// public static java.lang.Object updateBlockEntityTags(com.mojang.serialization.Dynamic stack,java.util.Map renames, ) { return net.minecraft.datafixer.schema.Schema99.updateBlockEntityTags(stack,renames); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5362(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5362(name); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5363(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5363(name); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5365(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5365(name); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5366(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5366(name); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5367(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5367(name); }
...
// public static void targetInTile(com.mojang.datafixers.schemas.Schema schema,java.util.Map map,java.lang.String entityId, ) { net.minecraft.datafixer.schema.Schema99.targetInTile(schema,map,entityId); }
...
// public static com.mojang.serialization.Dynamic method_5371(com.mojang.serialization.Dynamic entityTag, ) { return net.minecraft.datafixer.schema.Schema99.method_5371(entityTag); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5372(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5372(name); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5374(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5374(name); }
...
// public static com.mojang.serialization.Dynamic method_5375(com.mojang.serialization.Dynamic blockEntityTag, ) { return net.minecraft.datafixer.schema.Schema99.method_5375(blockEntityTag); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5376(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5376(name); }
...
// public static void targetDisplayTile(com.mojang.datafixers.schemas.Schema schema,java.util.Map map,java.lang.String entityId, ) { net.minecraft.datafixer.schema.Schema99.targetDisplayTile(schema,map,entityId); }
...
// public static com.mojang.datafixers.types.templates.TypeTemplate method_5381(com.mojang.datafixers.schemas.Schema name, ) { return net.minecraft.datafixer.schema.Schema99.method_5381(name); }
...
// public static java.util.Map registerBlockEntities(com.mojang.datafixers.schemas.Schema schema, ) { return net.minecraft.datafixer.schema.Schema99.registerBlockEntities(schema); }
...
// public static java.util.Map registerEntities(com.mojang.datafixers.schemas.Schema schema, ) { return net.minecraft.datafixer.schema.Schema99.registerEntities(schema); }
...
// public static void registerTypes(com.mojang.datafixers.schemas.Schema schema,java.util.Map entityTypes,java.util.Map blockEntityTypes, ) { net.minecraft.datafixer.schema.Schema99.registerTypes(schema,entityTypes,blockEntityTypes); }
