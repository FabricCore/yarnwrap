...
// public static boolean shouldRemoveItem(com.mojang.serialization.Dynamic dynamic, ) { return net.minecraft.datafixer.fix.RemoveEmptyItemInSuspiciousBlockFix.shouldRemoveItem(dynamic); }
