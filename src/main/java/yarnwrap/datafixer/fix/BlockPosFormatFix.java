...
// public static java.util.List PATROL_TARGET_ENTITY_IDS() { return net.minecraft.datafixer.fix.BlockPosFormatFix.PATROL_TARGET_ENTITY_IDS; }
// public static void PATROL_TARGET_ENTITY_IDS(java.util.List value, ) { net.minecraft.datafixer.fix.BlockPosFormatFix.PATROL_TARGET_ENTITY_IDS = value; }
...
// public static com.mojang.datafixers.TypeRewriteRule createFixRule(Object typeReference,java.lang.String id,java.util.Map oldToNewKey, ) { return net.minecraft.datafixer.fix.BlockPosFormatFix.createFixRule(typeReference,id,oldToNewKey); }
...
// public static com.mojang.datafixers.Typed fixOldBlockPosFormat(com.mojang.datafixers.Typed oldToNewKey, ) { return net.minecraft.datafixer.fix.BlockPosFormatFix.fixOldBlockPosFormat(oldToNewKey); }
...
// public static com.mojang.serialization.Dynamic fixMapItemFrames(com.mojang.serialization.Dynamic dynamic, ) { return net.minecraft.datafixer.fix.BlockPosFormatFix.fixMapItemFrames(dynamic); }
// public void addEntityFixes(java.util.List rules) { wrapperContained.addEntityFixes(rules); }
// public static void addEntityFixes(java.util.List rules, ) { net.minecraft.datafixer.fix.BlockPosFormatFix.addEntityFixes(rules); }
...
// public static com.mojang.serialization.Dynamic method_56967(com.mojang.serialization.Dynamic banner, ) { return net.minecraft.datafixer.fix.BlockPosFormatFix.method_56967(banner); }
...
// public static com.mojang.serialization.Dynamic method_56968(com.mojang.serialization.Dynamic frames, ) { return net.minecraft.datafixer.fix.BlockPosFormatFix.method_56968(frames); }
...
// public static com.mojang.serialization.Dynamic method_56969(com.mojang.serialization.Dynamic frame, ) { return net.minecraft.datafixer.fix.BlockPosFormatFix.method_56969(frame); }
