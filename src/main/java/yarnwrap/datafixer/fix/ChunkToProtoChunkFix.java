...
// public static it.unimi.dsi.fastutil.shorts.ShortArrayList method_39941(int sectionY, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39941(sectionY); }
...
// public static com.mojang.serialization.Dynamic fixLevel(com.mojang.serialization.Dynamic levelDynamic, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.fixLevel(levelDynamic); }
...
// public static com.mojang.serialization.Dynamic method_39944(com.mojang.serialization.Dynamic packedLocalPos, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39944(packedLocalPos); }
...
// public static com.mojang.serialization.Dynamic method_39945(com.mojang.serialization.Dynamic biomesDynamic, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39945(biomesDynamic); }
...
// public static com.mojang.serialization.Dynamic method_39946(com.mojang.serialization.Dynamic section, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39946(section); }
...
// public static com.mojang.serialization.Dynamic method_39947(com.mojang.serialization.Dynamic biomes, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39947(biomes); }
...
// public static com.mojang.serialization.Dynamic method_39948(com.mojang.serialization.Dynamic tileTicksDynamic, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39948(tileTicksDynamic); }
// public void method_39949(java.util.List tickTag) { wrapperContained.method_39949(tickTag); }
// public static void method_39949(java.util.List tickTag, ) { net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39949(tickTag); }
...
// public static com.mojang.serialization.Dynamic fixBiomes(com.mojang.serialization.Dynamic levelDynamic, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.fixBiomes(levelDynamic); }
...
// public static com.mojang.serialization.Dynamic fixTileTicks(com.mojang.serialization.Dynamic levelDynamic, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.fixTileTicks(levelDynamic); }
...
// public static com.mojang.serialization.Dynamic method_39954(com.mojang.serialization.Dynamic chunkDynamic, ) { return net.minecraft.datafixer.fix.ChunkToProtoChunkFix.method_39954(chunkDynamic); }
