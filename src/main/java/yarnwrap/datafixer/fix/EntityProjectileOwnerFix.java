...
// public static int[] makeUuidArray(long most,long least, ) { return net.minecraft.datafixer.fix.EntityProjectileOwnerFix.makeUuidArray(most,least); }
...
// public static com.mojang.serialization.Dynamic moveFlatOwnerMostLeastToArray(com.mojang.serialization.Dynamic entityDynamic, ) { return net.minecraft.datafixer.fix.EntityProjectileOwnerFix.moveFlatOwnerMostLeastToArray(entityDynamic); }
...
// public static com.mojang.serialization.Dynamic insertOwnerUuidArray(com.mojang.serialization.Dynamic entityDynamic,long most,long least, ) { return net.minecraft.datafixer.fix.EntityProjectileOwnerFix.insertOwnerUuidArray(entityDynamic,most,least); }
...
// public static com.mojang.datafixers.Typed fixEntities(com.mojang.datafixers.Typed entityTyped, ) { return net.minecraft.datafixer.fix.EntityProjectileOwnerFix.fixEntities(entityTyped); }
