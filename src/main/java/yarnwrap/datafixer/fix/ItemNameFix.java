...
// public static java.lang.String name() { return net.minecraft.datafixer.fix.ItemNameFix.name; }
// public static void name(java.lang.String value, ) { net.minecraft.datafixer.fix.ItemNameFix.name = value; }
...
// public static com.mojang.datafixers.DataFix create(com.mojang.datafixers.schemas.Schema outputSchema,java.lang.String name,java.util.function.Function rename, ) { return net.minecraft.datafixer.fix.ItemNameFix.create(outputSchema,name,rename); }
// public java.lang.String rename(java.lang.String input) { return wrapperContained.rename(input); }
// public static java.lang.String rename(java.lang.String input, ) { return net.minecraft.datafixer.fix.ItemNameFix.rename(input); }
