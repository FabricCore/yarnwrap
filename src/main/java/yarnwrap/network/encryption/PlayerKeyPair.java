...
public boolean needsRefreshing() { return wrapperContained.needsRefreshing(); }
// public static boolean needsRefreshing() { return net.minecraft.network.encryption.PlayerKeyPair.needsRefreshing(); }
