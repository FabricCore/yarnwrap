...
// public static void onCookieRequest(yarnwrap.network.packet.s2c.common.CookieRequestS2CPacket packet, ) { net.minecraft.network.listener.ClientCookieRequestPacketListener.onCookieRequest(packet.wrapperContained); }
