...
// public static void onResponse(yarnwrap.network.packet.s2c.query.QueryResponseS2CPacket packet, ) { net.minecraft.network.listener.ClientQueryPacketListener.onResponse(packet.wrapperContained); }
