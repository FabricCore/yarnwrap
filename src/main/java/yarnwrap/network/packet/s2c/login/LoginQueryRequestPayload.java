...
// public static void write(yarnwrap.network.PacketByteBuf buf, ) { net.minecraft.network.packet.s2c.login.LoginQueryRequestPayload.write(buf.wrapperContained); }
