...
// public static yarnwrap.recipe.book.RecipeBookCategory category() { return new yarnwrap.recipe.book.RecipeBookCategory(net.minecraft.network.packet.c2s.play.RecipeCategoryOptionsC2SPacket.category); }
// public static void category(yarnwrap.recipe.book.RecipeBookCategory value, ) { net.minecraft.network.packet.c2s.play.RecipeCategoryOptionsC2SPacket.category = value.wrapperContained; }
...
// public static yarnwrap.recipe.book.RecipeBookCategory getCategory() { return new yarnwrap.recipe.book.RecipeBookCategory(net.minecraft.network.packet.c2s.play.RecipeCategoryOptionsC2SPacket.getCategory()); }
