...
// public static java.util.stream.Stream streamRegistryManagerEntries(yarnwrap.registry.CombinedDynamicRegistries combinedRegistries, ) { return net.minecraft.registry.SerializableRegistries.streamRegistryManagerEntries(combinedRegistries.wrapperContained); }
...
// public static java.util.stream.Stream stream(yarnwrap.registry.DynamicRegistryManager dynamicRegistryManager, ) { return net.minecraft.registry.SerializableRegistries.stream(dynamicRegistryManager.wrapperContained); }
...
// public static java.util.stream.Stream streamDynamicEntries(yarnwrap.registry.CombinedDynamicRegistries combinedRegistries, ) { return net.minecraft.registry.SerializableRegistries.streamDynamicEntries(combinedRegistries.wrapperContained); }
...
// public static void method_56595(yarnwrap.registry.Registry registryEntry, ) { net.minecraft.registry.SerializableRegistries.method_56595(registryEntry.wrapperContained); }
// public void method_56596(java.util.Set registry) { wrapperContained.method_56596(registry); }
// public static void method_56596(java.util.Set registry, ) { net.minecraft.registry.SerializableRegistries.method_56596(registry); }
...
// public static void serialize(com.mojang.serialization.DynamicOps nbtOps,Object entry,yarnwrap.registry.DynamicRegistryManager registryManager,java.util.Set knownPacks,java.util.function.BiConsumer callback, ) { net.minecraft.registry.SerializableRegistries.serialize(nbtOps,entry,registryManager.wrapperContained,knownPacks,callback); }
...
// public static void forEachSyncedRegistry(com.mojang.serialization.DynamicOps nbtOps,yarnwrap.registry.DynamicRegistryManager registryManager,java.util.Set knownPacks,java.util.function.BiConsumer callback, ) { net.minecraft.registry.SerializableRegistries.forEachSyncedRegistry(nbtOps,registryManager.wrapperContained,knownPacks,callback); }
// public void method_56599(com.mojang.serialization.DynamicOps registry) { wrapperContained.method_56599(registry); }
// public static void method_56599(com.mojang.serialization.DynamicOps registry, ) { net.minecraft.registry.SerializableRegistries.method_56599(registry); }
