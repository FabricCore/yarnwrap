...
// public static yarnwrap.state.property.DirectionProperty of(java.lang.String name,java.util.Collection values, ) { return new yarnwrap.state.property.DirectionProperty(net.minecraft.state.property.DirectionProperty.of(name,values)); }
...
// public static yarnwrap.state.property.DirectionProperty of(java.lang.String name,java.util.function.Predicate filter, ) { return new yarnwrap.state.property.DirectionProperty(net.minecraft.state.property.DirectionProperty.of(name,filter)); }
...
// public static yarnwrap.state.property.DirectionProperty of(java.lang.String name,net.minecraft.util.math.Direction[] values, ) { return new yarnwrap.state.property.DirectionProperty(net.minecraft.state.property.DirectionProperty.of(name,values)); }
...
// public static yarnwrap.state.property.DirectionProperty of(java.lang.String name, ) { return new yarnwrap.state.property.DirectionProperty(net.minecraft.state.property.DirectionProperty.of(name)); }
...
// public static boolean method_38862(yarnwrap.util.math.Direction direction, ) { return net.minecraft.state.property.DirectionProperty.method_38862(direction.wrapperContained); }
