...
// // public static Object properties() { return net.minecraft.command.argument.serialize.ConstantArgumentSerializer.properties; }
// // public static void properties(Object value, ) { net.minecraft.command.argument.serialize.ConstantArgumentSerializer.properties = value; }
...
// public static yarnwrap.command.argument.serialize.ConstantArgumentSerializer of(java.util.function.Function typeSupplier, ) { return new yarnwrap.command.argument.serialize.ConstantArgumentSerializer(net.minecraft.command.argument.serialize.ConstantArgumentSerializer.of(typeSupplier)); }
...
// public static yarnwrap.command.argument.serialize.ConstantArgumentSerializer of(java.util.function.Supplier typeSupplier, ) { return new yarnwrap.command.argument.serialize.ConstantArgumentSerializer(net.minecraft.command.argument.serialize.ConstantArgumentSerializer.of(typeSupplier)); }
...
// public static com.mojang.brigadier.arguments.ArgumentType method_42000(java.util.function.Supplier commandRegistryAccess, ) { return net.minecraft.command.argument.serialize.ConstantArgumentSerializer.method_42000(commandRegistryAccess); }
