...
// public static org.slf4j.Logger LOGGER() { return net.minecraft.command.argument.ArgumentHelper.LOGGER; }
// public static void LOGGER(org.slf4j.Logger value, ) { net.minecraft.command.argument.ArgumentHelper.LOGGER = value; }

// public byte MIN_FLAG() { return wrapperContained.MIN_FLAG; }
// public void MIN_FLAG(byte value) { wrapperContained.MIN_FLAG = value; }
// public static byte MIN_FLAG() { return net.minecraft.command.argument.ArgumentHelper.MIN_FLAG; }
// public static void MIN_FLAG(byte value, ) { net.minecraft.command.argument.ArgumentHelper.MIN_FLAG = value; }

// public byte MAX_FLAG() { return wrapperContained.MAX_FLAG; }
// public void MAX_FLAG(byte value) { wrapperContained.MAX_FLAG = value; }
// public static byte MAX_FLAG() { return net.minecraft.command.argument.ArgumentHelper.MAX_FLAG; }
// public static void MAX_FLAG(byte value, ) { net.minecraft.command.argument.ArgumentHelper.MAX_FLAG = value; }
...
// public static void collectUsedArgumentTypes(com.mojang.brigadier.tree.CommandNode node,java.util.Set usedArgumentTypes,java.util.Set visitedNodes, ) { net.minecraft.command.argument.ArgumentHelper.collectUsedArgumentTypes(node,usedArgumentTypes,visitedNodes); }
// public void method_41993(java.util.Set child) { wrapperContained.method_41993(child); }
// public static void method_41993(java.util.Set child, ) { net.minecraft.command.argument.ArgumentHelper.method_41993(child); }
