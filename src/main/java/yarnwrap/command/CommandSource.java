...
// public com.google.common.base.CharMatcher SUGGESTION_MATCH_PREFIX() { return wrapperContained.SUGGESTION_MATCH_PREFIX; }
// public void SUGGESTION_MATCH_PREFIX(com.google.common.base.CharMatcher value) { wrapperContained.SUGGESTION_MATCH_PREFIX = value; }
public static com.google.common.base.CharMatcher SUGGESTION_MATCH_PREFIX() { return net.minecraft.command.CommandSource.SUGGESTION_MATCH_PREFIX; }
// public static void SUGGESTION_MATCH_PREFIX(com.google.common.base.CharMatcher value, ) { net.minecraft.command.CommandSource.SUGGESTION_MATCH_PREFIX = value; }
...
// public void suggestIdentifiers(yarnwrap.registry.RegistryWrapper registry,Object suggestedIdType,com.mojang.brigadier.suggestion.SuggestionsBuilder builder) { wrapperContained.suggestIdentifiers(registry.wrapperContained,suggestedIdType,builder); }
// public static void suggestIdentifiers(yarnwrap.registry.RegistryWrapper registry,Object suggestedIdType,com.mojang.brigadier.suggestion.SuggestionsBuilder builder, ) { net.minecraft.command.CommandSource.suggestIdentifiers(registry.wrapperContained,suggestedIdType,builder); }
...
// public java.util.concurrent.CompletableFuture listSuggestions(com.mojang.brigadier.context.CommandContext context,com.mojang.brigadier.suggestion.SuggestionsBuilder builder,yarnwrap.registry.RegistryKey registryRef,Object suggestedIdType) { return wrapperContained.listSuggestions(context,builder,registryRef.wrapperContained,suggestedIdType); }
// public static java.util.concurrent.CompletableFuture listSuggestions(com.mojang.brigadier.context.CommandContext context,com.mojang.brigadier.suggestion.SuggestionsBuilder builder,yarnwrap.registry.RegistryKey registryRef,Object suggestedIdType, ) { return net.minecraft.command.CommandSource.listSuggestions(context,builder,registryRef.wrapperContained,suggestedIdType); }
