...
// public static void execute(java.lang.Object baseSource,java.util.List sources,com.mojang.brigadier.context.ContextChain contextChain,yarnwrap.command.ExecutionFlags flags,yarnwrap.command.ExecutionControl control, ) { net.minecraft.command.Forkable.execute(baseSource,sources,contextChain,flags.wrapperContained,control.wrapperContained); }
