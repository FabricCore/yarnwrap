...
// public static yarnwrap.command.MacroInvocation parse(java.lang.String command,int lineNumber, ) { return new yarnwrap.command.MacroInvocation(net.minecraft.command.MacroInvocation.parse(command,lineNumber)); }
