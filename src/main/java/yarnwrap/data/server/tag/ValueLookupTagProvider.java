...
// public static java.util.function.Function valueToKey() { return net.minecraft.data.server.tag.ValueLookupTagProvider.valueToKey; }
// public static void valueToKey(java.util.function.Function value, ) { net.minecraft.data.server.tag.ValueLookupTagProvider.valueToKey = value; }
