...
// public static float experience() { return net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.experience; }
// public static void experience(float value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.experience = value; }
...
// public static int cookingTime() { return net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.cookingTime; }
// public static void cookingTime(int value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.cookingTime = value; }
...
// public static yarnwrap.item.Item output() { return new yarnwrap.item.Item(net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.output); }
// public static void output(yarnwrap.item.Item value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.output = value.wrapperContained; }
...
// public static yarnwrap.recipe.Ingredient input() { return new yarnwrap.recipe.Ingredient(net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.input); }
// public static void input(yarnwrap.recipe.Ingredient value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.input = value.wrapperContained; }
...
// public static java.lang.String group() { return net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.group; }
// public static void group(java.lang.String value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.group = value; }
...
// public static yarnwrap.recipe.book.RecipeCategory category() { return new yarnwrap.recipe.book.RecipeCategory(net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.category); }
// public static void category(yarnwrap.recipe.book.RecipeCategory value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.category = value.wrapperContained; }
...
// public static yarnwrap.recipe.book.CookingRecipeCategory cookingCategory() { return new yarnwrap.recipe.book.CookingRecipeCategory(net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.cookingCategory); }
// public static void cookingCategory(yarnwrap.recipe.book.CookingRecipeCategory value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.cookingCategory = value.wrapperContained; }
...
// public static java.util.Map criteria() { return net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.criteria; }
// public static void criteria(java.util.Map value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.criteria = value; }
...
// // public static Object recipeFactory() { return net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.recipeFactory; }
// // public static void recipeFactory(Object value, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.recipeFactory = value; }
...
// public static void validate(yarnwrap.util.Identifier recipeId, ) { net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.validate(recipeId.wrapperContained); }
...
// public static yarnwrap.recipe.book.CookingRecipeCategory getCookingRecipeCategory(yarnwrap.recipe.RecipeSerializer serializer,yarnwrap.item.ItemConvertible output, ) { return new yarnwrap.recipe.book.CookingRecipeCategory(net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.getCookingRecipeCategory(serializer.wrapperContained,output.wrapperContained)); }
...
// public static yarnwrap.recipe.book.CookingRecipeCategory getSmeltingRecipeCategory(yarnwrap.item.ItemConvertible output, ) { return new yarnwrap.recipe.book.CookingRecipeCategory(net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.getSmeltingRecipeCategory(output.wrapperContained)); }
...
// public static yarnwrap.recipe.book.CookingRecipeCategory getBlastingRecipeCategory(yarnwrap.item.ItemConvertible output, ) { return new yarnwrap.recipe.book.CookingRecipeCategory(net.minecraft.data.server.recipe.CookingRecipeJsonBuilder.getBlastingRecipeCategory(output.wrapperContained)); }
