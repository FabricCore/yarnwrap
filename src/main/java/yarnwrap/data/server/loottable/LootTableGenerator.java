...
// public static void accept(java.util.function.BiConsumer lootTableBiConsumer, ) { net.minecraft.data.server.loottable.LootTableGenerator.accept(lootTableBiConsumer); }
