...
// public static yarnwrap.data.server.loottable.LootTableProvider createTradeRebalanceProvider(yarnwrap.data.DataOutput output,java.util.concurrent.CompletableFuture registryLookupFuture, ) { return new yarnwrap.data.server.loottable.LootTableProvider(net.minecraft.data.server.loottable.rebalance.TradeRebalanceLootTableProviders.createTradeRebalanceProvider(output.wrapperContained,registryLookupFuture)); }
