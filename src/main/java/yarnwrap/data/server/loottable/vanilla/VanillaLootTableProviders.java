...
// public static yarnwrap.data.server.loottable.LootTableProvider createVanillaProvider(yarnwrap.data.DataOutput output,java.util.concurrent.CompletableFuture registryLookupFuture, ) { return new yarnwrap.data.server.loottable.LootTableProvider(net.minecraft.data.server.loottable.vanilla.VanillaLootTableProviders.createVanillaProvider(output.wrapperContained,registryLookupFuture)); }
