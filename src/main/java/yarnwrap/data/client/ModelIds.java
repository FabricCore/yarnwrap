...
// public static yarnwrap.util.Identifier getItemModelId(yarnwrap.item.Item item, ) { return new yarnwrap.util.Identifier(net.minecraft.data.client.ModelIds.getItemModelId(item.wrapperContained)); }
...
// public static yarnwrap.util.Identifier getItemSubModelId(yarnwrap.item.Item item,java.lang.String suffix, ) { return new yarnwrap.util.Identifier(net.minecraft.data.client.ModelIds.getItemSubModelId(item.wrapperContained,suffix)); }
...
// public static yarnwrap.util.Identifier getBlockModelId(yarnwrap.block.Block block, ) { return new yarnwrap.util.Identifier(net.minecraft.data.client.ModelIds.getBlockModelId(block.wrapperContained)); }
...
// public static yarnwrap.util.Identifier getBlockSubModelId(yarnwrap.block.Block block,java.lang.String suffix, ) { return new yarnwrap.util.Identifier(net.minecraft.data.client.ModelIds.getBlockSubModelId(block.wrapperContained,suffix)); }
...
// public static yarnwrap.util.Identifier getMinecraftNamespacedBlock(java.lang.String name, ) { return new yarnwrap.util.Identifier(net.minecraft.data.client.ModelIds.getMinecraftNamespacedBlock(name)); }
...
// public static yarnwrap.util.Identifier getMinecraftNamespacedItem(java.lang.String name, ) { return new yarnwrap.util.Identifier(net.minecraft.data.client.ModelIds.getMinecraftNamespacedItem(name)); }
// public java.lang.String method_46196(java.lang.String path) { return wrapperContained.method_46196(path); }
// public static java.lang.String method_46196(java.lang.String path, ) { return net.minecraft.data.client.ModelIds.method_46196(path); }
// public java.lang.String method_46197(java.lang.String path) { return wrapperContained.method_46197(path); }
// public static java.lang.String method_46197(java.lang.String path, ) { return net.minecraft.data.client.ModelIds.method_46197(path); }
