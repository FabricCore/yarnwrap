...
// public static java.util.concurrent.CompletableFuture registriesFuture() { return net.minecraft.data.report.BiomeParametersProvider.registriesFuture; }
// public static void registriesFuture(java.util.concurrent.CompletableFuture value, ) { net.minecraft.data.report.BiomeParametersProvider.registriesFuture = value; }
...
public BiomeParametersProvider(yarnwrap.data.DataOutput output,java.util.concurrent.CompletableFuture registriesFuture) { this.wrapperContained = new net.minecraft.data.report.BiomeParametersProvider(output.wrapperContained,registriesFuture); }
...
// public java.util.concurrent.CompletionStage method_46810(yarnwrap.data.DataWriter registries) { return wrapperContained.method_46810(registries.wrapperContained); }
// public static java.util.concurrent.CompletionStage method_46810(yarnwrap.data.DataWriter registries, ) { return net.minecraft.data.report.BiomeParametersProvider.method_46810(registries.wrapperContained); }
