...
// public static void updateState(yarnwrap.screen.ScreenHandler handler,yarnwrap.util.collection.DefaultedList stacks,yarnwrap.item.ItemStack cursorStack,int properties, ) { net.minecraft.screen.ScreenHandlerSyncHandler.updateState(handler.wrapperContained,stacks.wrapperContained,cursorStack.wrapperContained,properties); }
