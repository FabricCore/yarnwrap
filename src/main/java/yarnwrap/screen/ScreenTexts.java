...
public static yarnwrap.text.Text ON() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.ON); }
// public static void ON(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.ON = value.wrapperContained; }
...
public static yarnwrap.text.Text OFF() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.OFF); }
// public static void OFF(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.OFF = value.wrapperContained; }
...
public static yarnwrap.text.Text DONE() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.DONE); }
// public static void DONE(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.DONE = value.wrapperContained; }
...
public static yarnwrap.text.Text CANCEL() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.CANCEL); }
// public static void CANCEL(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.CANCEL = value.wrapperContained; }
...
public static yarnwrap.text.Text YES() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.YES); }
// public static void YES(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.YES = value.wrapperContained; }
...
public static yarnwrap.text.Text NO() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.NO); }
// public static void NO(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.NO = value.wrapperContained; }
...
public static yarnwrap.text.Text PROCEED() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.PROCEED); }
// public static void PROCEED(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.PROCEED = value.wrapperContained; }
...
public static yarnwrap.text.Text BACK() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.BACK); }
// public static void BACK(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.BACK = value.wrapperContained; }
...
public static yarnwrap.text.Text CONNECT_FAILED() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.CONNECT_FAILED); }
// public static void CONNECT_FAILED(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.CONNECT_FAILED = value.wrapperContained; }
...
public static yarnwrap.text.Text LINE_BREAK() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.LINE_BREAK); }
// public static void LINE_BREAK(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.LINE_BREAK = value.wrapperContained; }
...
public static yarnwrap.text.Text SENTENCE_SEPARATOR() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.SENTENCE_SEPARATOR); }
// public static void SENTENCE_SEPARATOR(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.SENTENCE_SEPARATOR = value.wrapperContained; }
...
public static yarnwrap.text.Text EMPTY() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.EMPTY); }
// public static void EMPTY(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.EMPTY = value.wrapperContained; }
...
public static yarnwrap.text.Text ELLIPSIS() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.ELLIPSIS); }
// public static void ELLIPSIS(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.ELLIPSIS = value.wrapperContained; }
...
public static yarnwrap.text.Text ACKNOWLEDGE() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.ACKNOWLEDGE); }
// public static void ACKNOWLEDGE(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.ACKNOWLEDGE = value.wrapperContained; }
...
public static yarnwrap.text.Text CONTINUE() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.CONTINUE); }
// public static void CONTINUE(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.CONTINUE = value.wrapperContained; }
...
public static yarnwrap.text.Text SPACE() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.SPACE); }
// public static void SPACE(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.SPACE = value.wrapperContained; }
...
public static yarnwrap.text.Text TO_TITLE() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.TO_TITLE); }
// public static void TO_TITLE(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.TO_TITLE = value.wrapperContained; }
...
public static yarnwrap.text.Text OK() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.OK); }
// public static void OK(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.OK = value.wrapperContained; }
...
public static yarnwrap.text.Text OPEN_LINK() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.OPEN_LINK); }
// public static void OPEN_LINK(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.OPEN_LINK = value.wrapperContained; }
...
public static yarnwrap.text.Text COPY_LINK_TO_CLIPBOARD() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.COPY_LINK_TO_CLIPBOARD); }
// public static void COPY_LINK_TO_CLIPBOARD(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.COPY_LINK_TO_CLIPBOARD = value.wrapperContained; }
...
public static yarnwrap.text.Text DISCONNECT() { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.DISCONNECT); }
// public static void DISCONNECT(yarnwrap.text.Text value, ) { net.minecraft.screen.ScreenTexts.DISCONNECT = value.wrapperContained; }
...
// public static yarnwrap.text.MutableText composeGenericOptionText(yarnwrap.text.Text text,yarnwrap.text.Text value, ) { return new yarnwrap.text.MutableText(net.minecraft.screen.ScreenTexts.composeGenericOptionText(text.wrapperContained,value.wrapperContained)); }
// public yarnwrap.text.Text onOrOff(boolean on) { return new yarnwrap.text.Text(wrapperContained.onOrOff(on)); }
// public static yarnwrap.text.Text onOrOff(boolean on, ) { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.onOrOff(on)); }
...
// public static yarnwrap.text.Text joinLines(java.util.Collection texts, ) { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.joinLines(texts)); }
...
// public static yarnwrap.text.Text joinLines(net.minecraft.text.Text[] texts, ) { return new yarnwrap.text.Text(net.minecraft.screen.ScreenTexts.joinLines(texts)); }
...
// public static yarnwrap.text.MutableText joinSentences(net.minecraft.text.Text[] sentences, ) { return new yarnwrap.text.MutableText(net.minecraft.screen.ScreenTexts.joinSentences(sentences)); }
// public yarnwrap.text.MutableText days(long days) { return new yarnwrap.text.MutableText(wrapperContained.days(days)); }
// public static yarnwrap.text.MutableText days(long days, ) { return new yarnwrap.text.MutableText(net.minecraft.screen.ScreenTexts.days(days)); }
// public yarnwrap.text.MutableText hours(long hours) { return new yarnwrap.text.MutableText(wrapperContained.hours(hours)); }
// public static yarnwrap.text.MutableText hours(long hours, ) { return new yarnwrap.text.MutableText(net.minecraft.screen.ScreenTexts.hours(hours)); }
