...
// public static yarnwrap.util.collection.DefaultedList previousTrackedStacks() { return new yarnwrap.util.collection.DefaultedList(net.minecraft.screen.ScreenHandler.previousTrackedStacks); }
// public static void previousTrackedStacks(yarnwrap.util.collection.DefaultedList value, ) { net.minecraft.screen.ScreenHandler.previousTrackedStacks = value.wrapperContained; }
...
// public static yarnwrap.item.ItemStack previousCursorStack() { return new yarnwrap.item.ItemStack(net.minecraft.screen.ScreenHandler.previousCursorStack); }
// public static void previousCursorStack(yarnwrap.item.ItemStack value, ) { net.minecraft.screen.ScreenHandler.previousCursorStack = value.wrapperContained; }
...
// public static void setPreviousTrackedSlot(int slot,yarnwrap.item.ItemStack stack, ) { net.minecraft.screen.ScreenHandler.setPreviousTrackedSlot(slot,stack.wrapperContained); }
...
// public static void setPreviousCursorStack(yarnwrap.item.ItemStack stack, ) { net.minecraft.screen.ScreenHandler.setPreviousCursorStack(stack.wrapperContained); }
...
// public static void setPreviousTrackedSlotMutable(int slot,yarnwrap.item.ItemStack stack, ) { net.minecraft.screen.ScreenHandler.setPreviousTrackedSlotMutable(slot,stack.wrapperContained); }
