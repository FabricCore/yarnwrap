...
// public yarnwrap.util.Identifier EMPTY_OFF_HAND_SLOT_TEXTURE() { return new yarnwrap.util.Identifier(wrapperContained.EMPTY_OFF_HAND_SLOT_TEXTURE); }
// public void EMPTY_OFF_HAND_SLOT_TEXTURE(yarnwrap.util.Identifier value) { wrapperContained.EMPTY_OFF_HAND_SLOT_TEXTURE = value.wrapperContained; }
public static yarnwrap.util.Identifier EMPTY_OFF_HAND_SLOT_TEXTURE() { return new yarnwrap.util.Identifier(net.minecraft.screen.PlayerScreenHandler.EMPTY_OFF_HAND_SLOT_TEXTURE); }
// public static void EMPTY_OFF_HAND_SLOT_TEXTURE(yarnwrap.util.Identifier value, ) { net.minecraft.screen.PlayerScreenHandler.EMPTY_OFF_HAND_SLOT_TEXTURE = value.wrapperContained; }
