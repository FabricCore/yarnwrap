...
// public yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding random(yarnwrap.registry.RegistryKey alias,yarnwrap.util.collection.Pool targets) { return new yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding(wrapperContained.random(alias.wrapperContained,targets.wrapperContained)); }
// public static yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding random(yarnwrap.registry.RegistryKey alias,yarnwrap.util.collection.Pool targets, ) { return new yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding(net.minecraft.structure.pool.alias.StructurePoolAliasBinding.random(alias.wrapperContained,targets.wrapperContained)); }
...
// public yarnwrap.structure.pool.alias.RandomGroupStructurePoolAliasBinding randomGroup(yarnwrap.util.collection.Pool groups) { return new yarnwrap.structure.pool.alias.RandomGroupStructurePoolAliasBinding(wrapperContained.randomGroup(groups.wrapperContained)); }
// public static yarnwrap.structure.pool.alias.RandomGroupStructurePoolAliasBinding randomGroup(yarnwrap.util.collection.Pool groups, ) { return new yarnwrap.structure.pool.alias.RandomGroupStructurePoolAliasBinding(net.minecraft.structure.pool.alias.StructurePoolAliasBinding.randomGroup(groups.wrapperContained)); }
// public yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding random(java.lang.String alias,yarnwrap.util.collection.Pool targets) { return new yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding(wrapperContained.random(alias,targets.wrapperContained)); }
// public static yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding random(java.lang.String alias,yarnwrap.util.collection.Pool targets, ) { return new yarnwrap.structure.pool.alias.RandomStructurePoolAliasBinding(net.minecraft.structure.pool.alias.StructurePoolAliasBinding.random(alias,targets.wrapperContained)); }
