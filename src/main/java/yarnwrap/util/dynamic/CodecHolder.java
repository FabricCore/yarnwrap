...
// public static yarnwrap.util.dynamic.CodecHolder of(com.mojang.serialization.MapCodec mapCodec, ) { return new yarnwrap.util.dynamic.CodecHolder(net.minecraft.util.dynamic.CodecHolder.of(mapCodec)); }
