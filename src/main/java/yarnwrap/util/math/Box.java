...
// public static yarnwrap.util.math.Vec3d getBottomCenter() { return new yarnwrap.util.math.Vec3d(net.minecraft.util.math.Box.getBottomCenter()); }
...
// public static java.util.Optional raycast(yarnwrap.util.math.Vec3d min,yarnwrap.util.math.Vec3d max, ) { return net.minecraft.util.math.Box.raycast(min.wrapperContained,max.wrapperContained); }
