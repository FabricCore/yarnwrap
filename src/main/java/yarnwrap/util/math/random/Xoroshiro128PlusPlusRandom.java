...
// public static float FLOAT_MULTIPLIER() { return net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.FLOAT_MULTIPLIER; }
// public static void FLOAT_MULTIPLIER(float value, ) { net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.FLOAT_MULTIPLIER = value; }
...
// public static double DOUBLE_MULTIPLIER() { return net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.DOUBLE_MULTIPLIER; }
// public static void DOUBLE_MULTIPLIER(double value, ) { net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.DOUBLE_MULTIPLIER = value; }
...
// public static yarnwrap.util.math.random.Xoroshiro128PlusPlusRandomImpl implementation() { return new yarnwrap.util.math.random.Xoroshiro128PlusPlusRandomImpl(net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.implementation); }
// public static void implementation(yarnwrap.util.math.random.Xoroshiro128PlusPlusRandomImpl value, ) { net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.implementation = value.wrapperContained; }
...
// public static yarnwrap.util.math.random.GaussianGenerator gaussianGenerator() { return new yarnwrap.util.math.random.GaussianGenerator(net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.gaussianGenerator); }
// public static void gaussianGenerator(yarnwrap.util.math.random.GaussianGenerator value, ) { net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.gaussianGenerator = value.wrapperContained; }

// public com.mojang.serialization.Codec CODEC() { return wrapperContained.CODEC; }
// public void CODEC(com.mojang.serialization.Codec value) { wrapperContained.CODEC = value; }
public static com.mojang.serialization.Codec CODEC() { return net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.CODEC; }
// public static void CODEC(com.mojang.serialization.Codec value, ) { net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.CODEC = value; }
...
// public static long next(int bits, ) { return net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.next(bits); }
...
// public static yarnwrap.util.math.random.Xoroshiro128PlusPlusRandom method_51860(yarnwrap.util.math.random.Xoroshiro128PlusPlusRandomImpl implementation, ) { return new yarnwrap.util.math.random.Xoroshiro128PlusPlusRandom(net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.method_51860(implementation.wrapperContained)); }
...
// public static yarnwrap.util.math.random.Xoroshiro128PlusPlusRandomImpl method_51861(yarnwrap.util.math.random.Xoroshiro128PlusPlusRandom random, ) { return new yarnwrap.util.math.random.Xoroshiro128PlusPlusRandomImpl(net.minecraft.util.math.random.Xoroshiro128PlusPlusRandom.method_51861(random.wrapperContained)); }
