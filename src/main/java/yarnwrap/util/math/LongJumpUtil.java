...
// public boolean isPathClear(yarnwrap.entity.mob.MobEntity entity,yarnwrap.entity.EntityDimensions dimensions,yarnwrap.util.math.Vec3d prevPos,yarnwrap.util.math.Vec3d nextPos) { return wrapperContained.isPathClear(entity.wrapperContained,dimensions.wrapperContained,prevPos.wrapperContained,nextPos.wrapperContained); }
// public static boolean isPathClear(yarnwrap.entity.mob.MobEntity entity,yarnwrap.entity.EntityDimensions dimensions,yarnwrap.util.math.Vec3d prevPos,yarnwrap.util.math.Vec3d nextPos, ) { return net.minecraft.util.math.LongJumpUtil.isPathClear(entity.wrapperContained,dimensions.wrapperContained,prevPos.wrapperContained,nextPos.wrapperContained); }
