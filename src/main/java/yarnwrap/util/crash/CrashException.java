...
// public static yarnwrap.util.crash.CrashReport report() { return new yarnwrap.util.crash.CrashReport(net.minecraft.util.crash.CrashException.report); }
// public static void report(yarnwrap.util.crash.CrashReport value, ) { net.minecraft.util.crash.CrashException.report = value.wrapperContained; }
...
// public static yarnwrap.util.crash.CrashReport getReport() { return new yarnwrap.util.crash.CrashReport(net.minecraft.util.crash.CrashException.getReport()); }
