...
// public yarnwrap.util.crash.CrashReportSection addBlockLocation(yarnwrap.util.crash.CrashReportSection element,yarnwrap.world.HeightLimitView world,yarnwrap.util.math.BlockPos pos) { return new yarnwrap.util.crash.CrashReportSection(wrapperContained.addBlockLocation(element.wrapperContained,world.wrapperContained,pos.wrapperContained)); }
// public static yarnwrap.util.crash.CrashReportSection addBlockLocation(yarnwrap.util.crash.CrashReportSection element,yarnwrap.world.HeightLimitView world,yarnwrap.util.math.BlockPos pos, ) { return new yarnwrap.util.crash.CrashReportSection(net.minecraft.util.crash.CrashReportSection.addBlockLocation(element.wrapperContained,world.wrapperContained,pos.wrapperContained)); }
