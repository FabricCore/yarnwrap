...
// public static void startTime(java.time.Instant value, ) { net.minecraft.util.profiling.jfr.JfrProfile.startTime = value; }
...
// public static java.time.Instant endTime() { return net.minecraft.util.profiling.jfr.JfrProfile.endTime; }
// public static void endTime(java.time.Instant value, ) { net.minecraft.util.profiling.jfr.JfrProfile.endTime = value; }
...
// public static java.time.Duration duration() { return net.minecraft.util.profiling.jfr.JfrProfile.duration; }
// public static void duration(java.time.Duration value, ) { net.minecraft.util.profiling.jfr.JfrProfile.duration = value; }
...
// public static java.time.Duration worldGenDuration() { return net.minecraft.util.profiling.jfr.JfrProfile.worldGenDuration; }
// public static void worldGenDuration(java.time.Duration value, ) { net.minecraft.util.profiling.jfr.JfrProfile.worldGenDuration = value; }
...
// public static java.util.List serverTickTimeSamples() { return net.minecraft.util.profiling.jfr.JfrProfile.serverTickTimeSamples; }
// public static void serverTickTimeSamples(java.util.List value, ) { net.minecraft.util.profiling.jfr.JfrProfile.serverTickTimeSamples = value; }
...
// public static void cpuLoadSamples(java.util.List value, ) { net.minecraft.util.profiling.jfr.JfrProfile.cpuLoadSamples = value; }
...
// public static java.util.List getChunkGenerationSampleStatistics() { return net.minecraft.util.profiling.jfr.JfrProfile.getChunkGenerationSampleStatistics(); }
// public java.time.Duration method_38007(com.mojang.datafixers.util.Pair pair) { return wrapperContained.method_38007(pair); }
// public static java.time.Duration method_38007(com.mojang.datafixers.util.Pair pair, ) { return net.minecraft.util.profiling.jfr.JfrProfile.method_38007(pair); }
// public com.mojang.datafixers.util.Pair method_38008(Object entry) { return wrapperContained.method_38008(entry); }
// public static com.mojang.datafixers.util.Pair method_38008(Object entry, ) { return net.minecraft.util.profiling.jfr.JfrProfile.method_38008(entry); }
public java.lang.String toJson() { return wrapperContained.toJson(); }
// public static java.lang.String toJson() { return net.minecraft.util.profiling.jfr.JfrProfile.toJson(); }
