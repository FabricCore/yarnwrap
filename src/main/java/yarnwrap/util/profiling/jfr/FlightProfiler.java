...
public yarnwrap.util.function.Finishable startStructureGenerationProfiling(yarnwrap.util.math.ChunkPos chunkPos,yarnwrap.registry.RegistryKey world,yarnwrap.registry.entry.RegistryEntry structure) { return new yarnwrap.util.function.Finishable(wrapperContained.startStructureGenerationProfiling(chunkPos.wrapperContained,world.wrapperContained,structure.wrapperContained)); }
// public static yarnwrap.util.function.Finishable startStructureGenerationProfiling(yarnwrap.util.math.ChunkPos chunkPos,yarnwrap.registry.RegistryKey world,yarnwrap.registry.entry.RegistryEntry structure, ) { return new yarnwrap.util.function.Finishable(net.minecraft.util.profiling.jfr.FlightProfiler.startStructureGenerationProfiling(chunkPos.wrapperContained,world.wrapperContained,structure.wrapperContained)); }
