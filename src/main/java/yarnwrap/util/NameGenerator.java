...
// public static java.lang.String[] PREFIX() { return net.minecraft.util.NameGenerator.PREFIX; }
// public static void PREFIX(java.lang.String[] value, ) { net.minecraft.util.NameGenerator.PREFIX = value; }
...
// public static java.lang.String[] SUFFIX() { return net.minecraft.util.NameGenerator.SUFFIX; }
// public static void SUFFIX(java.lang.String[] value, ) { net.minecraft.util.NameGenerator.SUFFIX = value; }
...
// public static java.lang.String getRandom(yarnwrap.util.math.random.Random random,java.lang.String[] options, ) { return net.minecraft.util.NameGenerator.getRandom(random.wrapperContained,options); }
// public java.lang.String name(java.util.UUID uuid) { return wrapperContained.name(uuid); }
// public static java.lang.String name(java.util.UUID uuid, ) { return net.minecraft.util.NameGenerator.name(uuid); }
...
// public static yarnwrap.util.math.random.Random randomFromUuid(java.util.UUID uuid, ) { return new yarnwrap.util.math.random.Random(net.minecraft.util.NameGenerator.randomFromUuid(uuid)); }
// public java.lang.String name(yarnwrap.entity.Entity entity) { return wrapperContained.name(entity.wrapperContained); }
// public static java.lang.String name(yarnwrap.entity.Entity entity, ) { return net.minecraft.util.NameGenerator.name(entity.wrapperContained); }
