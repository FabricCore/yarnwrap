...
// public static it.unimi.dsi.fastutil.doubles.DoubleList xPoints() { return net.minecraft.util.shape.ArrayVoxelShape.xPoints; }
// public static void xPoints(it.unimi.dsi.fastutil.doubles.DoubleList value, ) { net.minecraft.util.shape.ArrayVoxelShape.xPoints = value; }
...
// public static it.unimi.dsi.fastutil.doubles.DoubleList yPoints() { return net.minecraft.util.shape.ArrayVoxelShape.yPoints; }
// public static void yPoints(it.unimi.dsi.fastutil.doubles.DoubleList value, ) { net.minecraft.util.shape.ArrayVoxelShape.yPoints = value; }
