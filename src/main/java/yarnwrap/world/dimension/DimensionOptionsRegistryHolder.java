...
// public java.util.Map createRegistry(yarnwrap.registry.RegistryWrapper dimensionTypeRegistry,java.util.Map dimensionOptions,yarnwrap.world.gen.chunk.ChunkGenerator chunkGenerator) { return wrapperContained.createRegistry(dimensionTypeRegistry.wrapperContained,dimensionOptions,chunkGenerator.wrapperContained); }
// public static java.util.Map createRegistry(yarnwrap.registry.RegistryWrapper dimensionTypeRegistry,java.util.Map dimensionOptions,yarnwrap.world.gen.chunk.ChunkGenerator chunkGenerator, ) { return net.minecraft.world.dimension.DimensionOptionsRegistryHolder.createRegistry(dimensionTypeRegistry.wrapperContained,dimensionOptions,chunkGenerator.wrapperContained); }
...
// public yarnwrap.world.dimension.DimensionOptionsRegistryHolder with(Object registries,yarnwrap.world.gen.chunk.ChunkGenerator chunkGenerator) { return new yarnwrap.world.dimension.DimensionOptionsRegistryHolder(wrapperContained.with(registries,chunkGenerator.wrapperContained)); }
// public static yarnwrap.world.dimension.DimensionOptionsRegistryHolder with(Object registries,yarnwrap.world.gen.chunk.ChunkGenerator chunkGenerator, ) { return new yarnwrap.world.dimension.DimensionOptionsRegistryHolder(net.minecraft.world.dimension.DimensionOptionsRegistryHolder.with(registries,chunkGenerator.wrapperContained)); }
