...
// public static yarnwrap.registry.RegistryKey of(java.lang.String id, ) { return new yarnwrap.registry.RegistryKey(net.minecraft.world.biome.source.MultiNoiseBiomeSourceParameterLists.of(id)); }
// public void bootstrap(yarnwrap.registry.Registerable registry) { wrapperContained.bootstrap(registry.wrapperContained); }
// public static void bootstrap(yarnwrap.registry.Registerable registry, ) { net.minecraft.world.biome.source.MultiNoiseBiomeSourceParameterLists.bootstrap(registry.wrapperContained); }
