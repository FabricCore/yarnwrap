...
// public static int getColor(yarnwrap.world.biome.Biome biome,double x,double z, ) { return net.minecraft.world.biome.ColorResolver.getColor(biome.wrapperContained,x,z); }
