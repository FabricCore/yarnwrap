...
// public static int spawn(yarnwrap.server.world.ServerWorld world,boolean spawnMonsters,boolean spawnAnimals, ) { return net.minecraft.world.spawner.SpecialSpawner.spawn(world.wrapperContained,spawnMonsters,spawnAnimals); }
