...
// public static boolean needsFluidTick() { return net.minecraft.world.gen.chunk.AquiferSampler.needsFluidTick(); }
...
// public static yarnwrap.world.gen.chunk.AquiferSampler seaLevel(Object fluidLevelSampler, ) { return new yarnwrap.world.gen.chunk.AquiferSampler(net.minecraft.world.gen.chunk.AquiferSampler.seaLevel(fluidLevelSampler)); }
...
// public static yarnwrap.world.gen.chunk.AquiferSampler aquifer(yarnwrap.world.gen.chunk.ChunkNoiseSampler chunkNoiseSampler,yarnwrap.util.math.ChunkPos chunkPos,yarnwrap.world.gen.noise.NoiseRouter noiseRouter,yarnwrap.util.math.random.RandomSplitter randomSplitter,int minimumY,int height,Object fluidLevelSampler, ) { return new yarnwrap.world.gen.chunk.AquiferSampler(net.minecraft.world.gen.chunk.AquiferSampler.aquifer(chunkNoiseSampler.wrapperContained,chunkPos.wrapperContained,noiseRouter.wrapperContained,randomSplitter.wrapperContained,minimumY,height,fluidLevelSampler)); }
...
// public static yarnwrap.block.BlockState apply(Object pos,double density, ) { return new yarnwrap.block.BlockState(net.minecraft.world.gen.chunk.AquiferSampler.apply(pos,density)); }
