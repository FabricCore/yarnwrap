...
// public static void bootstrap(yarnwrap.registry.Registerable structureRegisterable, ) { net.minecraft.world.gen.structure.Structures.bootstrap(structureRegisterable.wrapperContained); }
...
// public static yarnwrap.world.StructureSpawns method_46847(yarnwrap.entity.SpawnGroup spawnGroup, ) { return new yarnwrap.world.StructureSpawns(net.minecraft.world.gen.structure.Structures.method_46847(spawnGroup.wrapperContained)); }
...
// public static yarnwrap.entity.SpawnGroup method_46848(yarnwrap.entity.SpawnGroup spawnGroup, ) { return new yarnwrap.entity.SpawnGroup(net.minecraft.world.gen.structure.Structures.method_46848(spawnGroup.wrapperContained)); }
...
// public static yarnwrap.world.StructureSpawns method_60421(yarnwrap.entity.SpawnGroup spawnGroup, ) { return new yarnwrap.world.StructureSpawns(net.minecraft.world.gen.structure.Structures.method_60421(spawnGroup.wrapperContained)); }
...
// public static yarnwrap.entity.SpawnGroup method_60422(yarnwrap.entity.SpawnGroup spawnGroup, ) { return new yarnwrap.entity.SpawnGroup(net.minecraft.world.gen.structure.Structures.method_60422(spawnGroup.wrapperContained)); }
