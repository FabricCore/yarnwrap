...
public static com.mojang.serialization.MapCodec CODEC() { return net.minecraft.world.gen.structure.JigsawStructure.CODEC; }
// public static void CODEC(com.mojang.serialization.MapCodec value, ) { net.minecraft.world.gen.structure.JigsawStructure.CODEC = value; }
...
// public static yarnwrap.registry.entry.RegistryEntry startPool() { return new yarnwrap.registry.entry.RegistryEntry(net.minecraft.world.gen.structure.JigsawStructure.startPool); }
// public static void startPool(yarnwrap.registry.entry.RegistryEntry value, ) { net.minecraft.world.gen.structure.JigsawStructure.startPool = value.wrapperContained; }

// public int size() { return wrapperContained.size; }
// public void size(int value) { wrapperContained.size = value; }
// public static int size() { return net.minecraft.world.gen.structure.JigsawStructure.size; }
// public static void size(int value, ) { net.minecraft.world.gen.structure.JigsawStructure.size = value; }
...
// public static yarnwrap.world.gen.heightprovider.HeightProvider startHeight() { return new yarnwrap.world.gen.heightprovider.HeightProvider(net.minecraft.world.gen.structure.JigsawStructure.startHeight); }
// public static void startHeight(yarnwrap.world.gen.heightprovider.HeightProvider value, ) { net.minecraft.world.gen.structure.JigsawStructure.startHeight = value.wrapperContained; }
...
// public static boolean useExpansionHack() { return net.minecraft.world.gen.structure.JigsawStructure.useExpansionHack; }
// public static void useExpansionHack(boolean value, ) { net.minecraft.world.gen.structure.JigsawStructure.useExpansionHack = value; }
...
// public static java.util.Optional projectStartToHeightmap() { return net.minecraft.world.gen.structure.JigsawStructure.projectStartToHeightmap; }
// public static void projectStartToHeightmap(java.util.Optional value, ) { net.minecraft.world.gen.structure.JigsawStructure.projectStartToHeightmap = value; }
...
// public static int maxDistanceFromCenter() { return net.minecraft.world.gen.structure.JigsawStructure.maxDistanceFromCenter; }
// public static void maxDistanceFromCenter(int value, ) { net.minecraft.world.gen.structure.JigsawStructure.maxDistanceFromCenter = value; }

// public int MAX_SIZE() { return wrapperContained.MAX_SIZE; }
// public void MAX_SIZE(int value) { wrapperContained.MAX_SIZE = value; }
public static int MAX_SIZE() { return net.minecraft.world.gen.structure.JigsawStructure.MAX_SIZE; }
// public static void MAX_SIZE(int value, ) { net.minecraft.world.gen.structure.JigsawStructure.MAX_SIZE = value; }
...
// public static java.util.Optional startJigsawName() { return net.minecraft.world.gen.structure.JigsawStructure.startJigsawName; }
// public static void startJigsawName(java.util.Optional value, ) { net.minecraft.world.gen.structure.JigsawStructure.startJigsawName = value; }
...
// public static java.util.List poolAliasBindings() { return net.minecraft.world.gen.structure.JigsawStructure.poolAliasBindings; }
// public static void poolAliasBindings(java.util.List value, ) { net.minecraft.world.gen.structure.JigsawStructure.poolAliasBindings = value; }
...
public static int MAX_GENERATION_DEPTH() { return net.minecraft.world.gen.structure.JigsawStructure.MAX_GENERATION_DEPTH; }
// public static void MAX_GENERATION_DEPTH(int value, ) { net.minecraft.world.gen.structure.JigsawStructure.MAX_GENERATION_DEPTH = value; }
...
public static yarnwrap.world.gen.structure.DimensionPadding DEFAULT_DIMENSION_PADDING() { return new yarnwrap.world.gen.structure.DimensionPadding(net.minecraft.world.gen.structure.JigsawStructure.DEFAULT_DIMENSION_PADDING); }
// public static void DEFAULT_DIMENSION_PADDING(yarnwrap.world.gen.structure.DimensionPadding value, ) { net.minecraft.world.gen.structure.JigsawStructure.DEFAULT_DIMENSION_PADDING = value.wrapperContained; }
...
// public static yarnwrap.world.gen.structure.DimensionPadding dimensionPadding() { return new yarnwrap.world.gen.structure.DimensionPadding(net.minecraft.world.gen.structure.JigsawStructure.dimensionPadding); }
// public static void dimensionPadding(yarnwrap.world.gen.structure.DimensionPadding value, ) { net.minecraft.world.gen.structure.JigsawStructure.dimensionPadding = value.wrapperContained; }
...
public static yarnwrap.structure.StructureLiquidSettings DEFAULT_LIQUID_SETTINGS() { return new yarnwrap.structure.StructureLiquidSettings(net.minecraft.world.gen.structure.JigsawStructure.DEFAULT_LIQUID_SETTINGS); }
// public static void DEFAULT_LIQUID_SETTINGS(yarnwrap.structure.StructureLiquidSettings value, ) { net.minecraft.world.gen.structure.JigsawStructure.DEFAULT_LIQUID_SETTINGS = value.wrapperContained; }
...
// public static yarnwrap.structure.StructureLiquidSettings liquidSettings() { return new yarnwrap.structure.StructureLiquidSettings(net.minecraft.world.gen.structure.JigsawStructure.liquidSettings); }
// public static void liquidSettings(yarnwrap.structure.StructureLiquidSettings value, ) { net.minecraft.world.gen.structure.JigsawStructure.liquidSettings = value.wrapperContained; }
...
// public static com.mojang.datafixers.kinds.App method_41662(Object instance, ) { return net.minecraft.world.gen.structure.JigsawStructure.method_41662(instance); }
...
// public static java.lang.Integer method_42704(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return net.minecraft.world.gen.structure.JigsawStructure.method_42704(structure.wrapperContained); }
...
// public static java.util.Optional method_42705(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return net.minecraft.world.gen.structure.JigsawStructure.method_42705(structure.wrapperContained); }
...
// public static java.lang.Boolean method_42706(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return net.minecraft.world.gen.structure.JigsawStructure.method_42706(structure.wrapperContained); }
...
// public static yarnwrap.world.gen.heightprovider.HeightProvider method_42707(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return new yarnwrap.world.gen.heightprovider.HeightProvider(net.minecraft.world.gen.structure.JigsawStructure.method_42707(structure.wrapperContained)); }
...
// public static com.mojang.serialization.DataResult validate(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return net.minecraft.world.gen.structure.JigsawStructure.validate(structure.wrapperContained); }
...
// public static java.lang.Integer method_42709(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return net.minecraft.world.gen.structure.JigsawStructure.method_42709(structure.wrapperContained); }
...
// public static yarnwrap.registry.entry.RegistryEntry method_42710(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return new yarnwrap.registry.entry.RegistryEntry(net.minecraft.world.gen.structure.JigsawStructure.method_42710(structure.wrapperContained)); }
...
// public static java.util.Optional method_43567(yarnwrap.world.gen.structure.JigsawStructure structure, ) { return net.minecraft.world.gen.structure.JigsawStructure.method_43567(structure.wrapperContained); }
