...
public yarnwrap.structure.StructureStart createStructureStart(yarnwrap.registry.entry.RegistryEntry structure,yarnwrap.registry.RegistryKey dimension,yarnwrap.registry.DynamicRegistryManager dynamicRegistryManager,yarnwrap.world.gen.chunk.ChunkGenerator chunkGenerator,yarnwrap.world.biome.source.BiomeSource biomeSource,yarnwrap.world.gen.noise.NoiseConfig noiseConfig,yarnwrap.structure.StructureTemplateManager structureTemplateManager,long seed,yarnwrap.util.math.ChunkPos chunkPos,int references,yarnwrap.world.HeightLimitView world,java.util.function.Predicate validBiomes) { return new yarnwrap.structure.StructureStart(wrapperContained.createStructureStart(structure.wrapperContained,dimension.wrapperContained,dynamicRegistryManager.wrapperContained,chunkGenerator.wrapperContained,biomeSource.wrapperContained,noiseConfig.wrapperContained,structureTemplateManager.wrapperContained,seed,chunkPos.wrapperContained,references,world.wrapperContained,validBiomes)); }
// public static yarnwrap.structure.StructureStart createStructureStart(yarnwrap.registry.entry.RegistryEntry structure,yarnwrap.registry.RegistryKey dimension,yarnwrap.registry.DynamicRegistryManager dynamicRegistryManager,yarnwrap.world.gen.chunk.ChunkGenerator chunkGenerator,yarnwrap.world.biome.source.BiomeSource biomeSource,yarnwrap.world.gen.noise.NoiseConfig noiseConfig,yarnwrap.structure.StructureTemplateManager structureTemplateManager,long seed,yarnwrap.util.math.ChunkPos chunkPos,int references,yarnwrap.world.HeightLimitView world,java.util.function.Predicate validBiomes, ) { return new yarnwrap.structure.StructureStart(net.minecraft.world.gen.structure.Structure.createStructureStart(structure.wrapperContained,dimension.wrapperContained,dynamicRegistryManager.wrapperContained,chunkGenerator.wrapperContained,biomeSource.wrapperContained,noiseConfig.wrapperContained,structureTemplateManager.wrapperContained,seed,chunkPos.wrapperContained,references,world.wrapperContained,validBiomes)); }
