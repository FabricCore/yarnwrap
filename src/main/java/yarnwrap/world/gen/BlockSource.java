...
// public static yarnwrap.block.BlockState apply(yarnwrap.world.gen.chunk.ChunkNoiseSampler sampler,int x,int y,int z, ) { return new yarnwrap.block.BlockState(net.minecraft.world.gen.BlockSource.apply(sampler.wrapperContained,x,y,z)); }
