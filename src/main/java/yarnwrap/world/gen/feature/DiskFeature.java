...
// public static boolean placeBlock(yarnwrap.world.gen.feature.DiskFeatureConfig config,yarnwrap.world.StructureWorldAccess world,yarnwrap.util.math.random.Random random,int topY,int bottomY,Object pos, ) { return net.minecraft.world.gen.feature.DiskFeature.placeBlock(config.wrapperContained,world.wrapperContained,random.wrapperContained,topY,bottomY,pos); }
