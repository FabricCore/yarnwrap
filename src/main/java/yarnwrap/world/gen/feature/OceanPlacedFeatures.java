...
public static yarnwrap.registry.RegistryKey SEAGRASS_WARM() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_WARM); }
// public static void SEAGRASS_WARM(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_WARM = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey SEAGRASS_NORMAL() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_NORMAL); }
// public static void SEAGRASS_NORMAL(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_NORMAL = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey SEAGRASS_COLD() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_COLD); }
// public static void SEAGRASS_COLD(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_COLD = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey SEAGRASS_RIVER() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_RIVER); }
// public static void SEAGRASS_RIVER(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_RIVER = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey SEAGRASS_SWAMP() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_SWAMP); }
// public static void SEAGRASS_SWAMP(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_SWAMP = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey SEAGRASS_DEEP_WARM() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_DEEP_WARM); }
// public static void SEAGRASS_DEEP_WARM(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_DEEP_WARM = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey SEAGRASS_DEEP() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_DEEP); }
// public static void SEAGRASS_DEEP(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEAGRASS_DEEP = value.wrapperContained; }
...
// public static void SEA_PICKLE(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.SEA_PICKLE = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey KELP_COLD() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.KELP_COLD); }
// public static void KELP_COLD(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.KELP_COLD = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey KELP_WARM() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.KELP_WARM); }
// public static void KELP_WARM(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.KELP_WARM = value.wrapperContained; }
...
public static yarnwrap.registry.RegistryKey WARM_OCEAN_VEGETATION() { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.feature.OceanPlacedFeatures.WARM_OCEAN_VEGETATION); }
// public static void WARM_OCEAN_VEGETATION(yarnwrap.registry.RegistryKey value, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.WARM_OCEAN_VEGETATION = value.wrapperContained; }

// public java.util.List seagrassModifiers(int count) { return wrapperContained.seagrassModifiers(count); }
// public static java.util.List seagrassModifiers(int count, ) { return net.minecraft.world.gen.feature.OceanPlacedFeatures.seagrassModifiers(count); }
...
// public static void bootstrap(yarnwrap.registry.Registerable featureRegisterable, ) { net.minecraft.world.gen.feature.OceanPlacedFeatures.bootstrap(featureRegisterable.wrapperContained); }
