...
// public static int FORCE_STATE_AND_NOTIFY_ALL() { return net.minecraft.world.gen.feature.TreeFeature.FORCE_STATE_AND_NOTIFY_ALL; }
// public static void FORCE_STATE_AND_NOTIFY_ALL(int value, ) { net.minecraft.world.gen.feature.TreeFeature.FORCE_STATE_AND_NOTIFY_ALL = value; }
...
// public static void setBlockStateWithoutUpdatingNeighbors(yarnwrap.world.ModifiableWorld world,yarnwrap.util.math.BlockPos pos,yarnwrap.block.BlockState state, ) { net.minecraft.world.gen.feature.TreeFeature.setBlockStateWithoutUpdatingNeighbors(world.wrapperContained,pos.wrapperContained,state.wrapperContained); }
...
// public static boolean generate(yarnwrap.world.StructureWorldAccess world,yarnwrap.util.math.random.Random random,yarnwrap.util.math.BlockPos pos,java.util.function.BiConsumer rootPlacerReplacer,java.util.function.BiConsumer trunkPlacerReplacer,Object blockPlacer,yarnwrap.world.gen.feature.TreeFeatureConfig config, ) { return net.minecraft.world.gen.feature.TreeFeature.generate(world.wrapperContained,random.wrapperContained,pos.wrapperContained,rootPlacerReplacer,trunkPlacerReplacer,blockPlacer,config.wrapperContained); }
...
// public static boolean isVine(yarnwrap.world.TestableWorld world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.world.gen.feature.TreeFeature.isVine(world.wrapperContained,pos.wrapperContained); }
// public boolean method_16417(yarnwrap.block.BlockState state) { return wrapperContained.method_16417(state.wrapperContained); }
// public static boolean method_16417(yarnwrap.block.BlockState state, ) { return net.minecraft.world.gen.feature.TreeFeature.method_16417(state.wrapperContained); }
...
// public static boolean isAirOrLeaves(yarnwrap.world.TestableWorld world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.world.gen.feature.TreeFeature.isAirOrLeaves(world.wrapperContained,pos.wrapperContained); }
...
// public static yarnwrap.util.shape.VoxelSet placeLogsAndLeaves(yarnwrap.world.WorldAccess world,yarnwrap.util.math.BlockBox box,java.util.Set trunkPositions,java.util.Set decorationPositions,java.util.Set rootPositions, ) { return new yarnwrap.util.shape.VoxelSet(net.minecraft.world.gen.feature.TreeFeature.placeLogsAndLeaves(world.wrapperContained,box.wrapperContained,trunkPositions,decorationPositions,rootPositions)); }
// public void method_23381(Object decorator) { wrapperContained.method_23381(decorator); }
// public static void method_23381(Object decorator, ) { net.minecraft.world.gen.feature.TreeFeature.method_23381(decorator); }
// public boolean method_23384(yarnwrap.block.BlockState state) { return wrapperContained.method_23384(state.wrapperContained); }
// public static boolean method_23384(yarnwrap.block.BlockState state, ) { return net.minecraft.world.gen.feature.TreeFeature.method_23384(state.wrapperContained); }
...
// public static boolean canReplace(yarnwrap.world.TestableWorld world,yarnwrap.util.math.BlockPos pos, ) { return net.minecraft.world.gen.feature.TreeFeature.canReplace(world.wrapperContained,pos.wrapperContained); }
...
// public static void method_27372(yarnwrap.world.gen.feature.TreeFeatureConfig node, ) { net.minecraft.world.gen.feature.TreeFeature.method_27372(node.wrapperContained); }
...
// public static int getTopPosition(yarnwrap.world.TestableWorld world,int height,yarnwrap.util.math.BlockPos pos,yarnwrap.world.gen.feature.TreeFeatureConfig config, ) { return net.minecraft.world.gen.feature.TreeFeature.getTopPosition(world.wrapperContained,height,pos.wrapperContained,config.wrapperContained); }
...
// public static java.lang.Boolean method_35363(yarnwrap.world.StructureWorldAccess box, ) { return net.minecraft.world.gen.feature.TreeFeature.method_35363(box.wrapperContained); }
...
// public static void method_35364(java.util.Set pos,yarnwrap.world.StructureWorldAccess state, ) { net.minecraft.world.gen.feature.TreeFeature.method_35364(pos,state.wrapperContained); }
...
// public static void method_43162(java.util.Set pos,yarnwrap.world.StructureWorldAccess state, ) { net.minecraft.world.gen.feature.TreeFeature.method_43162(pos,state.wrapperContained); }
...
// public static yarnwrap.util.math.BlockPos method_43293(yarnwrap.util.math.BlockPos rootPlacer, ) { return new yarnwrap.util.math.BlockPos(net.minecraft.world.gen.feature.TreeFeature.method_43293(rootPlacer.wrapperContained)); }
