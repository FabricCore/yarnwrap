...
public static com.mojang.serialization.MapCodec CODEC() { return net.minecraft.world.gen.trunk.GiantTrunkPlacer.CODEC; }
// public static void CODEC(com.mojang.serialization.MapCodec value, ) { net.minecraft.world.gen.trunk.GiantTrunkPlacer.CODEC = value; }
...
// public static void setLog(yarnwrap.world.TestableWorld world,java.util.function.BiConsumer replacer,yarnwrap.util.math.random.Random random,Object tmpPos,yarnwrap.world.gen.feature.TreeFeatureConfig config,yarnwrap.util.math.BlockPos startPos,int dx,int dy,int dz, ) { net.minecraft.world.gen.trunk.GiantTrunkPlacer.setLog(world.wrapperContained,replacer,random.wrapperContained,tmpPos,config.wrapperContained,startPos.wrapperContained,dx,dy,dz); }
// public com.mojang.datafixers.kinds.App method_28900(Object instance) { return wrapperContained.method_28900(instance); }
// public static com.mojang.datafixers.kinds.App method_28900(Object instance, ) { return net.minecraft.world.gen.trunk.GiantTrunkPlacer.method_28900(instance); }
