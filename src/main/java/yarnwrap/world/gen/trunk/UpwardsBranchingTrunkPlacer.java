...
public static com.mojang.serialization.MapCodec CODEC() { return net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.CODEC; }
// public static void CODEC(com.mojang.serialization.MapCodec value, ) { net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.CODEC = value; }
...
// public static yarnwrap.util.math.intprovider.IntProvider extraBranchSteps() { return new yarnwrap.util.math.intprovider.IntProvider(net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.extraBranchSteps); }
// public static void extraBranchSteps(yarnwrap.util.math.intprovider.IntProvider value, ) { net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.extraBranchSteps = value.wrapperContained; }
...
// public static float placeBranchPerLogProbability() { return net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.placeBranchPerLogProbability; }
// public static void placeBranchPerLogProbability(float value, ) { net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.placeBranchPerLogProbability = value; }
...
// public static yarnwrap.util.math.intprovider.IntProvider extraBranchLength() { return new yarnwrap.util.math.intprovider.IntProvider(net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.extraBranchLength); }
// public static void extraBranchLength(yarnwrap.util.math.intprovider.IntProvider value, ) { net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.extraBranchLength = value.wrapperContained; }
...
// public static yarnwrap.registry.entry.RegistryEntryList canGrowThrough() { return new yarnwrap.registry.entry.RegistryEntryList(net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.canGrowThrough); }
// public static void canGrowThrough(yarnwrap.registry.entry.RegistryEntryList value, ) { net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.canGrowThrough = value.wrapperContained; }
...
// public static void generateExtraBranch(yarnwrap.world.TestableWorld world,java.util.function.BiConsumer replacer,yarnwrap.util.math.random.Random random,int height,yarnwrap.world.gen.feature.TreeFeatureConfig config,java.util.List nodes,Object pos,int yOffset,yarnwrap.util.math.Direction direction,int length,int steps, ) { net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.generateExtraBranch(world.wrapperContained,replacer,random.wrapperContained,height,config.wrapperContained,nodes,pos,yOffset,direction.wrapperContained,length,steps); }
// public boolean method_43200(yarnwrap.block.BlockState state) { return wrapperContained.method_43200(state.wrapperContained); }
// public static boolean method_43200(yarnwrap.block.BlockState state, ) { return net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.method_43200(state.wrapperContained); }
...
// public static yarnwrap.registry.entry.RegistryEntryList method_43201(yarnwrap.world.gen.trunk.UpwardsBranchingTrunkPlacer trunkPlacer, ) { return new yarnwrap.registry.entry.RegistryEntryList(net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.method_43201(trunkPlacer.wrapperContained)); }
...
// public static yarnwrap.util.math.intprovider.IntProvider method_43203(yarnwrap.world.gen.trunk.UpwardsBranchingTrunkPlacer trunkPlacer, ) { return new yarnwrap.util.math.intprovider.IntProvider(net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.method_43203(trunkPlacer.wrapperContained)); }
...
// public static java.lang.Float method_43204(yarnwrap.world.gen.trunk.UpwardsBranchingTrunkPlacer trunkPlacer, ) { return net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.method_43204(trunkPlacer.wrapperContained); }
...
// public static yarnwrap.util.math.intprovider.IntProvider method_43205(yarnwrap.world.gen.trunk.UpwardsBranchingTrunkPlacer trunkPlacer, ) { return new yarnwrap.util.math.intprovider.IntProvider(net.minecraft.world.gen.trunk.UpwardsBranchingTrunkPlacer.method_43205(trunkPlacer.wrapperContained)); }
