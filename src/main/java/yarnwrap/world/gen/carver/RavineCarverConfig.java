...
public static com.mojang.serialization.Codec RAVINE_CODEC() { return net.minecraft.world.gen.carver.RavineCarverConfig.RAVINE_CODEC; }
// public static void RAVINE_CODEC(com.mojang.serialization.Codec value, ) { net.minecraft.world.gen.carver.RavineCarverConfig.RAVINE_CODEC = value; }
...
// public static yarnwrap.util.math.floatprovider.FloatProvider verticalRotation() { return new yarnwrap.util.math.floatprovider.FloatProvider(net.minecraft.world.gen.carver.RavineCarverConfig.verticalRotation); }
// public static void verticalRotation(yarnwrap.util.math.floatprovider.FloatProvider value, ) { net.minecraft.world.gen.carver.RavineCarverConfig.verticalRotation = value.wrapperContained; }

public Object shape() { return wrapperContained.shape; }
// // public void shape(Object value) { wrapperContained.shape = value; }
// // public static Object shape() { return net.minecraft.world.gen.carver.RavineCarverConfig.shape; }
// // public static void shape(Object value, ) { net.minecraft.world.gen.carver.RavineCarverConfig.shape = value; }
...
// public static com.mojang.datafixers.kinds.App method_35336(Object instance, ) { return net.minecraft.world.gen.carver.RavineCarverConfig.method_35336(instance); }
...
// public static Object method_35337(yarnwrap.world.gen.carver.RavineCarverConfig config, ) { return net.minecraft.world.gen.carver.RavineCarverConfig.method_35337(config.wrapperContained); }
...
// public static yarnwrap.util.math.floatprovider.FloatProvider method_35338(yarnwrap.world.gen.carver.RavineCarverConfig config, ) { return new yarnwrap.util.math.floatprovider.FloatProvider(net.minecraft.world.gen.carver.RavineCarverConfig.method_35338(config.wrapperContained)); }
