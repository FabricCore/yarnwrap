...
// public static double noiseLevel() { return net.minecraft.world.gen.placementmodifier.NoiseThresholdCountPlacementModifier.noiseLevel; }
// public static void noiseLevel(double value, ) { net.minecraft.world.gen.placementmodifier.NoiseThresholdCountPlacementModifier.noiseLevel = value; }
...
// public static int aboveNoise() { return net.minecraft.world.gen.placementmodifier.NoiseThresholdCountPlacementModifier.aboveNoise; }
// public static void aboveNoise(int value, ) { net.minecraft.world.gen.placementmodifier.NoiseThresholdCountPlacementModifier.aboveNoise = value; }
...
// public static int belowNoise() { return net.minecraft.world.gen.placementmodifier.NoiseThresholdCountPlacementModifier.belowNoise; }
// public static void belowNoise(int value, ) { net.minecraft.world.gen.placementmodifier.NoiseThresholdCountPlacementModifier.belowNoise = value; }
...
public static com.mojang.serialization.MapCodec MODIFIER_CODEC() { return net.minecraft.world.gen.placementmodifier.NoiseThresholdCountPlacementModifier.MODIFIER_CODEC; }
