...
// public yarnwrap.world.dimension.DimensionOptionsRegistryHolder createDemoOptions(Object registries) { return new yarnwrap.world.dimension.DimensionOptionsRegistryHolder(wrapperContained.createDemoOptions(registries)); }
// public static yarnwrap.world.dimension.DimensionOptionsRegistryHolder createDemoOptions(Object registries, ) { return new yarnwrap.world.dimension.DimensionOptionsRegistryHolder(net.minecraft.world.gen.WorldPresets.createDemoOptions(registries)); }
// public yarnwrap.world.dimension.DimensionOptions getDefaultOverworldOptions(Object registries) { return new yarnwrap.world.dimension.DimensionOptions(wrapperContained.getDefaultOverworldOptions(registries)); }
// public static yarnwrap.world.dimension.DimensionOptions getDefaultOverworldOptions(Object registries, ) { return new yarnwrap.world.dimension.DimensionOptions(net.minecraft.world.gen.WorldPresets.getDefaultOverworldOptions(registries)); }
...
// public yarnwrap.world.dimension.DimensionOptionsRegistryHolder createTestOptions(Object registries) { return new yarnwrap.world.dimension.DimensionOptionsRegistryHolder(wrapperContained.createTestOptions(registries)); }
// public static yarnwrap.world.dimension.DimensionOptionsRegistryHolder createTestOptions(Object registries, ) { return new yarnwrap.world.dimension.DimensionOptionsRegistryHolder(net.minecraft.world.gen.WorldPresets.createTestOptions(registries)); }
