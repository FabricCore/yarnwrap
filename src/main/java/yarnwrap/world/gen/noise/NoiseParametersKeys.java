...
// public static yarnwrap.registry.RegistryKey of(java.lang.String id, ) { return new yarnwrap.registry.RegistryKey(net.minecraft.world.gen.noise.NoiseParametersKeys.of(id)); }
...
// public static yarnwrap.util.math.noise.DoublePerlinNoiseSampler createNoiseSampler(yarnwrap.registry.RegistryEntryLookup noiseParametersLookup,yarnwrap.util.math.random.RandomSplitter splitter,yarnwrap.registry.RegistryKey key, ) { return new yarnwrap.util.math.noise.DoublePerlinNoiseSampler(net.minecraft.world.gen.noise.NoiseParametersKeys.createNoiseSampler(noiseParametersLookup.wrapperContained,splitter.wrapperContained,key.wrapperContained)); }
