...
// public static void appendDebugInfo(java.lang.StringBuilder builder,double originX,double originY,double originZ,byte permutation, ) { net.minecraft.world.gen.noise.NoiseHelper.appendDebugInfo(builder,originX,originY,originZ,permutation); }
...
// public static void appendDebugInfo(java.lang.StringBuilder builder,double originX,double originY,double originZ,int permutation, ) { net.minecraft.world.gen.noise.NoiseHelper.appendDebugInfo(builder,originX,originY,originZ,permutation); }
