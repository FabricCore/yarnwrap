...
public static com.mojang.serialization.Codec CODEC() { return net.minecraft.world.event.listener.Vibration.CODEC; }
// public static void CODEC(com.mojang.serialization.Codec value, ) { net.minecraft.world.event.listener.Vibration.CODEC = value; }
...
// public static java.util.Optional getEntity(yarnwrap.server.world.ServerWorld world, ) { return net.minecraft.world.event.listener.Vibration.getEntity(world.wrapperContained); }
// public com.mojang.datafixers.kinds.App method_42349(Object instance) { return wrapperContained.method_42349(instance); }
// public static com.mojang.datafixers.kinds.App method_42349(Object instance, ) { return net.minecraft.world.event.listener.Vibration.method_42349(instance); }
...
// public static java.util.UUID getOwnerUuid(yarnwrap.entity.Entity entity, ) { return net.minecraft.world.event.listener.Vibration.getOwnerUuid(entity.wrapperContained); }
...
// public static yarnwrap.world.event.listener.Vibration method_42685(yarnwrap.registry.entry.RegistryEntry event,java.lang.Float distance,yarnwrap.util.math.Vec3d pos,java.util.Optional uuid,java.util.Optional projectileOwnerUuid, ) { return new yarnwrap.world.event.listener.Vibration(net.minecraft.world.event.listener.Vibration.method_42685(event.wrapperContained,distance,pos.wrapperContained,uuid,projectileOwnerUuid)); }
...
// public static java.util.Optional method_42686(yarnwrap.world.event.listener.Vibration vibration, ) { return net.minecraft.world.event.listener.Vibration.method_42686(vibration.wrapperContained); }
...
// public static java.util.Optional getOwner(yarnwrap.server.world.ServerWorld world, ) { return net.minecraft.world.event.listener.Vibration.getOwner(world.wrapperContained); }
...
// public static yarnwrap.entity.projectile.ProjectileEntity method_42688(yarnwrap.entity.Entity entity, ) { return new yarnwrap.entity.projectile.ProjectileEntity(net.minecraft.world.event.listener.Vibration.method_42688(entity.wrapperContained)); }
...
// public static java.util.Optional method_42689(yarnwrap.world.event.listener.Vibration vibration, ) { return net.minecraft.world.event.listener.Vibration.method_42689(vibration.wrapperContained); }
// public boolean method_42691(yarnwrap.entity.Entity entity) { return wrapperContained.method_42691(entity.wrapperContained); }
// public static boolean method_42691(yarnwrap.entity.Entity entity, ) { return net.minecraft.world.event.listener.Vibration.method_42691(entity.wrapperContained); }
